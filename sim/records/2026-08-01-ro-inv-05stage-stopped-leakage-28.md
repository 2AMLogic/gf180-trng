---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-28
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-28/
  files:
    - fs_-40c_2.97v.spice  sha256:7bfcf497f794e4d040bfd0fe2399a8c97a6517aefef508c0b62bde51dde2f7ae
    - fs_-40c_2.97v.log  sha256:aa656042f1dafc91667a18f3c022839d6ca32a52e2b620df6cb892153cf8731d
wall_time: 0.8s
---

## Result

- `i_leak_a`: 1.498927e-11
- `p_idle_w`: 4.451814e-11
- `v_n1`: 2.97
- `v_n2`: 3.869165e-09
- `v_n3`: 2.97
- `v_n4`: 3.869165e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners fs --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
