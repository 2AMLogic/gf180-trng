---
record: 2026-08-01-sampler-dff-reset-current-xsv-26
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-26/
  files:
    - ss_125c_3.30v.spice  sha256:489bcaeec12b1751371d77198aaf9cf0eee0c16c103fe1d1ac199660bfbae850
    - ss_125c_3.30v.log  sha256:5eb6bb3ae4b583848a149c5db8c3d54752e75a39367e91e3326a69a6deb6b6d9
wall_time: 1.2s
---

## Result

- `i_reset_xsv_a`: 1.360093e-04
- `p_reset_xsv_w`: 4.488308e-04
- `v_q`: 3.326099e-08
- `v_m`: 0.94206
- `v_rst`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
