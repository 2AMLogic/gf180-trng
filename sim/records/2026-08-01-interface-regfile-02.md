---
record: 2026-08-01-interface-regfile-02
date: 2026-08-01T21:21:22Z
status: valid
...
analysis:
  ...
  runs: 1
seeds: [2]   # SHA-256 counter-mode source, bit-identical on any platform
...
raw:
  path: sim/records/raw/2026-08-01-interface-regfile-02/
  files:
    - data_words.hex  sha256:1ac048226117e985e485c3e72d03d4e79085b738fdcf5fa6d860aae101b07e09
    - raw_words.hex  sha256:b6e4ff3c240af5c4e095d22c2e60815b86111fca0c48ea9d4a3274b173baa9b4
    - summary.json  sha256:3d508786d80b53ccc8ba480098f5a286953d25e35b07e06d28aa0fbcbf267cb5
wall_time: 1.3s
---

## Result

Scenario `ht-gate` — DR-0002's latch-and-gate: a failure latches HT_FAIL_*, flushes the conditioned FIFO and deasserts streaming valid, while RAW_DATA keeps working; recovery needs an explicit write-1-to-clear plus a fresh start-up-test pass.

| Quantity | Value |
|---|---|
| raw samples driven | 8192 |
| start-up window (samples) | 1024 |
| start-up windows run | 2 |
...
| conditioned words offered by the conditioner | 21 |
| DATA words read | 21 |
| RAW_DATA words read | 255 |
| raw words packed | 255 |
| flush events | 2 |
| FIFO words discarded by flush | 0 |
| partial raw bits discarded by flush | 12 |
| final STATUS | `0x00000010` |
| final STATUS.HT_ALARM | 0 |
| final STATUS.STARTUP | 0 |
| final STATUS.COND_READY | 1 |
| final STATUS.OVF_DATA / OVF_RAW | 0 / 0 |
| final DATA_LEVEL / RAW_LEVEL | 0 / 0 |
| DATA stream sha256 | `1ac048226117e985e485c3e72d03d4e79085b738fdcf5fa6d860aae101b07e09` |
| RAW_DATA stream sha256 | `b6e4ff3c240af5c4e095d22c2e60815b86111fca0c48ea9d4a3274b173baa9b4` |
| raw words acquired while HT_ALARM latched (DR-0001 §5 requires > 0) | 16 |
| RAW_DATA words read while HT_ALARM latched (requires > 0) | 16 |
| DATA words read while HT_ALARM latched (DR-0002 §2 requires 0) | 0 |

Scripted events:

| Raw sample | Event |
|---|---|
| 3000 | ht_fail_rct pulse |
| 3500 | write-1-to-clear HT_FAIL_RCT |
...
```sh
python3 sim/tb/interface-regfile/run_demo.py --scenario ht-gate --no-write
```
