---
record: 2026-08-01-health-test-fault-injection-05
date: 2026-08-01T23:07:43Z
status: valid
...
raw:
  path: sim/records/raw/2026-08-01-health-test-fault-injection-05/
  files:
    - summary.json  sha256:8e239ef43a2b7a46b4be4fe50406af7dfc963cc7d887c7155350d3f67c20acdb
    - raw_bits.bin  sha256:261daf2eab347c18766b48484e2da78917072fb1be52fdc2b5669ced742e322d
wall_time: 0.1s
---

## Result

Scenario `injection-locked` -- DR-0002 groups 'heavily biased stream / injection-locked source' under the same 2*W latency target -- a locked pair of rings presents the combined node as a long deterministic run rather than a per-sample independent bit.

| Quantity | Value |
|---|---|
| lead-in + fault bits total | 6096 |
| fault onset (sample index) | 2000 |
| fault generator | `oscillator_lockup_bits` |
| C_RCT / C_APT / W | 81 / 824 / 1024 |
| first event index after onset | 2079 |
...
```sh
python3 sim/tb/health-test-fault-injection/run_demo.py --scenario injection-locked --no-write
```
