---
record: 2026-08-01-sampler-dff-reset-clocked-17
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-17/
  files:
    - ff_125c_3.30v.spice  sha256:7e0de142fb1d703db587683610d0348443e101e744d316ed9186318f15d0ca75
    - ff_125c_3.30v.log  sha256:c2ee6913ed051513fab4e1d27a0428d4609154cd6f2af07590dd9c96e20153a1
wall_time: 1.9m
---

## Result

- `q_rst_max_v`: 0.126833
- `q_rst_max_frac`: 0.0384344
- `s_rst_min_v`: 2.81091
- `s_rst_dev_frac`: 0.148208
- `mb_rst_min_v`: 3.16114
- `q_rel_v`: 4.031265e-06
- `q_cap_v`: 3.29999
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
