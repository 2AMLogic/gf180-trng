---
record: 2026-08-01-sampler-dff-reset-clocked-28
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-28/
  files:
    - fs_-40c_2.97v.spice  sha256:87397c1e7d37024852c082503547d1cf66e78f1d0910c50aa4b06b1ccfd8f576
    - fs_-40c_2.97v.log  sha256:65fb9a76d1566c0ee80de93bb028ffbeafd1a9dfdfd0421b9fbd32231f95991c
wall_time: 2.3m
---

## Result

- `q_rst_max_v`: 0.120596
- `q_rst_max_frac`: 0.0406046
- `s_rst_min_v`: 2.54012
- `s_rst_dev_frac`: 0.144739
- `mb_rst_min_v`: 2.83262
- `q_rel_v`: 2.447388e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
