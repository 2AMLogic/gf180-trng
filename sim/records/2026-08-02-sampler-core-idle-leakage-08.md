---
record: 2026-08-02-sampler-core-idle-leakage-08
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-08/
  files:
    - tt_125c_3.30v.spice  sha256:86aca2e2c44f6d3d682e0d309032a8df091415de0d4a5a6e91bdb20629d6ccaf
    - tt_125c_3.30v.log  sha256:61692143726273f45440ad996997f30cbc8ff3a511c3aa9cbcff14ade4679f80
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 2.843700e-09
- `i_idle_clkhi_a`: 2.377300e-09
- `p_idle_clklo_w`: 9.384210e-09
- `p_idle_clkhi_w`: 7.845090e-09
- `i_idle_clklo_prev_a`: 2.853200e-09
- `i_idle_clkhi_prev_a`: 2.377350e-09
- `i_idle_worst_a`: 2.843700e-09
- `p_idle_worst_w`: 9.384210e-09
- `v_ro1_v`: 3.29998
- `v_ro2_v`: 3.29998
- `v_xo_v`: 9.627862e-07
- `v_n1_v`: 3.29999
- `v_n2_v`: 5.896020e-07
- `v_rawbit_clklo_v`: -6.838949e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 7.989828e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
