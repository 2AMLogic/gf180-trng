---
record: 2026-08-01-sampler-dff-reset-current-xsb-35
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-35/
  files:
    - fs_125c_3.30v.spice  sha256:1dd3203a0935fbddbd8d96e8e097a93364e1ac8b33bc12a0f25a7ac06b705a55
    - fs_125c_3.30v.log  sha256:e830f50b422509b7cbf2c6d826d60b9c80b92f7bc981d43dba29ccdc9ba1f632
wall_time: 4.7s
---

## Result

- `i_reset_xsb_a`: 8.830210e-05
- `p_reset_xsb_w`: 2.913969e-04
- `i_reset_xsb_first_a`: 8.830211e-05
- `i_reset_xsb_last_a`: 8.830210e-05
- `q_v`: -8.899167e-07
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
