---
record: 2026-08-02-sampler-dff-active-current-36
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-36/
  files:
    - fs_125c_3.63v.spice  sha256:7849c03e67036152390d33fae9a4a776f493e9554afbc5bd7b697c3df3ec7e26
    - fs_125c_3.63v.log  sha256:eb31d50e9bc8b364936cb1a240b0d34690e290bce320ca154232781385b18988
wall_time: 12.4s
---

## Result

- `q_d_shut_c`: 1.300000e-18
- `q_d_open_c`: 9.500267e-15
- `e_d_shut_j`: 4.719000e-18
- `e_d_open_j`: 3.448597e-14
- `q_clkcyc_xsv_c`: 8.584870e-15
- `e_clkcyc_xsv_j`: 3.116308e-14
- `q_clkcyc_xsb_resid_c`: 1.560167e-15
- `q_cyc_xsb_total_c`: 1.060761e-13
- `q_d_shut_xsv_c`: 2.025000e-18
- `q_d_open_xsv_c`: 3.005000e-18
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 3.195093e-08
- `qv_post_v`: 3.62999
- `qb_pre_v`: -1.131494e-06
- `qb_post_v`: 3.62999
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
