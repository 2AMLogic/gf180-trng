---
record: 2026-08-02-ro-array-core-xo-slew-02
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-02/
  files:
    - ff_-40c_2.97v.spice  sha256:6c24a7cfb0edc5b4e8bf7e9803711eca3d84146ea2badf5e216f7bc5c090643c
    - ff_-40c_2.97v.log  sha256:ea7fb361089f22757f2a261cc26857cc089f0c21bceb231e0d3ec5163b817190
wall_time: 10.9m
---

## Result

- `xo_slew_rise_v_per_s`: 3.883526e+10
- `xo_slew_fall_v_per_s`: -5.133419e+10
- `ro1_slew_rise_v_per_s`: 3.780919e+09
- `ro1_slew_fall_v_per_s`: -6.353157e+09
- `ro1_band_slew_a_v_per_s`: 1.781697e+09
- `ro1_band_slew_b_v_per_s`: 1.781323e+09
- `xo_swing_v`: 3.06457
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ff --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
