---
record: 2026-08-02-sampler-core-idle-leakage-07
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-07/
  files:
    - tt_125c_2.97v.spice  sha256:c8208970d5cd6fb28ec8f4503e6e403b333aaabf1fb4924ee221909f6f8a176f
    - tt_125c_2.97v.log  sha256:1ef2494d360bf0503a5004535a72791a3b2992e5b8001b525db2d9c4b0aaf250
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 2.316950e-09
- `i_idle_clkhi_a`: 1.938550e-09
- `p_idle_clklo_w`: 6.881342e-09
- `p_idle_clkhi_w`: 5.757494e-09
- `i_idle_clklo_prev_a`: 2.324850e-09
- `i_idle_clkhi_prev_a`: 1.938600e-09
- `i_idle_worst_a`: 2.316950e-09
- `p_idle_worst_w`: 6.881342e-09
- `v_ro1_v`: 2.96998
- `v_ro2_v`: 2.96998
- `v_xo_v`: 7.884482e-07
- `v_n1_v`: 2.96999
- `v_n2_v`: 5.729080e-07
- `v_rawbit_clklo_v`: -5.825016e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 7.741293e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
