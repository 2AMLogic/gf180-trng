---
record: 2026-08-01-sampler-dff-reset-current-xsb-12
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-12/
  files:
    - ff_-40c_3.63v.spice  sha256:f998d82bb92be993c3068dfcb773c194af2f76fecf3015b222b8bd5377a0d26e
    - ff_-40c_3.63v.log  sha256:3f45c9daa4569c81041bb8477c89ad8b9caf4a09dd5602cb89a9db70ef4331d3
wall_time: 4.8s
---

## Result

- `i_reset_xsb_a`: 1.570348e-04
- `p_reset_xsb_w`: 5.700363e-04
- `i_reset_xsb_first_a`: 1.570348e-04
- `i_reset_xsb_last_a`: 1.570348e-04
- `q_v`: 3.336657e-08
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
