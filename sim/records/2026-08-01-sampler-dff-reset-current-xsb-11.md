---
record: 2026-08-01-sampler-dff-reset-current-xsb-11
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-11/
  files:
    - ff_-40c_3.30v.spice  sha256:c9b14670496ae0de23cd5ae2d41317aeba16dadfceb10d3bf129bcb7d8f4f0c5
    - ff_-40c_3.30v.log  sha256:f7f1db5dcaa9f827237ade725fffca1e54801e0419bfa42eecb82ff1a4911ebf
wall_time: 4.8s
---

## Result

- `i_reset_xsb_a`: 1.333581e-04
- `p_reset_xsb_w`: 4.400819e-04
- `i_reset_xsb_first_a`: 1.333581e-04
- `i_reset_xsb_last_a`: 1.333582e-04
- `q_v`: 3.402456e-08
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
