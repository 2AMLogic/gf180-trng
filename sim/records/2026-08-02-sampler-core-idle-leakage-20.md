---
record: 2026-08-02-sampler-core-idle-leakage-20
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-20/
  files:
    - ss_-40c_3.30v.spice  sha256:70de47d27b80d05fd3abf9a890c5b93ae288db195d898372e96b3fdbb58a21ef
    - ss_-40c_3.30v.log  sha256:ea9f53eb989831f2e26d48c916259d737657c25f716518974cae75a30794771c
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 3.288500e-10
- `i_idle_clkhi_a`: 1.977000e-10
- `p_idle_clklo_w`: 1.085205e-09
- `p_idle_clkhi_w`: 6.524100e-10
- `i_idle_clklo_prev_a`: 3.339000e-10
- `i_idle_clkhi_prev_a`: 1.977500e-10
- `i_idle_worst_a`: 3.288500e-10
- `p_idle_worst_w`: 1.085205e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 9.594704e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 1.044877e-07
- `v_rawbit_clklo_v`: -4.509690e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.784658e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
