---
record: 2026-08-02-sampler-core-idle-leakage-23
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-23/
  files:
    - ss_27c_3.30v.spice  sha256:b134f1c5320076f3cfb146efd65233756fcd5e3507196c6225f5b8bbcabfec20
    - ss_27c_3.30v.log  sha256:956163a2c91382710700b180b286aa4ed5b4db26f39e0b2cde49185666385d15
wall_time: 60.0s
---

## Result

- `i_idle_clklo_a`: 3.541000e-10
- `i_idle_clkhi_a`: 1.993000e-10
- `p_idle_clklo_w`: 1.168530e-09
- `p_idle_clkhi_w`: 6.576900e-10
- `i_idle_clklo_prev_a`: 3.604500e-10
- `i_idle_clkhi_prev_a`: 1.993000e-10
- `i_idle_worst_a`: 3.541000e-10
- `p_idle_worst_w`: 1.168530e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 6.423016e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 1.379373e-07
- `v_rawbit_clklo_v`: -5.312168e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.972731e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
