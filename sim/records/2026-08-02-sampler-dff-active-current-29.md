---
record: 2026-08-02-sampler-dff-active-current-29
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-29/
  files:
    - fs_-40c_3.30v.spice  sha256:5cb56112eb6c32253096b9b625bf3ec1593ced6566bd806726394bcb475a0e12
    - fs_-40c_3.30v.log  sha256:ccdd03020c7117c1597f0e9eaaf5a2b796e3b29f091379c64b45b0e84f821064
wall_time: 12.7s
---

## Result

- `q_d_shut_c`: 5.166667e-20
- `q_d_open_c`: 7.880150e-15
- `e_d_shut_j`: 1.705000e-19
- `e_d_open_j`: 2.600450e-14
- `q_clkcyc_xsv_c`: 7.547180e-15
- `e_clkcyc_xsv_j`: 2.490569e-14
- `q_clkcyc_xsb_resid_c`: 7.191333e-16
- `q_cyc_xsb_total_c`: 8.740130e-14
- `q_d_shut_xsv_c`: 5.000000e-20
- `q_d_open_xsv_c`: 5.000000e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.443649e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -1.758396e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps -40 --supply 3.3 --supply-tol 0 --no-write
```

## Caveats

- Single corner (fs / 3.30 V / -40 C). Says nothing about any other corner.
