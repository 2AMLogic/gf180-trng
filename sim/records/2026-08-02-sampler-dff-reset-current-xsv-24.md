---
record: 2026-08-02-sampler-dff-reset-current-xsv-24
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-24/
  files:
    - ss_27c_3.63v.spice  sha256:e5670b5d3d9caf4930b4de51f24af9767269134344b6f216e9ccb05525c87aee
    - ss_27c_3.63v.log  sha256:86d81877d4df2533f2974bc3e4ca5ecaaf49278af389d1896a0a8545611bb767
wall_time: 3.3s
---

## Result

- `i_reset_xsv_a`: 5.341957e-11
- `p_reset_xsv_w`: 1.939131e-10
- `v_q`: 2.163948e-08
- `v_m`: 3.63
- `v_mb`: 3.63
- `v_qb`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
