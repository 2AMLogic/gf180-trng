---
record: 2026-08-02-sampler-dff-reset-current-xsb-04
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-04/
  files:
    - tt_27c_2.97v.spice  sha256:635fc597cee4f86cad9df4e09fdff87eba5274e70b6a24d4f5e12897dbc6bd3c
    - tt_27c_2.97v.log  sha256:e4d4290cbe9e4d10e0f7fb2e1b08c771a53716c297a7193c8e047ac1b749bbf0
wall_time: 12.2s
---

## Result

- `i_reset_xsb_a`: 1.983700e-08
- `p_reset_xsb_w`: 5.891589e-08
- `i_reset_xsb_first_a`: 3.051050e-08
- `i_reset_xsb_last_a`: 9.163500e-09
- `q_v`: -8.062771e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners tt --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
