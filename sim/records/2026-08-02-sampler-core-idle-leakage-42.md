---
record: 2026-08-02-sampler-core-idle-leakage-42
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-42/
  files:
    - sf_27c_3.63v.spice  sha256:f60f59a5a97d2f6eca8f9f07709ff2b9d9ee8225c02c012a2c66b9db47a12185
    - sf_27c_3.63v.log  sha256:74956e7c428e2857c5ca562e81d4cfabe0adfe35f7a2cf34430f39e3c6be5bd6
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 4.608500e-10
- `i_idle_clkhi_a`: 2.260500e-10
- `p_idle_clklo_w`: 1.672886e-09
- `p_idle_clkhi_w`: 8.205615e-10
- `i_idle_clklo_prev_a`: 4.706500e-10
- `i_idle_clkhi_prev_a`: 2.260000e-10
- `i_idle_worst_a`: 4.608500e-10
- `p_idle_worst_w`: 1.672886e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 8.462721e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 1.439679e-07
- `v_rawbit_clklo_v`: -8.167854e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 2.233709e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
