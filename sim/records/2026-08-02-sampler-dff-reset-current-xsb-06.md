---
record: 2026-08-02-sampler-dff-reset-current-xsb-06
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-06/
  files:
    - tt_27c_3.63v.spice  sha256:86c0bdd2b763be19faf61e1332957b529dffac83f85d3272bb93dd081e485691
    - tt_27c_3.63v.log  sha256:b1f72262a90bc2a64bdc025b2a483702cab4beb25889810ba3ed711e352d0c0c
wall_time: 12.2s
---

## Result

- `i_reset_xsb_a`: 2.155625e-08
- `p_reset_xsb_w`: 7.824919e-08
- `i_reset_xsb_first_a`: 3.179800e-08
- `i_reset_xsb_last_a`: 1.131450e-08
- `q_v`: -4.528744e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners tt --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
