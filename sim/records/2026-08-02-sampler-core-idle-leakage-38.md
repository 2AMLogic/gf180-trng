---
record: 2026-08-02-sampler-core-idle-leakage-38
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-38/
  files:
    - sf_-40c_3.30v.spice  sha256:567c1d6162379b4436c94fe56cbf264e0d5a7a977afc76d41483cfee8ea4fab8
    - sf_-40c_3.30v.log  sha256:7a80070809be34cef0ba51128c216af5ba0a7a319e3575e8013a6034b5450a9b
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 3.688500e-10
- `i_idle_clkhi_a`: 1.992000e-10
- `p_idle_clklo_w`: 1.217205e-09
- `p_idle_clkhi_w`: 6.573600e-10
- `i_idle_clklo_prev_a`: 3.755500e-10
- `i_idle_clkhi_prev_a`: 1.992500e-10
- `i_idle_worst_a`: 3.688500e-10
- `p_idle_worst_w`: 1.217205e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 9.582842e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 1.009688e-07
- `v_rawbit_clklo_v`: -6.463467e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.702546e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
