---
record: 2026-08-02-ro-array-core-xo-slew-08
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-08/
  files:
    - ss_125c_2.97v.spice  sha256:ba0d509584909ae8cd139d05505cc307a929e3cc6ca8d56722ebdd0392819d87
    - ss_125c_2.97v.log  sha256:7f284eb6aa8c8c80b257631903e72dbd50ce8d8a7a94eb0d4a5d72c8761aaa53
wall_time: 11.2m
---

## Result

- `xo_slew_rise_v_per_s`: 1.753287e+10
- `xo_slew_fall_v_per_s`: -2.319523e+10
- `ro1_slew_rise_v_per_s`: 1.354590e+09
- `ro1_slew_fall_v_per_s`: -2.384265e+09
- `ro1_band_slew_a_v_per_s`: 5.488921e+08
- `ro1_band_slew_b_v_per_s`: 7.219778e+08
- `xo_swing_v`: 3.04899
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ss --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
