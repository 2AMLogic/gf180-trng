---
record: 2026-08-02-ro-array-core-pvt-q-50
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-50/
  files:
    - ss_27c_3.30v.spice  sha256:363b392a34f10fc0497b4038a7ffcc17c2c575ff0832f420e8b69ebc75c0fbd2
    - ss_27c_3.30v.log  sha256:02c7b1b62a05ab2da9a75cb8858274e3966182fc95156614730f14fdac31add9
wall_time: 2.8m
---

## Result

- `period_r1`: 8.139118e-09
- `period_r2`: 7.589265e-09
- `f_r1`: 1.228634e+08
- `f_r2`: 1.317651e+08
- `i_r1_a`: -1.453944e-05
- `i_r2_a`: -1.554641e-05
- `i_tree_a`: -1.207971e-05
- `e_cycle_r1_j`: -3.905160e-13
- `c_eff_node_r1_f`: -3.260005e-15
- `ring_swing_v`: 3.45743
- `xo_swing_v`: 3.47667
- `i_total_a`: -4.216556e-05
- `p_rings_w`: -9.928330e-05
- `p_total_w`: -1.391463e-04
- `xo_trans_per_s`: 5.092570e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ss --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
