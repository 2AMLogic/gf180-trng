---
record: 2026-08-02-sampler-core-idle-leakage-21
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-21/
  files:
    - ss_-40c_3.63v.spice  sha256:249b64ef985c927fadaaab55cdaaf6551408b517645ac2dd6b31aca6e47118e8
    - ss_-40c_3.63v.log  sha256:7b034db6b8c15414b17f3fa3d8817c1918d5ac912e1bd84dae15eb1aef46c166
wall_time: 59.7s
---

## Result

- `i_idle_clklo_a`: 3.835500e-10
- `i_idle_clkhi_a`: 2.186500e-10
- `p_idle_clklo_w`: 1.392287e-09
- `p_idle_clkhi_w`: 7.936995e-10
- `i_idle_clklo_prev_a`: 3.899500e-10
- `i_idle_clkhi_prev_a`: 2.186000e-10
- `i_idle_worst_a`: 3.835500e-10
- `p_idle_worst_w`: 1.392287e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 1.129066e-06
- `v_n1_v`: 3.63
- `v_n2_v`: 1.095316e-07
- `v_rawbit_clklo_v`: -5.581221e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.900371e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
