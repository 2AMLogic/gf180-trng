---
record: 2026-08-02-sampler-core-idle-leakage-02
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-02/
  files:
    - tt_-40c_3.30v.spice  sha256:02ff861d22916f10bcb936fd7e36da35ce68527ff9be65a2f6a51d3d6e12149c
    - tt_-40c_3.30v.log  sha256:51cf43100b496aef3fdf11c2ca85e1023ccc1995a893013c0d75473da0ebafa1
wall_time: 1.5m
---

## Result

- `i_idle_clklo_a`: 3.549000e-10
- `i_idle_clkhi_a`: 1.989000e-10
- `p_idle_clklo_w`: 1.171170e-09
- `p_idle_clkhi_w`: 6.563700e-10
- `i_idle_clklo_prev_a`: 3.609000e-10
- `i_idle_clkhi_prev_a`: 1.989500e-10
- `i_idle_worst_a`: 3.549000e-10
- `p_idle_worst_w`: 1.171170e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 1.001410e-06
- `v_n1_v`: 3.3
- `v_n2_v`: 9.343193e-08
- `v_rawbit_clklo_v`: -5.605631e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.604130e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
