---
record: 2026-08-01-sampler-dff-reset-current-xsb-44
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-44/
  files:
    - sf_125c_3.30v.spice  sha256:bf6c9c84b0bdcd1e67bf99fa3d378f3bda393b9c3df6e20f11581dc1490ee82a
    - sf_125c_3.30v.log  sha256:8067b5b6e17be6f01aca3cbd3c050ef7925391f010148762c4e7ca8c6cbd3d0b
wall_time: 4.7s
---

## Result

- `i_reset_xsb_a`: 8.209648e-05
- `p_reset_xsb_w`: 2.709184e-04
- `i_reset_xsb_first_a`: 8.209647e-05
- `i_reset_xsb_last_a`: 8.209650e-05
- `q_v`: 6.266235e-08
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
