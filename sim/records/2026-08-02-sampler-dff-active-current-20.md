---
record: 2026-08-02-sampler-dff-active-current-20
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-20/
  files:
    - ss_-40c_3.30v.spice  sha256:d4950da4c6b7ee2b9ec3744e35d9ef074905d74aa467fea16e7f7a0b1abb87f0
    - ss_-40c_3.30v.log  sha256:f4a9bcfe32d4659524c1fc342b8d1acd5bc96bd4cf5ca0a00de88382756c96c2
wall_time: 14.5s
---
...
- `q_d_open_c`: 7.729983e-15
- `e_d_shut_j`: 1.705000e-19
- `e_d_open_j`: 2.550895e-14
- `q_clkcyc_xsv_c`: 7.589860e-15
- `e_clkcyc_xsv_j`: 2.504654e-14
- `q_clkcyc_xsb_resid_c`: 6.940667e-16
- `q_cyc_xsb_total_c`: 8.572440e-14
- `q_d_shut_xsv_c`: 5.000000e-20
- `q_d_open_xsv_c`: 5.000000e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.700399e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -3.621970e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
