---
record: 2026-08-02-sampler-core-idle-leakage-11
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-11/
  files:
    - ff_-40c_3.30v.spice  sha256:68ca378a2246f41bcb52ccc4193ee2ce056f04e42eee2499044e0d19541cfde3
    - ff_-40c_3.30v.log  sha256:9ed4ce39228616a162efc2b4a3d6dfe3a94bf2c9fa48382042f80b375726e5a2
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 3.875000e-10
- `i_idle_clkhi_a`: 2.015500e-10
- `p_idle_clklo_w`: 1.278750e-09
- `p_idle_clkhi_w`: 6.651150e-10
- `i_idle_clklo_prev_a`: 3.949500e-10
- `i_idle_clkhi_prev_a`: 2.015500e-10
- `i_idle_worst_a`: 3.875000e-10
- `p_idle_worst_w`: 1.278750e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 8.863374e-08
- `v_n1_v`: 3.3
- `v_n2_v`: 8.265391e-08
- `v_rawbit_clklo_v`: -6.831566e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.441289e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
