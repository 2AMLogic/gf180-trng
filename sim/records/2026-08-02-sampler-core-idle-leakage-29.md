---
record: 2026-08-02-sampler-core-idle-leakage-29
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-29/
  files:
    - fs_-40c_3.30v.spice  sha256:8911659d11a9233c99e0cbf6f87007b74fb9b25cdce46727bf8925940de63d2e
    - fs_-40c_3.30v.log  sha256:417fcb75d28c9bcd2229f908296afd18166b98e1d024fbef63d9c28f34f2aa8b
wall_time: 47.1s
---

## Result

- `i_idle_clklo_a`: 3.395000e-10
- `i_idle_clkhi_a`: 1.990500e-10
- `p_idle_clklo_w`: 1.120350e-09
- `p_idle_clkhi_w`: 6.568650e-10
- `i_idle_clklo_prev_a`: 3.449000e-10
- `i_idle_clkhi_prev_a`: 1.991000e-10
- `i_idle_worst_a`: 3.395000e-10
- `p_idle_worst_w`: 1.120350e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 8.860390e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 8.644041e-08
- `v_rawbit_clklo_v`: -4.770181e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.521241e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
