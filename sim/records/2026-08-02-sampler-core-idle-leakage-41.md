---
record: 2026-08-02-sampler-core-idle-leakage-41
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-41/
  files:
    - sf_27c_3.30v.spice  sha256:0fc2c5542b759721e0cf27bea8c88415b48c5176a82a8f5f60ab724e2ccfb254
    - sf_27c_3.30v.log  sha256:237fd8f7ffcc1712d67b6bd5e229603462b7b61be5dc2fce0bca134aca328d5f
wall_time: 1.2m
---

## Result

- `i_idle_clklo_a`: 4.032000e-10
- `i_idle_clkhi_a`: 2.034500e-10
- `p_idle_clklo_w`: 1.330560e-09
- `p_idle_clkhi_w`: 6.713850e-10
- `i_idle_clklo_prev_a`: 4.114500e-10
- `i_idle_clkhi_prev_a`: 2.034500e-10
- `i_idle_worst_a`: 4.032000e-10
- `p_idle_worst_w`: 1.330560e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 1.001009e-06
- `v_n1_v`: 3.3
- `v_n2_v`: 1.371480e-07
- `v_rawbit_clklo_v`: -7.142587e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.938673e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
