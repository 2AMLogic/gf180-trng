---
record: 2026-08-01-sampler-dff-reset-current-xsb-22
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-22/
  files:
    - ss_27c_2.97v.spice  sha256:fa4939f84f277bb0d6be8991de4e1e026a13adf80cddcd22ab5b4089f7c2ad05
    - ss_27c_2.97v.log  sha256:98a434315ec6b6ae01186e4eea3987b592ceaf56e9498501432c5d1af46b0912
wall_time: 4.5s
---

## Result

- `i_reset_xsb_a`: 6.386614e-05
- `p_reset_xsb_w`: 1.896824e-04
- `i_reset_xsb_first_a`: 6.386613e-05
- `i_reset_xsb_last_a`: 6.386615e-05
- `q_v`: -7.752594e-07
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
