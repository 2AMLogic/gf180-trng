---
record: 2026-08-02-sampler-dff-active-current-21
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-21/
  files:
    - ss_-40c_3.63v.spice  sha256:55f3c429e57895d8008e2b7424e594616b7ddc312830a3b2dc610c32b7932221
    - ss_-40c_3.63v.log  sha256:b51f6fba0e02057bdd4ba84eaaaeb1109f485cb040562fcc89b9de89b614add7
wall_time: 16.2s
---
...
- `q_d_open_c`: 8.584833e-15
- `e_d_shut_j`: 1.815000e-19
- `e_d_open_j`: 3.116295e-14
- `q_clkcyc_xsv_c`: 8.363190e-15
- `e_clkcyc_xsv_j`: 3.035838e-14
- `q_clkcyc_xsb_resid_c`: 7.673333e-16
- `q_cyc_xsb_total_c`: 9.520100e-14
- `q_d_shut_xsv_c`: 5.500000e-20
- `q_d_open_xsv_c`: 5.500000e-20
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 1.800204e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -2.549096e-07
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
