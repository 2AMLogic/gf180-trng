---
record: 2026-08-01-sampler-dff-reset-clocked-25
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-25/
  files:
    - ss_125c_2.97v.spice  sha256:e31b9d165a7e601dbeb2ca57916398dd3ab7d3352467b6ff0858734a787245da
    - ss_125c_2.97v.log  sha256:47a5bed285d5a2803034841dbf88272d8439039d359278f00f738a14fc0796fa
wall_time: 2.2m
---

## Result

- `q_rst_max_v`: 0.116037
- `q_rst_max_frac`: 0.0390697
- `s_rst_min_v`: 2.5411
- `s_rst_dev_frac`: 0.14441
- `mb_rst_min_v`: 2.83731
- `q_rel_v`: 5.274300e-07
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
