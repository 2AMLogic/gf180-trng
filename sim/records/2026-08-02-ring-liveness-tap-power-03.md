---
record: 2026-08-02-ring-liveness-tap-power-03
date: 2026-08-02T04:57:55Z
status: valid
...
raw:
  path: sim/records/raw/2026-08-02-ring-liveness-tap-power-03/
  files:
    - ss_-40c_3.63v.spice  sha256:28724a730e182d557700fdc1fd89957429b7f189dbcf86ccd2a7abaa38e03e48
    - ss_-40c_3.63v.log  sha256:38cb90f1ebe1f69bf589ab761853bfcd70287ccc2c640a5702840b43fb0f1891
wall_time: 9.2m
---

## Result

- `period_r1`: 6.523777e-09
- `period_r2`: 6.285253e-09
- `f_r1`: 1.532854e+08
- `f_r2`: 1.591026e+08
- `i_r1_a`: -2.170188e-05
- `i_r2_a`: -2.316462e-05
- `i_tree_a`: -2.202846e-05
- `ring_swing_v`: 3.70342
- `xo_swing_v`: 3.73411
- `p_rings_w`: -1.628654e-04
- `p_total_w`: -2.428287e-04
- `i_tap_avg_a`: -1.169571e-05
- `p_tap_avg_w`: -4.245544e-05
- `ro1_bit_end_v`: 3.63
- `ro2_bit_end_v`: 2.350427e-08
- `ro1_bit_rail_dev_v`: -9.999974e-07
- `ro2_bit_rail_dev_v`: 2.350427e-08
...
```sh
python3 sim/run_corners.py ring-liveness-tap-power --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
