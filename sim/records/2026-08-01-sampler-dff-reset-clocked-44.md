---
record: 2026-08-01-sampler-dff-reset-clocked-44
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-44/
  files:
    - sf_125c_3.30v.spice  sha256:df00a1ad1a7928e6a217589404457795e57e3de8f3ff1836a2c4c81d402cad4f
    - sf_125c_3.30v.log  sha256:c14461d3f6a6f1418d54bf4407720d869114bc53650a0a9ed6c669bfbdadfd4e
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.129818
- `q_rst_max_frac`: 0.0393388
- `s_rst_min_v`: 2.80626
- `s_rst_dev_frac`: 0.149618
- `mb_rst_min_v`: 3.15399
- `q_rel_v`: 1.541419e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
