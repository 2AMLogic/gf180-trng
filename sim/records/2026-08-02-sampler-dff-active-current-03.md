---
record: 2026-08-02-sampler-dff-active-current-03
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-03/
  files:
    - tt_-40c_3.63v.spice  sha256:d1fdcdf973ba3e73aba681ca52442508dc3f45ed443813f5e84a37eb1417d98a
    - tt_-40c_3.63v.log  sha256:55c0be05aea1d824804bcefcd2ea611deb7bdc66e1e18bacec293fcaf2be90ab
wall_time: 12.5s
---
...
- `q_d_open_c`: 8.770533e-15
- `e_d_shut_j`: 1.815000e-19
- `e_d_open_j`: 3.183704e-14
- `q_clkcyc_xsv_c`: 8.340380e-15
- `e_clkcyc_xsv_j`: 3.027558e-14
- `q_clkcyc_xsb_resid_c`: 8.939333e-16
- `q_cyc_xsb_total_c`: 9.737030e-14
- `q_d_shut_xsv_c`: 5.500000e-20
- `q_d_open_xsv_c`: 5.500000e-20
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 1.642821e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -1.111044e-07
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
