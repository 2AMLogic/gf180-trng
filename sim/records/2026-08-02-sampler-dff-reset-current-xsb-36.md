---
record: 2026-08-02-sampler-dff-reset-current-xsb-36
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-36/
  files:
    - fs_125c_3.63v.spice  sha256:9c0b4e948f4f789ac76db08a1c46f0d86b613860f57d801775b20978249f466f
    - fs_125c_3.63v.log  sha256:f4e0c32b678ec0df1f51881803c1366b6e0eacce51b32f6fe57540c86754b3eb
wall_time: 13.6s
---

## Result

- `i_reset_xsb_a`: 2.657275e-08
- `p_reset_xsb_w`: 9.645908e-08
- `i_reset_xsb_first_a`: 3.940600e-08
- `i_reset_xsb_last_a`: 1.373950e-08
- `q_v`: -1.500685e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
