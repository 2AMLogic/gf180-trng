---
record: 2026-08-01-sampler-dff-reset-clocked-15
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-15/
  files:
    - ff_27c_3.63v.spice  sha256:c06178acc732fd7516aa32e129877d2032ff66d53c9385cf94ebec20beddcf85
    - ff_27c_3.63v.log  sha256:24c5ab3323a74f4304f4835b8c27b7eafead5521347abd7c52f4df0bc4926deb
wall_time: 1.9m
---

## Result

- `q_rst_max_v`: 0.144778
- `q_rst_max_frac`: 0.0398838
- `s_rst_min_v`: 3.07864
- `s_rst_dev_frac`: 0.151889
- `mb_rst_min_v`: 3.46678
- `q_rel_v`: 1.632623e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
