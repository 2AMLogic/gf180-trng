---
record: 2026-08-01-sampler-dff-reset-clocked-21
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-21/
  files:
    - ss_-40c_3.63v.spice  sha256:6304eb5d037685ad99bec10ce8891f2a7850f5233bf01d0c464871630b1fd137
    - ss_-40c_3.63v.log  sha256:c8de57be85b1ad8a0f6391f8500c4a47f9fe3ebc098cc0e8daa3d7f9dc8ff7a4
wall_time: 1.7m
---

## Result

- `q_rst_max_v`: 0.151978
- `q_rst_max_frac`: 0.0418672
- `s_rst_min_v`: 3.08161
- `s_rst_dev_frac`: 0.151072
- `mb_rst_min_v`: 3.45557
- `q_rel_v`: 2.690271e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
