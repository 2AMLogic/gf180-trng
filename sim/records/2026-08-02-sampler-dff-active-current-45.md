---
record: 2026-08-02-sampler-dff-active-current-45
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-45/
  files:
    - sf_125c_3.63v.spice  sha256:25884842335055fad91c116ec8f7d511be1906fc15c207105ec4e031656e147a
    - sf_125c_3.63v.log  sha256:4d7b938e0fae8a3c29da8f7e00691cdc8e611fdcc6fbf5847fe0e6abf3624301
wall_time: 11.3s
---

## Result

- `q_d_shut_c`: 2.500000e-19
- `q_d_open_c`: 9.597133e-15
- `e_d_shut_j`: 9.075000e-19
- `e_d_open_j`: 3.483759e-14
- `q_clkcyc_xsv_c`: 8.579610e-15
- `e_clkcyc_xsv_j`: 3.114398e-14
- `q_clkcyc_xsb_resid_c`: 1.210333e-15
- `q_cyc_xsb_total_c`: 1.067813e-13
- `q_d_shut_xsv_c`: 4.116667e-19
- `q_d_open_xsv_c`: 3.833333e-19
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 4.525874e-07
- `qv_post_v`: 3.63
- `qb_pre_v`: -3.001693e-07
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners sf --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
