---
record: 2026-08-02-sampler-dff-reset-current-xsb-26
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-26/
  files:
    - ss_125c_3.30v.spice  sha256:02185c2901d0f8c1dca5c3b209a4a3ede72bccfdb6b2bbfbbc8740b0f2c31520
    - ss_125c_3.30v.log  sha256:0d34d1af568de9324815771abcb788a7cc2d6c70d8b587f441bfd0823a5df088
wall_time: 12.5s
---

## Result

- `i_reset_xsb_a`: 2.864225e-08
- `p_reset_xsb_w`: 9.451942e-08
- `i_reset_xsb_first_a`: 4.420850e-08
- `i_reset_xsb_last_a`: 1.307600e-08
- `q_v`: -3.002408e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
