---
record: 2026-08-02-sampler-dff-active-current-04
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-04/
  files:
    - tt_27c_2.97v.spice  sha256:1527e8bdde913478fbb69ac0228c0d2aa5ae9c135e0599d0dda6f2252c997b16
    - tt_27c_2.97v.log  sha256:ccd743c7841c38386f93ef3da36caec835801d2ba61d2ac74ce93124cac18b13
wall_time: 12.1s
---
...
- `q_d_open_c`: 7.301617e-15
- `e_d_shut_j`: 1.386000e-19
- `e_d_open_j`: 2.168580e-14
- `q_clkcyc_xsv_c`: 6.917110e-15
- `e_clkcyc_xsv_j`: 2.054382e-14
- `q_clkcyc_xsb_resid_c`: 6.749500e-16
- `q_cyc_xsb_total_c`: 8.099320e-14
- `q_d_shut_xsv_c`: 4.666667e-20
- `q_d_open_xsv_c`: 4.666667e-20
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 1.759263e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -5.813694e-07
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
