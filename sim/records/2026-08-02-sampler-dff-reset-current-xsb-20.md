---
record: 2026-08-02-sampler-dff-reset-current-xsb-20
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-20/
  files:
    - ss_-40c_3.30v.spice  sha256:3d2d4e3d498b9dc652a5cd317222e6cf2ba433a321075e0a0f8a9f8c35d3ba89
    - ss_-40c_3.30v.log  sha256:84e33d4b616dc226f7095fe3e687bdd4bcf594d3c8db1f2dcb5cc0c88b360254
wall_time: 12.2s
---

## Result

- `i_reset_xsb_a`: 1.861800e-08
- `p_reset_xsb_w`: 6.143940e-08
- `i_reset_xsb_first_a`: 2.761200e-08
- `i_reset_xsb_last_a`: 9.624000e-09
- `q_v`: -5.633735e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
