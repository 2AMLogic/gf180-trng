---
record: 2026-08-01-sampler-dff-reset-clocked-32
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-32/
  files:
    - fs_27c_3.30v.spice  sha256:ea1e59b2f5b1be24973556770d042371f8370ea6048210ded7e326d7122c3809
    - fs_27c_3.30v.log  sha256:0c6f586afc462abbb90d36a8fc6e440f452e83cdbe0de4b5a36cf2eb87ae14c9
wall_time: 2.1m
---
...
- `q_rst_max_v`: 0.13211
- `q_rst_max_frac`: 0.0400334
- `s_rst_min_v`: 2.81447
- `s_rst_dev_frac`: 0.147132
- `mb_rst_min_v`: 3.15195
- `q_rel_v`: 2.634311e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
