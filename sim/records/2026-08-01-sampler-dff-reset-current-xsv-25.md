---
record: 2026-08-01-sampler-dff-reset-current-xsv-25
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-25/
  files:
    - ss_125c_2.97v.spice  sha256:c255dc0a28739764e98eaace68cda5700d57b9512cc3acd9454f160fca85370b
    - ss_125c_2.97v.log  sha256:f50fad4b6d6a2b31e82ce0030744403044d293e8ad376ce0cd888f70e5411b28
wall_time: 1.3s
---

## Result

- `i_reset_xsv_a`: 1.096947e-04
- `p_reset_xsv_w`: 3.257932e-04
- `v_q`: 3.255205e-08
- `v_m`: 0.8214
- `v_rst`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
