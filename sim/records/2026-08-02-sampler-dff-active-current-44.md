---
record: 2026-08-02-sampler-dff-active-current-44
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-44/
  files:
    - sf_125c_3.30v.spice  sha256:3ae1243a271e64a23958ae50b7f7cffd86b640f3f521048e76a74d34140d37f3
    - sf_125c_3.30v.log  sha256:9f9067f36c21fb6031f25fd55a92fe04df7e92ca3d775c7c8ca076a75356f21b
wall_time: 12.9s
---

## Result

- `q_d_shut_c`: 2.333333e-19
- `q_d_open_c`: 8.659767e-15
- `e_d_shut_j`: 7.700000e-19
- `e_d_open_j`: 2.857723e-14
- `q_clkcyc_xsv_c`: 7.853420e-15
- `e_clkcyc_xsv_j`: 2.591629e-14
- `q_clkcyc_xsb_resid_c`: 1.051133e-15
- `q_cyc_xsb_total_c`: 9.631090e-14
- `q_d_shut_xsv_c`: 3.600000e-19
- `q_d_open_xsv_c`: 3.316667e-19
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 4.301065e-07
- `qv_post_v`: 3.3
- `qb_pre_v`: -6.342437e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners sf --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
