---
record: 2026-08-01-sampler-dff-reset-current-xsb-43
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-43/
  files:
    - sf_125c_2.97v.spice  sha256:7dbd1afc6036a4b73b1e32a8ff4c5bf1b62e7a79817192578de9da5d06eea533
    - sf_125c_2.97v.log  sha256:91c37adc13ae9c61b4a1eb61a90a2e416578eb9036b55665bd8f8d86ea55cb41
wall_time: 4.9s
---

## Result

- `i_reset_xsb_a`: 6.696230e-05
- `p_reset_xsb_w`: 1.988780e-04
- `i_reset_xsb_first_a`: 6.696230e-05
- `i_reset_xsb_last_a`: 6.696230e-05
- `q_v`: -3.809793e-07
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
