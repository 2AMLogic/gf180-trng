---
record: 2026-08-02-sampler-core-idle-leakage-19
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-19/
  files:
    - ss_-40c_2.97v.spice  sha256:f9733120a7ba2b6cafe185620122b009c8f461c1995bdc0216787d493c3ce75a
    - ss_-40c_2.97v.log  sha256:df7c4ee0b6b19e2e12d4a3831e14456b3a021f76d30754ca346a2739f1030b5c
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 2.757000e-10
- `i_idle_clkhi_a`: 1.772000e-10
- `p_idle_clklo_w`: 8.188290e-10
- `p_idle_clkhi_w`: 5.262840e-10
- `i_idle_clklo_prev_a`: 2.795500e-10
- `i_idle_clkhi_prev_a`: 1.772000e-10
- `i_idle_worst_a`: 2.757000e-10
- `p_idle_worst_w`: 8.188290e-10
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 4.108554e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 1.002483e-07
- `v_rawbit_clklo_v`: -3.552552e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.553607e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
