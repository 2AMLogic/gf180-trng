---
record: 2026-08-02-sampler-dff-reset-current-xsb-18
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-18/
  files:
    - ff_125c_3.63v.spice  sha256:22d202d9a67e25a7a82e4640922847f382b0fad7be9619d4f90752953c01fe71
    - ff_125c_3.63v.log  sha256:0a451ccea805f2a7e4e32680128340ff61158b1a40fbc642a2234d92029548a5
wall_time: 12.0s
---

## Result

- `i_reset_xsb_a`: 2.761400e-08
- `p_reset_xsb_w`: 1.002388e-07
- `i_reset_xsb_first_a`: 4.001600e-08
- `i_reset_xsb_last_a`: 1.521200e-08
- `q_v`: -5.594084e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
