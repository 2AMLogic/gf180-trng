---
record: 2026-08-02-sampler-dff-reset-current-xsb-08
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-08/
  files:
    - tt_125c_3.30v.spice  sha256:1e495b7f3fe5cfc5f6a1eae733f1957785275215dc83276b247a3d085f08ca9a
    - tt_125c_3.30v.log  sha256:5edf245fff158dfe058d2a780985fc319d4b46cba96a96307031bcd9917ad2ca
wall_time: 12.4s
---

## Result

- `i_reset_xsb_a`: 2.617825e-08
- `p_reset_xsb_w`: 8.638823e-08
- `i_reset_xsb_first_a`: 4.013200e-08
- `i_reset_xsb_last_a`: 1.222450e-08
- `q_v`: -1.687889e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners tt --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
