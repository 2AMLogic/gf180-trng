---
record: 2026-08-02-sampler-dff-reset-current-xsv-33
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-33/
  files:
    - fs_27c_3.63v.spice  sha256:12210107e6c66a121965fb29a9b6d921f8fe26662f5e40d12c640e7d0c204852
    - fs_27c_3.63v.log  sha256:9f7b3664ae120b5fd681eb3757626f590b2fc889de616bb27ecc6a3351a152b8
wall_time: 3.0s
---

## Result

- `i_reset_xsv_a`: 7.846379e-11
- `p_reset_xsv_w`: 2.848236e-10
- `v_q`: 1.819858e-08
- `v_m`: 3.63
- `v_mb`: 3.63
- `v_qb`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners fs --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
