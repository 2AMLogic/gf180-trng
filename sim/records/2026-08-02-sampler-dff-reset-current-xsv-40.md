---
record: 2026-08-02-sampler-dff-reset-current-xsv-40
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-40/
  files:
    - sf_27c_2.97v.spice  sha256:618c47226a3f177794c36b8be3acb60359146d9fe52ea52c55b46098cae4ab46
    - sf_27c_2.97v.log  sha256:6f970a4bcd0b91e7770c1ecbb8faf2fc5eebf4c49e1999695259fe0bdcbe04c3
wall_time: 2.7s
---

## Result

- `i_reset_xsv_a`: 4.382312e-11
- `p_reset_xsv_w`: 1.301547e-10
- `v_q`: 1.941892e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
