---
record: 2026-08-02-sampler-dff-reset-current-xsb-10
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-10/
  files:
    - ff_-40c_2.97v.spice  sha256:2671fc33bdd9a83653694aa5ecd466ed9c49787019b5d9d00227ecd38ebbd611
    - ff_-40c_2.97v.log  sha256:7d23046bf49c725eb182d84012bcf79c19e74e58130e31e087a2a546f036b665
wall_time: 12.8s
---

## Result

- `i_reset_xsb_a`: 1.474850e-08
- `p_reset_xsb_w`: 4.380305e-08
- `i_reset_xsb_first_a`: 2.256850e-08
- `i_reset_xsb_last_a`: 6.928500e-09
- `q_v`: -8.565512e-07
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
