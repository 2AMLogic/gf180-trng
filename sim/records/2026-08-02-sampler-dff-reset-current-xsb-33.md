---
record: 2026-08-02-sampler-dff-reset-current-xsb-33
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-33/
  files:
    - fs_27c_3.63v.spice  sha256:8a7f73c9dbfde77f497f0c027d617559007c2bba034c86111a921aab600db84a
    - fs_27c_3.63v.log  sha256:b1286cf6bad72688d3770d68c75ca31f52c67ddfec0d8442cf03b58c9cc05361
wall_time: 12.8s
---

## Result

- `i_reset_xsb_a`: 2.045750e-08
- `p_reset_xsb_w`: 7.426073e-08
- `i_reset_xsb_first_a`: 3.014700e-08
- `i_reset_xsb_last_a`: 1.076800e-08
- `q_v`: -5.664227e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
