---
record: 2026-08-01-sampler-dff-reset-current-xsv-42
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-42/
  files:
    - sf_27c_3.63v.spice  sha256:341d7fed23f846725e3b67702d1597f13bb96c8fbe96aaba1d1f8214dfdd5369
    - sf_27c_3.63v.log  sha256:09ddaf17a9e9f2d1bd646327c9625a68a7e20f9e42e062d60a853ad0eeb995e5
wall_time: 1.4s
---

## Result

- `i_reset_xsv_a`: 2.256867e-04
- `p_reset_xsv_w`: 8.192426e-04
- `v_q`: 2.152966e-08
- `v_m`: 1.1903
- `v_rst`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
