---
record: 2026-08-01-sampler-dff-reset-clocked-41
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-41/
  files:
    - sf_27c_3.30v.spice  sha256:40d908a60d9254639b5e4774ea7d11a3e51eceaad80bddca8202703e30ac432e
    - sf_27c_3.30v.log  sha256:cbb608ddf768884ebfa27a3c48b6abf35656c366272b60e5d554bf8d92098eca
wall_time: 1.7m
---
...
- `q_rst_max_v`: 0.13526
- `q_rst_max_frac`: 0.040988
- `s_rst_min_v`: 2.79738
- `s_rst_dev_frac`: 0.152308
- `mb_rst_min_v`: 3.14766
- `q_rel_v`: 2.043370e-06
- `q_cap_v`: 3.30001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
