---
record: 2026-08-02-sampler-dff-active-current-39
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-39/
  files:
    - sf_-40c_3.63v.spice  sha256:82de8c1ca439f8b27b4dcebf10d04d58c05124a94fdb448fa8594f63e2ea831c
    - sf_-40c_3.63v.log  sha256:ab0d25d15a9bed561004dc398277455191a3c38447eb006d0534351162da7f8b
wall_time: 11.7s
---

## Result

- `q_d_shut_c`: 6.666667e-20
- `q_d_open_c`: 8.827467e-15
- `e_d_shut_j`: 2.420000e-19
- `e_d_open_j`: 3.204370e-14
- `q_clkcyc_xsv_c`: 8.364210e-15
- `e_clkcyc_xsv_j`: 3.036208e-14
- `q_clkcyc_xsb_resid_c`: 1.060400e-15
- `q_cyc_xsb_total_c`: 9.816320e-14
- `q_d_shut_xsv_c`: 5.500000e-20
- `q_d_open_xsv_c`: 5.500000e-20
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 1.751445e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -9.543854e-08
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners sf --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
