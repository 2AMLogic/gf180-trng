---
record: 2026-08-02-sampler-dff-reset-current-xsb-29
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-29/
  files:
    - fs_-40c_3.30v.spice  sha256:9c923e2904f0010ef8ca8f12057b6ab4370c8a8f51ed10c7ee713471990427b0
    - fs_-40c_3.30v.log  sha256:959cf12764e9828550b3ab57d72a075a7f5cdfcc980c99d2ec8d8068e6d07f56
wall_time: 13.4s
---

## Result

- `i_reset_xsb_a`: 1.598300e-08
- `p_reset_xsb_w`: 5.274390e-08
- `i_reset_xsb_first_a`: 2.386050e-08
- `i_reset_xsb_last_a`: 8.105500e-09
- `q_v`: -2.711782e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
