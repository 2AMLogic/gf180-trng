---
record: 2026-08-02-sampler-dff-active-current-18
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-18/
  files:
    - ff_125c_3.63v.spice  sha256:0deec67159ebdcf54998b6ee74686d3c324cb6ad8e906c50fc3e0e28d64c7640
    - ff_125c_3.63v.log  sha256:40218e9d88bacfb8ec3ff09c88e44fdc7bf9a0b107c2eb1e3a7a18029df1f878
wall_time: 16.0s
---

## Result

- `q_d_shut_c`: 2.533333e-18
- `q_d_open_c`: 9.818267e-15
- `e_d_shut_j`: 9.196000e-18
- `e_d_open_j`: 3.564031e-14
- `q_clkcyc_xsv_c`: 8.631870e-15
- `e_clkcyc_xsv_j`: 3.133369e-14
- `q_clkcyc_xsb_resid_c`: 2.051933e-15
- `q_cyc_xsb_total_c`: 1.100782e-13
- `q_d_shut_xsv_c`: 4.160000e-18
- `q_d_open_xsv_c`: 5.821667e-18
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 6.791303e-07
- `qv_post_v`: 3.62998
- `qb_pre_v`: 3.513221e-07
- `qb_post_v`: 3.62998
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ff --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
