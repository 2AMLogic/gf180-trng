---
record: 2026-08-02-sampler-dff-active-current-37
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-37/
  files:
    - sf_-40c_2.97v.spice  sha256:99293f700b9b1035c29d996f3e432ac2c3c61efc3ce11f8579038c5ef9029ba5
    - sf_-40c_2.97v.log  sha256:0a483eeacc6e5d070b1bbcfe88886a51be683689f54ee22bc59e7a6a33fbaec6
wall_time: 11.5s
---

## Result

- `q_d_shut_c`: 4.333333e-20
- `q_d_open_c`: 7.050250e-15
- `e_d_shut_j`: 1.287000e-19
- `e_d_open_j`: 2.093924e-14
- `q_clkcyc_xsv_c`: 6.831650e-15
- `e_clkcyc_xsv_j`: 2.029000e-14
- `q_clkcyc_xsb_resid_c`: 5.929167e-16
- `q_cyc_xsb_total_c`: 7.814610e-14
- `q_d_shut_xsv_c`: 4.500000e-20
- `q_d_open_xsv_c`: 4.500000e-20
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 1.544738e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -1.383537e-07
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners sf --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
