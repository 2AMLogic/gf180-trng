---
record: 2026-08-01-conditioner-crc32-01
date: 2026-08-01T09:26:54Z
status: valid
...
raw:
  path: sim/records/raw/2026-08-01-conditioner-crc32-01/
  files:
    - raw_bits.bin  sha256:f18dda795c7655199dd9c594494003fb1e22ffce3f0a37704b09c6180b07d1c6
    - cond_words.hex  sha256:7d29d6c6e3c00c824a8f1eee7d9dbe9ecb8b9b8354f5aa707d31c9ac043e53a1
    - summary.json  sha256:0144bcdfa18696eb7fff456e0ca58349275808be5bee55891f58640e918b310f
wall_time: 1.8s
---

## Result

Scenario `h050` -- the DR-0002 / DR-0007 design target H0 = 0.5 bit/sample -- the operating point the health-test cutoffs and the DR-0007 array sizing law are both written against.

| Quantity | Value |
|---|---|
| raw bits in | 131072 |
| raw ones | 38783 |
| raw P(1) measured | 0.295891 |
| raw most-common-value min-entropy measured | 0.506129 bit/sample |
| conditioned words out | 512 |
| conditioned bits out | 16384 |
| conditioned P(1) measured | 0.498718 |
| conditioned distinct words | 512 of 512 |
| conditioned ones per bit position (min-max) | 225-282 of 512 |
| compression ratio K measured | 8.0000 |
| flush events | 0 |
| raw bits discarded by flush | 0 |
| conditioned stream sha256 | `7d29d6c6e3c00c824a8f1eee7d9dbe9ecb8b9b8354f5aa707d31c9ac043e53a1` |
...
```sh
python3 sim/tb/conditioner-crc32/run_demo.py --scenario h050 --no-write
```
