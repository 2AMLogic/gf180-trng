---
record: 2026-08-01-sampler-dff-reset-clocked-22
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-22/
  files:
    - ss_27c_2.97v.spice  sha256:127de55d0368f9edc8eb2d2514515871a65953973ebfe9b56340bfd59f8e1090
    - ss_27c_2.97v.log  sha256:34d09710350a96bb6bcaa0b99f3a2ee3dd53448adbe13e6086a003d7a9a58441
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.120185
- `q_rst_max_frac`: 0.0404664
- `s_rst_min_v`: 2.53895
- `s_rst_dev_frac`: 0.145136
- `mb_rst_min_v`: 2.83256
- `q_rel_v`: 6.410343e-07
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
