---
record: 2026-08-01-sampler-dff-reset-current-xsv-21
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-21/
  files:
    - ss_-40c_3.63v.spice  sha256:e7270db8adb62c613c8634c9e8aca226893f52247aeca60285088cc9af4e3dcc
    - ss_-40c_3.63v.log  sha256:14926de9c01756cac01a45d0dc7377003323a258199e395fc071dbb90953e878
wall_time: 1.0s
---

## Result

- `i_reset_xsv_a`: 2.112263e-04
- `p_reset_xsv_w`: 7.667515e-04
- `v_q`: 1.800217e-08
- `v_m`: 0.965774
- `v_rst`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
