---
record: 2026-08-02-ro-array-core-pvt-q-21
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-21/
  files:
    - ss_-40c_3.63v.spice  sha256:52d62096102a46162c47d05916e59eeebdd827449f31c8b324fa3f697093c752
    - ss_-40c_3.63v.log  sha256:4f5fbaa850fe5cb005646ffdf6526664b51ad37ebf300bd556bf2114ebd4ecea
wall_time: 10.8m
---

## Result

- `period_r1`: 6.153907e-09
- `period_r2`: 5.796494e-09
- `f_r1`: 1.624984e+08
- `f_r2`: 1.725181e+08
- `i_r1_a`: -2.204113e-05
- `i_r2_a`: -2.354877e-05
- `i_tree_a`: -1.963754e-05
- `e_cycle_r1_j`: -4.923698e-13
- `c_eff_node_r1_f`: -3.396921e-15
- `ring_swing_v`: 3.89723
- `xo_swing_v`: 3.75328
- `i_total_a`: -6.522744e-05
- `p_rings_w`: -1.654913e-04
- `p_total_w`: -2.367756e-04
- `xo_trans_per_s`: 6.700329e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
