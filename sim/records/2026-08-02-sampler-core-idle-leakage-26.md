---
record: 2026-08-02-sampler-core-idle-leakage-26
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-26/
  files:
    - ss_125c_3.30v.spice  sha256:9f3a6e8be275bd3c88ba0bc0949ebd4626cc7bb3cfc50331066f60034ab0ede4
    - ss_125c_3.30v.log  sha256:b9511cf13145cc7bc82920655f35113a9139cc9b1ab20653b906e5f9d440c29a
wall_time: 46.7s
---

## Result

- `i_idle_clklo_a`: 6.396000e-10
- `i_idle_clkhi_a`: 4.285500e-10
- `p_idle_clklo_w`: 2.110680e-09
- `p_idle_clkhi_w`: 1.414215e-09
- `i_idle_clklo_prev_a`: 6.484500e-10
- `i_idle_clkhi_prev_a`: 4.285500e-10
- `i_idle_worst_a`: 6.396000e-10
- `p_idle_worst_w`: 2.110680e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 7.333367e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 2.451985e-07
- `v_rawbit_clklo_v`: 6.624512e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 3.434016e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
