---
record: 2026-08-01-sampler-dff-reset-clocked-18
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-18/
  files:
    - ff_125c_3.63v.spice  sha256:bb14e9e1317d5e56ab4dca207d7215431c2a9c1f6492de3af5492fc51a02c919
    - ff_125c_3.63v.log  sha256:8e82080db1e12f272ab454ff873a31c94389fd0b2c9af61b73a276e4abb70deb
wall_time: 1.9m
---

## Result

- `q_rst_max_v`: 0.138515
- `q_rst_max_frac`: 0.0381584
- `s_rst_min_v`: 3.08991
- `s_rst_dev_frac`: 0.148784
- `mb_rst_min_v`: 3.47781
- `q_rel_v`: 3.706185e-06
- `q_cap_v`: 3.62999
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
