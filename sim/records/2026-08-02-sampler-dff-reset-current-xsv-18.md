---
record: 2026-08-02-sampler-dff-reset-current-xsv-18
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-18/
  files:
    - ff_125c_3.63v.spice  sha256:b7d33775535d2c0d9cdb483d33d7c187be7e623279d77a466877c2dfd488b885
    - ff_125c_3.63v.log  sha256:72ec1cd293ed7cc2f884bd592d9f00b04c8fd520f95f744ef463b5a72aa8eb46
wall_time: 3.4s
---

## Result

- `i_reset_xsv_a`: 5.085956e-09
- `p_reset_xsv_w`: 1.846202e-08
- `v_q`: 6.784362e-07
- `v_m`: 3.62998
- `v_mb`: 3.62999
- `v_qb`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
