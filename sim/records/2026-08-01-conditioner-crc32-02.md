---
record: 2026-08-01-conditioner-crc32-02
date: 2026-08-01T09:26:56Z
status: valid
...
source_model:
  ...
  declared_min_entropy_per_sample: 0.106456
  target_p_one: 0.071132963907
  u32_threshold: 305513754
...
raw:
  path: sim/records/raw/2026-08-01-conditioner-crc32-02/
  files:
    - raw_bits.bin  sha256:6fecb6797e9d4aa545a04297d692aad97bc079d52888e197bd5d638e609616b2
    - cond_words.hex  sha256:e7e765177c3cd795c547ad871cbda85c0c5d27f751ef232b1133e48de990d937
    - summary.json  sha256:c0cf992671f866fbce144734a3d0de7e03dbbb4fce2236d6275405a8b05d473f
wall_time: 1.6s
---

## Result

Scenario `h0107` -- the break-even input min-entropy computed by sp800_90b.py for K = 8 -- the point at which the SP 800-90B non-vetted cap stops being the binding term on output entropy.

| Quantity | Value |
|---|---|
| raw bits in | 131072 |
| raw ones | 9226 |
| raw P(1) measured | 0.070389 |
| raw most-common-value min-entropy measured | 0.105301 bit/sample |
| conditioned words out | 512 |
| conditioned bits out | 16384 |
| conditioned P(1) measured | 0.499817 |
| conditioned distinct words | 512 of 512 |
| conditioned ones per bit position (min-max) | 236-282 of 512 |
| compression ratio K measured | 8.0000 |
| flush events | 0 |
| raw bits discarded by flush | 0 |
| conditioned stream sha256 | `e7e765177c3cd795c547ad871cbda85c0c5d27f751ef232b1133e48de990d937` |
...
| Quantity | Value |
|---|---|
| declared input min-entropy per block | 27.252736 bit |
| output entropy before the non-vetted cap | 27.199996 bit/word |
| output entropy credited to a non-vetted component | 27.199996 bit/word |
...
```sh
python3 sim/tb/conditioner-crc32/run_demo.py --scenario h0107 --no-write
```
