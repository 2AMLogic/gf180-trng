---
record: 2026-08-02-sampler-dff-active-current-09
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-09/
  files:
    - tt_125c_3.63v.spice  sha256:76c7bf5d6ed9583d208f689c448d7448418f6ef737482b34cbcb600550015bf2
    - tt_125c_3.63v.log  sha256:cfbed159c93c3f0294f8277414ef81377abcd391b93620071109ac00b1fbe10b
wall_time: 13.5s
---

## Result

- `q_d_shut_c`: 3.000000e-19
- `q_d_open_c`: 9.545600e-15
- `e_d_shut_j`: 1.089000e-18
- `e_d_open_j`: 3.465053e-14
- `q_clkcyc_xsv_c`: 8.568090e-15
- `e_clkcyc_xsv_j`: 3.110217e-14
- `q_clkcyc_xsb_resid_c`: 1.333300e-15
- `q_cyc_xsb_total_c`: 1.063379e-13
- `q_d_shut_xsv_c`: 4.383333e-19
- `q_d_open_xsv_c`: 5.983333e-19
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 8.476818e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -8.868533e-07
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
