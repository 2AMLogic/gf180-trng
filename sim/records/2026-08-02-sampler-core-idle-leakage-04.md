---
record: 2026-08-02-sampler-core-idle-leakage-04
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-04/
  files:
    - tt_27c_2.97v.spice  sha256:abf5e683442b8d709e2801f6e69f1639758d8c7fc0fd8b8e4b4509d86ad8d489
    - tt_27c_2.97v.log  sha256:0fdd5936e47a4444a4487cd83702b29a1006630098920b8b411bc6739d1049fe
wall_time: 1.5m
---

## Result

- `i_idle_clklo_a`: 3.382500e-10
- `i_idle_clkhi_a`: 1.875500e-10
- `p_idle_clklo_w`: 1.004602e-09
- `p_idle_clkhi_w`: 5.570235e-10
- `i_idle_clklo_prev_a`: 3.443500e-10
- `i_idle_clkhi_prev_a`: 1.875500e-10
- `i_idle_worst_a`: 3.382500e-10
- `p_idle_worst_w`: 1.004602e-09
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 7.632242e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 1.187013e-07
- `v_rawbit_clklo_v`: -5.357857e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.832004e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
