---
record: 2026-08-02-sampler-dff-reset-current-xsb-09
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-09/
  files:
    - tt_125c_3.63v.spice  sha256:1c37adfe0c8c9d86e99f243029d64b4900208204d05f448869d652e8cea6dc8c
    - tt_125c_3.63v.log  sha256:1e30a8cec6a75719cf0c1ad518c6fd83b15f109488d09950f5e8024f007d44a3
wall_time: 12.2s
---

## Result

- `i_reset_xsb_a`: 2.658150e-08
- `p_reset_xsb_w`: 9.649084e-08
- `i_reset_xsb_first_a`: 4.021550e-08
- `i_reset_xsb_last_a`: 1.294750e-08
- `q_v`: -1.368213e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners tt --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
