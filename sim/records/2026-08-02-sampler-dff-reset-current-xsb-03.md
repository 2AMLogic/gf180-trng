---
record: 2026-08-02-sampler-dff-reset-current-xsb-03
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-03/
  files:
    - tt_-40c_3.63v.spice  sha256:18a1ab50993ac6df1ce31428d3067fbb8d474df11115adbe48022fd62714f21e
    - tt_-40c_3.63v.log  sha256:e77c972cc71ef7c6aa75f783920788eac2ea8f70220ab62b93c9d4c6677ce733
wall_time: 11.9s
---

## Result

- `i_reset_xsb_a`: 1.947325e-08
- `p_reset_xsb_w`: 7.068790e-08
- `i_reset_xsb_first_a`: 2.760000e-08
- `i_reset_xsb_last_a`: 1.134650e-08
- `q_v`: -1.403090e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners tt --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
