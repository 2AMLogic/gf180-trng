---
record: 2026-08-02-sampler-dff-reset-current-xsv-30
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-30/
  files:
    - fs_-40c_3.63v.spice  sha256:bbcfeb199e46146f3727a127859e4ec5553a2f5421eadd73624e64b2f1c9f069
    - fs_-40c_3.63v.log  sha256:5d65f385f1e66761be8ef1e17a8215d77e3eecfcbc41a1512440ee452bf663c5
wall_time: 2.8s
---

## Result

- `i_reset_xsv_a`: 5.356778e-11
- `p_reset_xsv_w`: 1.944510e-10
- `v_q`: 1.546414e-08
- `v_m`: 3.63
- `v_mb`: 3.63
- `v_qb`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners fs --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
