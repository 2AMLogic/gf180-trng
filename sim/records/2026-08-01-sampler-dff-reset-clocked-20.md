---
record: 2026-08-01-sampler-dff-reset-clocked-20
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-20/
  files:
    - ss_-40c_3.30v.spice  sha256:d309d056d10a56dd47fc1de4587da2f1ba04d99a3b3c8f3a1e3db64f952db6b8
    - ss_-40c_3.30v.log  sha256:aa61d1288a2d96eb658a3bfad756eff28fe3d9bf64d8ac721e8b5cc340595624
wall_time: 1.7m
---

## Result

- `q_rst_max_v`: 0.137656
- `q_rst_max_frac`: 0.0417141
- `s_rst_min_v`: 2.80994
- `s_rst_dev_frac`: 0.148503
- `mb_rst_min_v`: 3.14224
- `q_rel_v`: 2.847124e-06
- `q_cap_v`: 3.30001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
