---
record: 2026-08-01-sampler-dff-reset-current-xsb-40
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-40/
  files:
    - sf_27c_2.97v.spice  sha256:b40aeb2c77650832c2c7a1ce73f004176fc2935ee1a5318e440eb08afc309da7
    - sf_27c_2.97v.log  sha256:140722f4301cf387f3e5436990a177ef751afd5e01fd4e85fd427a7afba85163
wall_time: 4.4s
---

## Result

- `i_reset_xsb_a`: 7.714686e-05
- `p_reset_xsb_w`: 2.291262e-04
- `i_reset_xsb_first_a`: 7.714688e-05
- `i_reset_xsb_last_a`: 7.714685e-05
- `q_v`: -5.490580e-08
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
