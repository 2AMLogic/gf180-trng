---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-36
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-36/
  files:
    - fs_125c_3.63v.spice  sha256:9f3404bf2277bbed50e87686778af50b93b72b304e2dacba7493563e66d9fc28
    - fs_125c_3.63v.log  sha256:787ac0299cbc6edf4b7ee753950a775ab53e374632aec53b8612c197376f87c2
wall_time: 0.7s
---

## Result

- `i_leak_a`: 5.619428e-09
- `p_idle_w`: 2.039852e-08
- `v_n1`: 3.62999
- `v_n2`: 1.323608e-08
- `v_n3`: 3.63
- `v_n4`: 1.323552e-08
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners fs --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
