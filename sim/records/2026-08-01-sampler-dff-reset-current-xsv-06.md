---
record: 2026-08-01-sampler-dff-reset-current-xsv-06
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-06/
  files:
    - tt_27c_3.63v.spice  sha256:8bfbcfdab4b4b1de2e0133726543ef0f17df6db923b79f0ed943ea3b1877bd4a
    - tt_27c_3.63v.log  sha256:a45a8227425d3c09769d5f5dc65b728a9ae17ed51ff2cbd529fc976275b0589f
wall_time: 1.3s
---

## Result

- `i_reset_xsv_a`: 2.329478e-04
- `p_reset_xsv_w`: 8.456006e-04
- `v_q`: 1.953188e-08
- `v_m`: 1.06929
- `v_rst`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners tt --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
