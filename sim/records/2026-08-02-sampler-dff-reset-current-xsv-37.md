---
record: 2026-08-02-sampler-dff-reset-current-xsv-37
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-37/
  files:
    - sf_-40c_2.97v.spice  sha256:4de3b43a5f71b08ed679c569fc76dcd8c560174e7dc6ad92014a864bcf235b0b
    - sf_-40c_2.97v.log  sha256:f6eedc555b6b421b88e3d9af4688ea4799f72d617fe38997670ca1b35adc74d7
wall_time: 3.1s
---

## Result

- `i_reset_xsv_a`: 4.317101e-11
- `p_reset_xsv_w`: 1.282179e-10
- `v_q`: 1.544730e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
