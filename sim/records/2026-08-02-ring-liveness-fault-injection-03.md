---
record: 2026-08-02-ring-liveness-fault-injection-03
...
raw:
  path: sim/records/raw/2026-08-02-ring-liveness-fault-injection-03/
  files:
    - summary.json  sha256:bb5c13f4e84339d536fd178b42c7cd977fb2ece0ef0b654ebe6a714534077e26
    - raw_rows.bin  sha256:0ac3595800a77cfbf8c79dedceba35ef700ee447172fbbf0ade44116ed49e6bb
wall_time: 0.1s
---

## Result

Scenario `ring2-stuck` -- the same fault as ring1-stuck, on the other ring -- confirms the monitor is symmetric across N_RINGS and not accidentally wired to only one channel.
...
```sh
python3 sim/tb/ring-liveness-fault-injection/run_demo.py --scenario ring2-stuck --no-write
```
