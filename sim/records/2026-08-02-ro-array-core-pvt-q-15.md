---
record: 2026-08-02-ro-array-core-pvt-q-15
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-15/
  files:
    - ff_27c_3.63v.spice  sha256:b7e1d2fe14e8a29cbe30d96cfa4f8b1978673dba33ff63efb3c423fe65f6e9d0
    - ff_27c_3.63v.log  sha256:798d9d0f04b09c33695e13d0592a43e6609c83dd6905d43770ecaaacc697f518
wall_time: 8.2m
---

## Result

- `period_r1`: 5.453234e-09
- `period_r2`: 5.154790e-09
- `f_r1`: 1.833774e+08
- `f_r2`: 1.939943e+08
- `i_r1_a`: -2.991483e-05
- `i_r2_a`: -3.181524e-05
- `i_tree_a`: -3.658476e-05
- `e_cycle_r1_j`: -5.921712e-13
- `c_eff_node_r1_f`: -4.085464e-15
- `ring_swing_v`: 3.82912
- `xo_swing_v`: 3.70127
- `i_total_a`: -9.831484e-05
- `p_rings_w`: -2.240802e-04
- `p_total_w`: -3.568829e-04
- `xo_trans_per_s`: 7.547435e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ff --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
