---
record: 2026-08-02-sampler-core-idle-leakage-03
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-03/
  files:
    - tt_-40c_3.63v.spice  sha256:24ec0d10e9c06bc161fc476b0e64f66d1311fab5896017a41682aff20bbfeca7
    - tt_-40c_3.63v.log  sha256:1246011cb4975186000c87cad626b389c66ed62d448849f724ec0c35ad31f9b8
wall_time: 1.5m
---

## Result

- `i_idle_clklo_a`: 4.118000e-10
- `i_idle_clkhi_a`: 2.205500e-10
- `p_idle_clklo_w`: 1.494834e-09
- `p_idle_clkhi_w`: 8.005965e-10
- `i_idle_clklo_prev_a`: 4.193500e-10
- `i_idle_clkhi_prev_a`: 2.205500e-10
- `i_idle_worst_a`: 4.118000e-10
- `p_idle_worst_w`: 1.494834e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 7.516147e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 9.842615e-08
- `v_rawbit_clklo_v`: -6.741104e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.704754e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
