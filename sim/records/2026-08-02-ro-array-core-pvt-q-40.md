---
record: 2026-08-02-ro-array-core-pvt-q-40
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-40/
  files:
    - ff_27c_2.97v.spice  sha256:66d3711fcaae9791100881eed603f0909afa3243f72cd908d1a11ddeed026949
    - ff_27c_2.97v.log  sha256:d681458fd6e82ee00b90c6a01d2085dde39cbca87cc3b75df1290d99e145a6a1
wall_time: 3.4m
---

## Result

- `period_r1`: 6.183140e-09
- `period_r2`: 5.782593e-09
- `f_r1`: 1.617301e+08
- `f_r2`: 1.729328e+08
- `i_r1_a`: -1.922823e-05
- `i_r2_a`: -2.049657e-05
- `i_tree_a`: -1.746550e-05
- `e_cycle_r1_j`: -3.531058e-13
- `c_eff_node_r1_f`: -3.639144e-15
- `ring_swing_v`: 3.10435
- `xo_swing_v`: 3.10311
- `i_total_a`: -5.719030e-05
- `p_rings_w`: -1.179827e-04
- `p_total_w`: -1.698552e-04
- `xo_trans_per_s`: 6.693259e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ff --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
