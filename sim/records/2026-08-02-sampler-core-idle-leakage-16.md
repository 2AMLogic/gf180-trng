---
record: 2026-08-02-sampler-core-idle-leakage-16
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-16/
  files:
    - ff_125c_2.97v.spice  sha256:f0ba7ab4cfa1b6f13bcc29915a5838bea6b2459a2892392dfd5f6697254a39d0
    - ff_125c_2.97v.log  sha256:0c21f5164af68c5a269596d6c9fbf0d512ea957f17dc0f81c55e55ad954850b5
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 2.019680e-08
- `i_idle_clkhi_a`: 1.804015e-08
- `p_idle_clklo_w`: 5.998450e-08
- `p_idle_clkhi_w`: 5.357925e-08
- `i_idle_clklo_prev_a`: 2.020530e-08
- `i_idle_clkhi_prev_a`: 1.804015e-08
- `i_idle_worst_a`: 2.019680e-08
- `p_idle_worst_w`: 5.998450e-08
- `v_ro1_v`: 2.96985
- `v_ro2_v`: 2.96986
- `v_xo_v`: 2.486892e-06
- `v_n1_v`: 2.9699
- `v_n2_v`: 4.473523e-06
- `v_rawbit_clklo_v`: -6.028962e-06
- `v_rawvalid_clklo_v`: 2.96999
- `v_rawbit_clkhi_v`: 6.069034e-07
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
