---
record: 2026-08-01-sampler-dff-reset-clocked-19
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-19/
  files:
    - ss_-40c_2.97v.spice  sha256:bb5ac2d703273bd2c0567d76679d9da2239925875bbaaeb9a65dfe9f145d879f
    - ss_-40c_2.97v.log  sha256:18e8e9fb6b799f6fabf4b086f4413051d4da7a4d4e138bddabcec3fab1bfc85c
wall_time: 1.7m
---

## Result

- `q_rst_max_v`: 0.122576
- `q_rst_max_frac`: 0.0412713
- `s_rst_min_v`: 2.53839
- `s_rst_dev_frac`: 0.145322
- `mb_rst_min_v`: 2.82931
- `q_rel_v`: 1.011708e-06
- `q_cap_v`: 2.97001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
