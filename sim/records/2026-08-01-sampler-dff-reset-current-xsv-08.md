---
record: 2026-08-01-sampler-dff-reset-current-xsv-08
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-08/
  files:
    - tt_125c_3.30v.spice  sha256:6be5ae8961178b10fd16bf533c3dc9350e64d0c4538f1c1e0057d9c6ed21c7e4
    - tt_125c_3.30v.log  sha256:a3e17cc0ef4bbb8bf91c600313ce4823b629c4a8840e5c668ea6e0a2d0b849f1
wall_time: 1.3s
---

## Result

- `i_reset_xsv_a`: 1.696308e-04
- `p_reset_xsv_w`: 5.597817e-04
- `v_q`: 8.091112e-08
- `v_m`: 1.00133
- `v_rst`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners tt --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
