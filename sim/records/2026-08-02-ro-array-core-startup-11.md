---
record: 2026-08-02-ro-array-core-startup-11
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-startup-11/
  files:
    - ff_-40c_3.30v.spice  sha256:0aed8648ae1efb9bb9c6ca3c213b41d7e6f14f9ced9bbc7cae6df8ddc17de30c
    - ff_-40c_3.30v.log  sha256:fd426a3fda2e0d2a87940dec6f743d450b7e85796d9f88584aaf88c26690bc8e
wall_time: 2.7m
---
...
- `t8r2_s`: 4.028399e-08
- `t9r2_s`: 4.468171e-08
- `t10r2_s`: 4.907423e-08
- `t1xo_s`: 7.121049e-09
- `t2xo_s`: 9.605548e-09
- `t3xo_s`: 1.153386e-08
- `t4xo_s`: 1.398264e-08
- `ring_swing_early_v`: 3.39805
- `ring_swing_late_v`: 3.49131
- `xo_swing_early_v`: 3.35125
- `xo_swing_late_v`: 3.39191
- `v_ro1_off_v`: 3.3
- `v_xo_off_v`: 8.531498e-08
...
```sh
python3 sim/run_corners.py ro-array-core-startup --corners ff --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
