---
record: 2026-08-01-sampler-dff-setup-hold-37
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-setup-hold-37/
  files:
    - sf_-40c_2.97v.spice  sha256:9ac981c26c5d505841c724ea3ea8adb591ada713b0e765c7e4b24101b84750ff
    - sf_-40c_2.97v.log  sha256:d0135a11a1b1c98b9c01ad434898d9e0d544da9193a162a1c93d2f5f488f21aa
wall_time: 1.7m
---

## Result

- `tpd_clk_q_rise_s`: 1.133000e-10
- `tpd_clk_q_fall_s`: 1.290000e-10
- `q_rst_v`: 1.544736e-08
- `q_e1_v`: 2.97001
- `q_e2_v`: 3.875117e-07
- `q_e4_v`: 1.689513e-06
- `q_e3_1ns_v`: 1.992078e-04
- `q_e3_10ns_v`: -3.844093e-06
- `q_e3_100ns_v`: -3.679662e-06
- `q_e3_drift_v`: -2.028875e-04
- `q_e3_rail_dev_v`: -3.679662e-06
- `q_e5_1ns_v`: 0.00109297
- `q_e5_10ns_v`: 2.736616e-06
- `q_e5_100ns_v`: 2.643586e-06
- `q_e5_drift_v`: -0.00109033
- `q_e5_rail_dev_v`: 2.643586e-06
- `q_e6_v`: 1.688515e-06
- `q_e7_1ns_v`: 2.97464
- `q_e7_10ns_v`: 2.97001
- `q_e7_100ns_v`: 2.97001
- `q_e7_drift_v`: -0.004632
- `q_e7_rail_dev_v`: -1.100000e-05
...
```sh
python3 sim/run_corners.py sampler-dff-setup-hold --corners sf --temps -40 --supply 2.97 --supply-tol 0 --no-write
```

## Caveats

- Single corner (sf / 2.97 V / -40 C). Says nothing about any other corner.
