---
record: 2026-08-01-health-test-fault-injection-01
date: 2026-08-01T23:07:30Z
status: valid
...
analysis:
  ...
  runs: 1
seeds: [10]   # SHA-256 counter-mode source, bit-identical on any platform
...
raw:
  path: sim/records/raw/2026-08-01-health-test-fault-injection-01/
  files:
    - summary.json  sha256:212f20a26ad1afab9510d69327d286370f1efc2cb35a134e1702b37dd4be2c9e
    - raw_bits.bin  sha256:f983c17e5676ef5d3497db42b8483df4a6770ae14891e849b6d1a80e6e7a8e98
wall_time: 0.0s
---

## Result

Scenario `healthy` -- the DR-0002 design target H0 = 0.5 bit/sample, run long enough to cover several full APT windows -- neither test should ever fire on a source whose declared min-entropy matches the assumption the cutoffs were derived from.

| Quantity | Value |
|---|---|
| raw bits driven | 4096 |
...
```sh
python3 sim/tb/health-test-fault-injection/run_demo.py --scenario healthy --no-write
```
