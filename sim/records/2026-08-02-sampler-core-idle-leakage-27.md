---
record: 2026-08-02-sampler-core-idle-leakage-27
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-27/
  files:
    - ss_125c_3.63v.spice  sha256:075474108395d6a71836fabc53294707057276d78c19c2f70459a09e26a91079
    - ss_125c_3.63v.log  sha256:4a71c8c438ad59ea522b94d3d12419fe2f55ea45024fb9a4a57c8c4b5fc138da
wall_time: 49.9s
---

## Result

- `i_idle_clklo_a`: 7.580500e-10
- `i_idle_clkhi_a`: 5.019000e-10
- `p_idle_clklo_w`: 2.751722e-09
- `p_idle_clkhi_w`: 1.821897e-09
- `i_idle_clklo_prev_a`: 7.678000e-10
- `i_idle_clkhi_prev_a`: 5.018500e-10
- `i_idle_worst_a`: 7.580500e-10
- `p_idle_worst_w`: 2.751722e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 8.214930e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 2.464961e-07
- `v_rawbit_clklo_v`: -6.976664e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 3.305483e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
