---
record: 2026-08-01-sampler-dff-reset-current-xsv-09
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-09/
  files:
    - tt_125c_3.63v.spice  sha256:d876dcf202fd0c13402e8e31bf98eff77a0d0eefe11e21f2f4c43ffdc313cadc
    - tt_125c_3.63v.log  sha256:e86244a163508bb92ef5dacc4b598b20396a43655c054baca059508caa108d38
wall_time: 1.5s
---

## Result

- `i_reset_xsv_a`: 2.027694e-04
- `p_reset_xsv_w`: 7.360528e-04
- `v_q`: 8.476175e-08
- `v_m`: 1.12632
- `v_rst`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners tt --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
