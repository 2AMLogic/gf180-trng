---
record: 2026-08-02-sampler-core-idle-leakage-09
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-09/
  files:
    - tt_125c_3.63v.spice  sha256:6af42045c8894f9f9ddb3c368afb04ed97eb97d38f0b793c0760fc902d891b17
    - tt_125c_3.63v.log  sha256:d6d50ed0372db076623ca3491f31707ead7cb3d98a9603ce21c98df4b9f9f2bf
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 3.530350e-09
- `i_idle_clkhi_a`: 2.958150e-09
- `p_idle_clklo_w`: 1.281517e-08
- `p_idle_clkhi_w`: 1.073808e-08
- `i_idle_clklo_prev_a`: 3.541500e-09
- `i_idle_clkhi_prev_a`: 2.958200e-09
- `i_idle_worst_a`: 3.530350e-09
- `p_idle_worst_w`: 1.281517e-08
- `v_ro1_v`: 3.62998
- `v_ro2_v`: 3.62998
- `v_xo_v`: 1.067711e-06
- `v_n1_v`: 3.62999
- `v_n2_v`: 6.176522e-07
- `v_rawbit_clklo_v`: -7.770445e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 8.560825e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
