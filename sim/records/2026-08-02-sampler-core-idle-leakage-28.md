---
record: 2026-08-02-sampler-core-idle-leakage-28
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-28/
  files:
    - fs_-40c_2.97v.spice  sha256:a0a16f5d28f7a7760ad5dbf1dae9e144a9c5f04fd74137adcdf1d2fd68b0b953
    - fs_-40c_2.97v.log  sha256:30d0ebcf72b5eaeb9cc61e7f9b3dde478e36f5445c9f650f147722375593c9d0
wall_time: 47.2s
---

## Result

- `i_idle_clklo_a`: 2.883500e-10
- `i_idle_clkhi_a`: 1.783500e-10
- `p_idle_clklo_w`: 8.563995e-10
- `p_idle_clkhi_w`: 5.296995e-10
- `i_idle_clklo_prev_a`: 2.927000e-10
- `i_idle_clkhi_prev_a`: 1.783500e-10
- `i_idle_worst_a`: 2.883500e-10
- `p_idle_worst_w`: 8.563995e-10
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 8.005318e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 8.242179e-08
- `v_rawbit_clklo_v`: -3.798205e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.273926e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
