---
record: 2026-08-01-sampler-dff-reset-clocked-05
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-05/
  files:
    - tt_27c_3.30v.spice  sha256:f95a92978279da7ca55745faa75e66772253c16b9352713ba42cfe71d55e72cc
    - tt_27c_3.30v.log  sha256:42c8ef2a74af8ca18336075ac01da56ec3ee99da172b62309dbc723a05c77351
wall_time: 2.3m
---

## Result

- `q_rst_max_v`: 0.133966
- `q_rst_max_frac`: 0.0405958
- `s_rst_min_v`: 2.80476
- `s_rst_dev_frac`: 0.150074
- `mb_rst_min_v`: 3.14949
- `q_rel_v`: 2.950341e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
