---
record: 2026-08-01-sampler-dff-reset-current-xsv-17
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-17/
  files:
    - ff_125c_3.30v.spice  sha256:dd70cdf90c9c0757a28b75fe9a1b56404ed1425a07dcbc8b066792c2ffd3b3d8
    - ff_125c_3.30v.log  sha256:78cc224fe4076469df61787d904ff76ebb6df76a7314d0dbbbf69be151c8b066
wall_time: 1.2s
---

## Result

- `i_reset_xsv_a`: 2.083844e-04
- `p_reset_xsv_w`: 6.876684e-04
- `v_q`: 6.368531e-07
- `v_m`: 1.05457
- `v_rst`: 3.29999
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
