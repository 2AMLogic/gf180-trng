---
record: 2026-08-01-sampler-dff-reset-clocked-31
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-31/
  files:
    - fs_27c_2.97v.spice  sha256:0fc52c02585611ef42854d1f79358d697ad409ba0db217c411cde336b3997c64
    - fs_27c_2.97v.log  sha256:faf315cc3d5d19986ea1f0b3a35eef030d4a2ce13f8a2123e14d37c15c9d0d0b
wall_time: 2.1m
---

## Result

- `q_rst_max_v`: 0.118216
- `q_rst_max_frac`: 0.0398035
- `s_rst_min_v`: 2.54096
- `s_rst_dev_frac`: 0.144459
- `mb_rst_min_v`: 2.83744
- `q_rel_v`: 2.398219e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
