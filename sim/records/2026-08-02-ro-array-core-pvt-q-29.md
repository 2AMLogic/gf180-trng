---
record: 2026-08-02-ro-array-core-pvt-q-29
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-29/
  files:
    - tt_-40c_3.30v.spice  sha256:89c86e621e9079fa74cff7b71b26d44801b8f2563c2a429f04404411109c0ed1
    - tt_-40c_3.30v.log  sha256:1a76c6d2296cac784b6448493791d7a46dc7dcce06e2337c9dd6b4ec181883f6
wall_time: 2.9m
---

## Result

- `period_r1`: 5.251570e-09
- `period_r2`: 4.916765e-09
- `f_r1`: 1.904192e+08
- `f_r2`: 2.033858e+08
- `i_r1_a`: -2.284300e-05
- `i_r2_a`: -2.432955e-05
- `i_tree_a`: -1.910094e-05
- `e_cycle_r1_j`: -3.958734e-13
- `c_eff_node_r1_f`: -3.304728e-15
- `ring_swing_v`: 3.46074
- `xo_swing_v`: 3.46996
- `i_total_a`: -6.627349e-05
- `p_rings_w`: -1.556694e-04
- `p_total_w`: -2.187025e-04
- `xo_trans_per_s`: 7.876100e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners tt --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
