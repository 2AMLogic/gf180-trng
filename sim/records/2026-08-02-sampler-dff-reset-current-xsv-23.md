---
record: 2026-08-02-sampler-dff-reset-current-xsv-23
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-23/
  files:
    - ss_27c_3.30v.spice  sha256:7cba761162e545be6db1a268ed2240286a72d5e5c2585b4ebfcf30442d2374f5
    - ss_27c_3.30v.log  sha256:7fa418f244de7fb20dd30b7b03b58a5170662f25794dd0f20f97f6d6b7c01ce7
wall_time: 3.2s
---

## Result

- `i_reset_xsv_a`: 4.838547e-11
- `p_reset_xsv_w`: 1.596720e-10
- `v_q`: 2.068339e-08
- `v_m`: 3.3
- `v_mb`: 3.3
- `v_qb`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
