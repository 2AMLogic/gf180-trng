---
record: 2026-08-02-sampler-core-idle-leakage-05
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-05/
  files:
    - tt_27c_3.30v.spice  sha256:c4282fa94bf170e0a15eb8e565f41890f6fceca64ba5eb776481b219b1302502
    - tt_27c_3.30v.log  sha256:99f1260026958c61ea4afa3577e57b416c2754201b6d772e1685ed0308eedb93
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 3.969500e-10
- `i_idle_clkhi_a`: 2.108000e-10
- `p_idle_clklo_w`: 1.309935e-09
- `p_idle_clkhi_w`: 6.956400e-10
- `i_idle_clklo_prev_a`: 4.045500e-10
- `i_idle_clkhi_prev_a`: 2.108000e-10
- `i_idle_worst_a`: 3.969500e-10
- `p_idle_worst_w`: 1.309935e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 8.902643e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 1.232369e-07
- `v_rawbit_clklo_v`: -6.456467e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.919670e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
