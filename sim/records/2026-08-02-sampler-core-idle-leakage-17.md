---
record: 2026-08-02-sampler-core-idle-leakage-17
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-17/
  files:
    - ff_125c_3.30v.spice  sha256:0b955044fb3bb8045abb2c50af5056e2ed6cec3a59f69f2259899827b050d812
    - ff_125c_3.30v.log  sha256:3e04fb2469de8229477598e7ef956e855159364be761cd649ab3458b2506fdc8
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 2.550355e-08
- `i_idle_clkhi_a`: 2.273530e-08
- `p_idle_clklo_w`: 8.416171e-08
- `p_idle_clkhi_w`: 7.502649e-08
- `i_idle_clklo_prev_a`: 2.551355e-08
- `i_idle_clkhi_prev_a`: 2.273530e-08
- `i_idle_worst_a`: 2.550355e-08
- `p_idle_worst_w`: 8.416171e-08
- `v_ro1_v`: 3.29983
- `v_ro2_v`: 3.29984
- `v_xo_v`: 2.641040e-06
- `v_n1_v`: 3.29989
- `v_n2_v`: 4.673648e-06
- `v_rawbit_clklo_v`: -6.889042e-06
- `v_rawvalid_clklo_v`: 3.29998
- `v_rawbit_clkhi_v`: 6.361103e-07
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
