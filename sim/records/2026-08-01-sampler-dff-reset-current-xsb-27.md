---
record: 2026-08-01-sampler-dff-reset-current-xsb-27
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-27/
  files:
    - ss_125c_3.63v.spice  sha256:d7bb851147ee7be209a1ea3e9ed7759470667303410cb57836e69548ab50a411
    - ss_125c_3.63v.log  sha256:03be597c28ef26b874bf31a5208281d28f793e5875457528ac5faf0790d81216
wall_time: 4.2s
---

## Result

- `i_reset_xsb_a`: 8.215712e-05
- `p_reset_xsb_w`: 2.982303e-04
- `i_reset_xsb_first_a`: 8.215709e-05
- `i_reset_xsb_last_a`: 8.215715e-05
- `q_v`: -1.375728e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
