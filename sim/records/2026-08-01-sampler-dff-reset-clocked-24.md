---
record: 2026-08-01-sampler-dff-reset-clocked-24
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-24/
  files:
    - ss_27c_3.63v.spice  sha256:bfc4cead8a34547d3df904b384fb53da8499dc5370f6a583a2e36dc30ef42f0d
    - ss_27c_3.63v.log  sha256:48f844895645750b8248bd31c420067753237fbd0f0012af03450f21501e0fab
wall_time: 1.8m
---
...
- `q_rst_max_v`: 0.14822
- `q_rst_max_frac`: 0.0408318
- `s_rst_min_v`: 3.08544
- `s_rst_dev_frac`: 0.150015
- `mb_rst_min_v`: 3.45988
- `q_rel_v`: 3.544245e-06
- `q_cap_v`: 3.63001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
