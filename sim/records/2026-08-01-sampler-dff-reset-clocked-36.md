---
record: 2026-08-01-sampler-dff-reset-clocked-36
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-36/
  files:
    - fs_125c_3.63v.spice  sha256:889e6eedf6224052962447044dcf82de39e6c0e7ea166614edd5c6bab6e6b995
    - fs_125c_3.63v.log  sha256:1845958d67929dbab5ce491c5a7c0d940a2a507d856d45f181b81444dfd9c758
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.139289
- `q_rst_max_frac`: 0.0383717
- `s_rst_min_v`: 3.09612
- `s_rst_dev_frac`: 0.147075
- `mb_rst_min_v`: 3.47146
- `q_rel_v`: 3.386936e-06
- `q_cap_v`: 3.62999
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
