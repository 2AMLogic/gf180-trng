---
record: 2026-08-02-sampler-dff-active-current-28
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-28/
  files:
    - fs_-40c_2.97v.spice  sha256:06e4dd01a8051f59f9f2a38e1a75cdb8f898c0e7b056360abb61b989f625ee94
    - fs_-40c_2.97v.log  sha256:61b3b1d727413b848c1092769580355b3d2d8b62f5cf05d8e1717efec1d6ba56
wall_time: 15.5s
---

## Result

- `q_d_shut_c`: 4.500000e-20
- `q_d_open_c`: 6.996333e-15
- `e_d_shut_j`: 1.336500e-19
- `e_d_open_j`: 2.077911e-14
- `q_clkcyc_xsv_c`: 6.778340e-15
- `e_clkcyc_xsv_j`: 2.013167e-14
- `q_clkcyc_xsb_resid_c`: 5.846833e-16
- `q_cyc_xsb_total_c`: 7.754480e-14
- `q_d_shut_xsv_c`: 4.500000e-20
- `q_d_open_xsv_c`: 4.500000e-20
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 1.355480e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -2.402303e-07
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
