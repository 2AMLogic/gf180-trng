---
record: 2026-08-02-sampler-core-idle-leakage-14
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-14/
  files:
    - ff_27c_3.30v.spice  sha256:292faa04ba47afbd5a1f20bb09bc94177c3eef81c15f341dcba95b91c580efe1
    - ff_27c_3.30v.log  sha256:7547df31850da1499500e6c641e0558b344e04602ae8b94f3a1f5340d417576b
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 6.653500e-10
- `i_idle_clkhi_a`: 4.257000e-10
- `p_idle_clklo_w`: 2.195655e-09
- `p_idle_clkhi_w`: 1.404810e-09
- `i_idle_clklo_prev_a`: 6.741000e-10
- `i_idle_clkhi_prev_a`: 4.257500e-10
- `i_idle_worst_a`: 6.653500e-10
- `p_idle_worst_w`: 2.195655e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 5.876070e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 1.160845e-07
- `v_rawbit_clklo_v`: -7.402083e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.805967e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
