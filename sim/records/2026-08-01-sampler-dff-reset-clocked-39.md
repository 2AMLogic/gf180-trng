---
record: 2026-08-01-sampler-dff-reset-clocked-39
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-39/
  files:
    - sf_-40c_3.63v.spice  sha256:439bb32ff881593f31b2d75230a186498bd65c61f2ad1d3f32a9b9f73e5dde5c
    - sf_-40c_3.63v.log  sha256:c9a9161b9d5c4afa146b8b5569f707d66090d1a110eaa06a0a8ff39767609764
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.152238
- `q_rst_max_frac`: 0.0419388
- `s_rst_min_v`: 3.06651
- `s_rst_dev_frac`: 0.155231
- `mb_rst_min_v`: 3.45774
- `q_rel_v`: 1.712021e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
