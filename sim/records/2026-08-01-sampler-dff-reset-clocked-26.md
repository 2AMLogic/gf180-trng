---
record: 2026-08-01-sampler-dff-reset-clocked-26
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-26/
  files:
    - ss_125c_3.30v.spice  sha256:33c71534a0896bd19fa4b2e6b69cba3d544225e17982e355544d99f83d0afed1
    - ss_125c_3.30v.log  sha256:3d3bc84d476334e404cbb301275b383023ef7d663c89d87538c207f3193469ae
wall_time: 2.2m
---

## Result

- `q_rst_max_v`: 0.129416
- `q_rst_max_frac`: 0.0392171
- `s_rst_min_v`: 2.81605
- `s_rst_dev_frac`: 0.146652
- `mb_rst_min_v`: 3.1516
- `q_rel_v`: 6.932949e-07
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
