---
record: 2026-08-02-sampler-dff-reset-current-xsb-45
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-45/
  files:
    - sf_125c_3.63v.spice  sha256:c8a78d953394d29d8bba8e8ce6a50184fda7e487fcb4dfe33a8f4433de6626bf
    - sf_125c_3.63v.log  sha256:797a3070ffd0abac216cba38c5915d949de2b8f16068979c976865bc2e80b785
wall_time: 12.3s
---

## Result

- `i_reset_xsb_a`: 2.798425e-08
- `p_reset_xsb_w`: 1.015828e-07
- `i_reset_xsb_first_a`: 4.245850e-08
- `i_reset_xsb_last_a`: 1.351000e-08
- `q_v`: -1.225362e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
