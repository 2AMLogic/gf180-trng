---
record: 2026-08-02-sampler-dff-reset-current-xsv-16
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-16/
  files:
    - ff_125c_2.97v.spice  sha256:62261e89b36b1437c0b7b10355f4b79685cfee61522d67d612fde6daee746168
    - ff_125c_2.97v.log  sha256:ffe36e3f73f402e909a58d2705131ba62083ad807cef86e5943262ccf62202ce
wall_time: 3.4s
---

## Result

- `i_reset_xsv_a`: 3.190616e-09
- `p_reset_xsv_w`: 9.476129e-09
- `v_q`: 6.075781e-07
- `v_m`: 2.96999
- `v_mb`: 2.96999
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
