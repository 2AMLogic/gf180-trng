---
record: 2026-08-01-sampler-dff-reset-clocked-01
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-01/
  files:
    - tt_-40c_2.97v.spice  sha256:c63b32827e6ee43c95d60f364bc6e2a94dc551d46a9f8186bec0cd5d100da0d4
    - tt_-40c_2.97v.log  sha256:7f398004355588f675a65934c793a62e3a965037bdedd94f1b6200d5b08d07fb
wall_time: 2.7m
---
...
- `q_rst_max_v`: 0.12333
- `q_rst_max_frac`: 0.0415254
- `s_rst_min_v`: 2.52819
- `s_rst_dev_frac`: 0.148758
- `mb_rst_min_v`: 2.83179
- `q_rel_v`: 2.674276e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
