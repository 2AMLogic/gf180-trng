---
record: 2026-08-02-sampler-dff-reset-current-xsv-38
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-38/
  files:
    - sf_-40c_3.30v.spice  sha256:c68763682c258aa304ffa932fdb0aa31384507dcd27c0bc03efb32438e030187
    - sf_-40c_3.30v.log  sha256:035f38016444d8030703d00c58d6701619e9cc27a6e056e1974cbba1096da5dc
wall_time: 3.0s
---

## Result

- `i_reset_xsv_a`: 4.814974e-11
- `p_reset_xsv_w`: 1.588941e-10
- `v_q`: 1.635362e-08
- `v_m`: 3.3
- `v_mb`: 3.3
- `v_qb`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
