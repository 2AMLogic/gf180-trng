---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-38
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-38/
  files:
    - sf_-40c_3.30v.spice  sha256:6a41ff7bd71d565a8e7344f02110fd2e48d924fef7eafd73cf76177e249fc807
    - sf_-40c_3.30v.log  sha256:1779b06d9d677544df07cd9f77ea9d8614d5af34eb0be929cdf959ad320edff0
wall_time: 1.0s
---

## Result

- `i_leak_a`: 1.687022e-11
- `p_idle_w`: 5.567172e-11
- `v_n1`: 3.3
- `v_n2`: 4.749239e-09
- `v_n3`: 3.3
- `v_n4`: 4.749239e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners sf --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
