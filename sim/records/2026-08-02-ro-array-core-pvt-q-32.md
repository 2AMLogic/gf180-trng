---
record: 2026-08-02-ro-array-core-pvt-q-32
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-32/
  files:
    - tt_27c_3.30v.spice  sha256:a349ae9a1891838cf560d7bfec1ffb1f505fd24019646c9e90c183fb81dc7302
    - tt_27c_3.30v.log  sha256:7f9419b3e45c26582e69830b5d97fe8da907365d51317cd9735cc761e42f8824
wall_time: 2.9m
---

## Result

- `period_r1`: 6.677580e-09
- `period_r2`: 6.240665e-09
- `f_r1`: 1.497549e+08
- `f_r2`: 1.602393e+08
- `i_r1_a`: -1.896085e-05
- `i_r2_a`: -2.022880e-05
- `i_tree_a`: -1.662935e-05
- `e_cycle_r1_j`: -4.178216e-13
- `c_eff_node_r1_f`: -3.487950e-15
- `ring_swing_v`: 3.46085
- `xo_swing_v`: 3.45389
- `i_total_a`: -5.581900e-05
- `p_rings_w`: -1.293259e-04
- `p_total_w`: -1.842027e-04
- `xo_trans_per_s`: 6.199884e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners tt --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
