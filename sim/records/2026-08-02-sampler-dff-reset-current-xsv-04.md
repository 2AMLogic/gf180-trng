---
record: 2026-08-02-sampler-dff-reset-current-xsv-04
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-04/
  files:
    - tt_27c_2.97v.spice  sha256:e7e879f22973da9ebc286a6e537ffbf4273d4e301b05c4447ffc8dfc6065d5e5
    - tt_27c_2.97v.log  sha256:c090abf2c40f8b77b2bbcc4ae7b3a90780e25a97fa9299682f43f214a83cbfa6
wall_time: 2.9s
---

## Result

- `i_reset_xsv_a`: 4.504514e-11
- `p_reset_xsv_w`: 1.337841e-10
- `v_q`: 1.759255e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners tt --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
