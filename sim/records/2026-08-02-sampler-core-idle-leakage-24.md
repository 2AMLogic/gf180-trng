---
record: 2026-08-02-sampler-core-idle-leakage-24
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-24/
  files:
    - ss_27c_3.63v.spice  sha256:03334e981729942ae7de1dc51ff38d27da4a84bb86b6b16be165d4a1e3b16b08
    - ss_27c_3.63v.log  sha256:273f44de7ad010bd4a17027504595e4288e0e3c7aa4b76d8951fae8168c9ecd9
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 4.115000e-10
- `i_idle_clkhi_a`: 2.205000e-10
- `p_idle_clklo_w`: 1.493745e-09
- `p_idle_clkhi_w`: 8.004150e-10
- `i_idle_clklo_prev_a`: 4.194000e-10
- `i_idle_clkhi_prev_a`: 2.205000e-10
- `i_idle_worst_a`: 4.115000e-10
- `p_idle_worst_w`: 1.493745e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 9.109504e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 1.437836e-07
- `v_rawbit_clklo_v`: -6.424775e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 2.265992e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
