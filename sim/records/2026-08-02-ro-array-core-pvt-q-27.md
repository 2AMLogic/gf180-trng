---
record: 2026-08-02-ro-array-core-pvt-q-27
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-27/
  files:
    - ss_125c_3.63v.spice  sha256:9ee5abf60a366267d7567d5334f65573ee14baed9ac0d13e384d64d90baae61c
    - ss_125c_3.63v.log  sha256:2a56969930a71a30888af6cfa599dc2432c92f50ced4d0b9d9e53d0ab0a0e560
wall_time: 9.5m
---

## Result

- `period_r1`: 1.021413e-08
- `period_r2`: 9.593318e-09
- `f_r1`: 9.790357e+07
- `f_r2`: 1.042392e+08
- `i_r1_a`: -1.488623e-05
- `i_r2_a`: -1.594439e-05
- `i_tree_a`: -1.655651e-05
- `e_cycle_r1_j`: -5.519411e-13
- `c_eff_node_r1_f`: -3.807911e-15
- `ring_swing_v`: 3.72118
- `xo_swing_v`: 3.70833
- `i_total_a`: -4.738713e-05
- `p_rings_w`: -1.119151e-04
- `p_total_w`: -1.720153e-04
- `xo_trans_per_s`: 4.042856e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
