---
record: 2026-08-02-sampler-core-idle-leakage-10
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-10/
  files:
    - ff_-40c_2.97v.spice  sha256:eddb233516824a2c2500b3d2d38e5d6545f75dcd86d383747ff01692a7aa98b3
    - ff_-40c_2.97v.log  sha256:b1e78bff3e2e98d34d32dfcbd9e0e2ee13a823be6ba0e6be6426fb27d410717e
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 3.287000e-10
- `i_idle_clkhi_a`: 1.800500e-10
- `p_idle_clklo_w`: 9.762390e-10
- `p_idle_clkhi_w`: 5.347485e-10
- `i_idle_clklo_prev_a`: 3.345500e-10
- `i_idle_clkhi_prev_a`: 1.800500e-10
- `i_idle_worst_a`: 3.287000e-10
- `p_idle_worst_w`: 9.762390e-10
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 6.399557e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 7.905304e-08
- `v_rawbit_clklo_v`: -5.690590e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.345243e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
