---
record: 2026-08-02-sampler-core-idle-leakage-18
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-18/
  files:
    - ff_125c_3.63v.spice  sha256:0a12e0ce992c1890ff31a35235d6c641030846ad54ee4c05935aa0c434646ad8
    - ff_125c_3.63v.log  sha256:d1ac9d40b6da21284bc9ac03a1376c9469234794f7977ba66e18c92e97a0bf2c
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 3.277270e-08
- `i_idle_clkhi_a`: 2.916360e-08
- `p_idle_clklo_w`: 1.189649e-07
- `p_idle_clkhi_w`: 1.058639e-07
- `i_idle_clklo_prev_a`: 3.278430e-08
- `i_idle_clkhi_prev_a`: 2.916360e-08
- `i_idle_worst_a`: 3.277270e-08
- `p_idle_worst_w`: 1.189649e-07
- `v_ro1_v`: 3.6298
- `v_ro2_v`: 3.62981
- `v_xo_v`: 2.789152e-06
- `v_n1_v`: 3.62988
- `v_n2_v`: 4.982957e-06
- `v_rawbit_clklo_v`: -7.691756e-06
- `v_rawvalid_clklo_v`: 3.62998
- `v_rawbit_clkhi_v`: 6.776947e-07
- `v_rawvalid_clkhi_v`: 3.62998
- `v_sup_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
