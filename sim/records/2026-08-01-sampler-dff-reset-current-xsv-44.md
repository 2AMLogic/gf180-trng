---
record: 2026-08-01-sampler-dff-reset-current-xsv-44
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-44/
  files:
    - sf_125c_3.30v.spice  sha256:9b9013a5c7e18e6b31ca1f194c0e5865b19bc1bbd0251adbfebcaf799dee1dc7
    - sf_125c_3.30v.log  sha256:5d5edc523f89a990990e02c7440a274e6f16c878441902f2a6dbc196e13a9047
wall_time: 1.2s
---

## Result

- `i_reset_xsv_a`: 1.639371e-04
- `p_reset_xsv_w`: 5.409924e-04
- `v_q`: 4.300902e-07
- `v_m`: 1.11706
- `v_rst`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
