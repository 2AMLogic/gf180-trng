---
record: 2026-08-02-sampler-dff-reset-current-xsv-29
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-29/
  files:
    - fs_-40c_3.30v.spice  sha256:0708385c152fb4df98cf1332c8aadabd1cdef080103e3413d86ee5d417259319
    - fs_-40c_3.30v.log  sha256:0a91fe9a95f19eb7c6bd163d89b442c9c1b3154e3f465c1c3272649966f611f7
wall_time: 2.9s
---

## Result

- `i_reset_xsv_a`: 4.848638e-11
- `p_reset_xsv_w`: 1.600050e-10
- `v_q`: 1.443646e-08
- `v_m`: 3.3
- `v_mb`: 3.3
- `v_qb`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners fs --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
