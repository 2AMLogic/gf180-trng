---
record: 2026-08-02-sampler-core-idle-leakage-01
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-01/
  files:
    - tt_-40c_2.97v.spice  sha256:5cc429aaa3f2895b3a11341d419893215db02554ade618c7fe88bb1c59418abb
    - tt_-40c_2.97v.log  sha256:cb8c4e8619365aef839dbbefb54c210a3d941bd6c37b17de0d29ad6f4dee69a3
wall_time: 1.5m
---

## Result

- `i_idle_clklo_a`: 3.016500e-10
- `i_idle_clkhi_a`: 1.783000e-10
- `p_idle_clklo_w`: 8.959005e-10
- `p_idle_clkhi_w`: 5.295510e-10
- `i_idle_clklo_prev_a`: 3.064500e-10
- `i_idle_clkhi_prev_a`: 1.782500e-10
- `i_idle_worst_a`: 3.016500e-10
- `p_idle_worst_w`: 8.959005e-10
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 1.018408e-06
- `v_n1_v`: 2.97
- `v_n2_v`: 8.960296e-08
- `v_rawbit_clklo_v`: -4.496311e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.515770e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
