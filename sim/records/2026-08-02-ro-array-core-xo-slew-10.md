---
record: 2026-08-02-ro-array-core-xo-slew-10
date: 2026-08-02T01:44:30Z
status: valid
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-10/
  files:
    - ss_125c_3.63v.spice  sha256:7e2e47d45572f4a8e898be2d7fb85bf84786177e3d3dccb053eeabe4723a6667
    - ss_125c_3.63v.log  sha256:3bde63cf3d84ad017cb5e3df22870cd6b090e9c7f5884f1bcc747b7f919a7bc9
wall_time: 11.3m
---

## Result

- `xo_slew_rise_v_per_s`: 2.639078e+10
- `xo_slew_fall_v_per_s`: -3.320567e+10
- `ro1_slew_rise_v_per_s`: 1.994384e+09
- `ro1_slew_fall_v_per_s`: -3.673285e+09
- `ro1_band_slew_a_v_per_s`: 9.284600e+08
- `ro1_band_slew_b_v_per_s`: 1.157784e+09
- `xo_swing_v`: 3.70488
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
