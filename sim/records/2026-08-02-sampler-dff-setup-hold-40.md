---
record: 2026-08-02-sampler-dff-setup-hold-40
date: 2026-08-02T01:06:36Z
status: valid
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-setup-hold-40/
  files:
    - sf_27c_2.97v.spice  sha256:5dd07ea2e06f7644ce1cc12503223549b513687f431b158307c5df0eb88a3a8f
    - sf_27c_2.97v.log  sha256:b139b25a9e4057edf8f291fa402d2bdbba1eb78c1080de1193810442c0f9f5ef
wall_time: 1.9m
---

## Result

- `tpd_clk_q_rise_s`: 1.146000e-10
- `tpd_clk_q_fall_s`: 1.390000e-10
- `q_rst_v`: 1.941895e-08
- `q_e1_v`: 2.97001
- `q_e2_v`: -2.879352e-06
- `q_e4_v`: 5.992495e-07
- `q_e3_1ns_v`: 1.335966e-04
- `q_e3_10ns_v`: -2.814938e-06
- `q_e3_100ns_v`: -2.675909e-06
- `q_e3_drift_v`: -1.362725e-04
- `q_e3_rail_dev_v`: -2.675909e-06
- `q_e5_1ns_v`: 2.474426e-04
- `q_e5_10ns_v`: 1.728617e-06
- `q_e5_100ns_v`: 1.640735e-06
- `q_e5_drift_v`: -2.458019e-04
- `q_e5_rail_dev_v`: 1.640735e-06
- `q_e6_v`: 5.992199e-07
- `q_e7_1ns_v`: 2.9713
- `q_e7_10ns_v`: 2.97001
- `q_e7_100ns_v`: 2.97001
- `q_e7_drift_v`: -0.001296
- `q_e7_rail_dev_v`: -4.999999e-06
...
```sh
python3 sim/run_corners.py sampler-dff-setup-hold --corners sf --temps 27 --supply 2.97 --supply-tol 0 --no-write
```

## Caveats

- Single corner (sf / 2.97 V / 27 C). Says nothing about any other corner.
