---
record: 2026-08-01-sampler-dff-reset-clocked-09
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-09/
  files:
    - tt_125c_3.63v.spice  sha256:33748af88ca516898287321b8544cf326f4f330ee0789703f634489df545910b
    - tt_125c_3.63v.log  sha256:76986225fd03ab5c2d0e2ff3a7c1fde6bdcdbfb21e7da4bc158343df3a34a636
wall_time: 2.0m
---

## Result

- `q_rst_max_v`: 0.140782
- `q_rst_max_frac`: 0.038783
- `s_rst_min_v`: 3.08934
- `s_rst_dev_frac`: 0.148943
- `mb_rst_min_v`: 3.47136
- `q_rel_v`: 3.158517e-06
- `q_cap_v`: 3.63001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
