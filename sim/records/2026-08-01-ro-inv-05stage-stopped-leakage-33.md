---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-33
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-33/
  files:
    - fs_27c_3.63v.spice  sha256:4469ac606441da93e64478e691e03da43cc979ee54f9cdc4a805b48215ea64f5
    - fs_27c_3.63v.log  sha256:84ec2dad302bc57296bf485d1218469742283c1a65dd7f4d99c57401fdf8530b
wall_time: 0.5s
---

## Result

- `i_leak_a`: 5.438662e-11
- `p_idle_w`: 1.974234e-10
- `v_n1`: 3.63
- `v_n2`: 5.599088e-09
- `v_n3`: 3.63
- `v_n4`: 5.599088e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners fs --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
