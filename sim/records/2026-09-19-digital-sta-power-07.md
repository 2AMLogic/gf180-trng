---
record: 2026-09-19-digital-sta-power-07
date: 2026-09-19T05:32:47Z
status: valid
...
parasitics:
  spef_sha256: bba90ba1975ad0eb20ca64c23ebd2ee7171087eb5e8ee4ad33c8a5e2025a80a8
  spef_bytes: 1734288
  note: >-
...
raw:
  path: sim/records/raw/2026-09-19-digital-sta-power-07/
  files:
    - constraint.tcl  sha256:f80a84876b610b0a254eac22b7c1b598234f5d3cd6a6bc55b2961ee1e75dcad1
    - constraint.log  sha256:947cf474df2dfabe65bcaddb9ac7622e1b825b5f60fcd90e53201bc035740a8e
    - ratified-rate.tcl  sha256:d6bdc941d850c1729ebdd51f62a7c99e4048e19265331e6ceecf37ccaa7d4fbe
    - ratified-rate.log  sha256:ba3286e0a4b52aba36388d4191f14342828e2e15258b971168209e2ac6a00d9c
wall_time: 6.1s
---
...
- `worst_setup_slack_ns`: 3.728462e+01
- `worst_hold_slack_ns`: 1.195161e+00
- `worst_setup_slack_ideal_clock_ns`: 3.727367e+01
- `worst_hold_slack_ideal_clock_ns`: 1.157745e+00
- `clock_tree_cost_ns`: -1.095657e-02
- `tns_setup_ns`: 0.000000e+00
- `tns_hold_ns`: 0.000000e+00
- `clock_skew_setup_ns`: -8.655676e-02
- `min_period_ns`: 1.271586e+01
- `fmax_bisect_mhz`: 7.864194e+01
- `fmax_linear_mhz`: 7.864493e+01
- `cell_area_um2`: 5.946514e+04
- `utilization_pct`: 4.155621e+01
- `spef_nets`: 1.447000e+03
- `wire_cap_total_f`: 5.052035e-12
- `wire_cap_per_net_f`: 3.491385e-15
- `coupling_cap_total_f`: 5.379830e-12
- `p_total_20mhz_w`: 5.138715e-03
- `p_internal_20mhz_w`: 3.578166e-03
- `p_switching_20mhz_w`: 1.560346e-03
- `p_clock_20mhz_w`: 1.110317e-03
- `p_sequential_20mhz_w`: 2.725251e-03
- `p_combinational_20mhz_w`: 1.303148e-03
- `p_total_1mhz_w`: 2.571286e-04
- `p_internal_1mhz_w`: 1.789084e-04
- `p_switching_1mhz_w`: 7.801720e-05
- `p_clock_1mhz_w`: 5.558097e-05
- `p_clock_internal_1mhz_w`: 2.055623e-05
- `p_clock_switching_1mhz_w`: 3.495619e-05
- `p_sequential_1mhz_w`: 1.363291e-04
- `p_sequential_internal_1mhz_w`: 1.263709e-04
- `p_sequential_switching_1mhz_w`: 9.888270e-06
- `p_combinational_1mhz_w`: 6.521870e-05
- `p_combinational_internal_1mhz_w`: 3.198129e-05
- `p_combinational_switching_1mhz_w`: 3.317291e-05
- `p_leakage_w`: 2.029882e-07
- `i_leakage_a`: 6.151158e-08
- `i_total_1mhz_a`: 7.791776e-05
...
- `max_slew_slack_ns`: -1.077525e+00
