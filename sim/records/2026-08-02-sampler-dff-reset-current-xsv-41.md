---
record: 2026-08-02-sampler-dff-reset-current-xsv-41
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-41/
  files:
    - sf_27c_3.30v.spice  sha256:5e0bddb1bbd06cb2054746421051ba327c58f6762e76dfc8af2776cbe3dcd381
    - sf_27c_3.30v.log  sha256:bd67ba409f1b4470b020a943b154034a3d284ee08bb64c248f92488664e03910
wall_time: 3.0s
---

## Result

- `i_reset_xsv_a`: 4.888669e-11
- `p_reset_xsv_w`: 1.613261e-10
- `v_q`: 2.031929e-08
- `v_m`: 3.3
- `v_mb`: 3.3
- `v_qb`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
