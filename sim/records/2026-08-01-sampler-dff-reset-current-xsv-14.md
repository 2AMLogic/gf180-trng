---
record: 2026-08-01-sampler-dff-reset-current-xsv-14
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-14/
  files:
    - ff_27c_3.30v.spice  sha256:3463ad04f6ebb754facf019151363a3ce253082c3dbbf6d2c37feddf40176b9d
    - ff_27c_3.30v.log  sha256:197bf2fdf28cad30f1de57dc462545d4ecc4bcaf15c379ada5b7b15fda25ea8f
wall_time: 1.1s
---

## Result

- `i_reset_xsv_a`: 2.391301e-04
- `p_reset_xsv_w`: 7.891294e-04
- `v_q`: 1.751478e-08
- `v_m`: 1.00386
- `v_rst`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
