---
record: 2026-08-02-sampler-dff-active-current-35
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-35/
  files:
    - fs_125c_3.30v.spice  sha256:d8b183a9a21e1b5735318e5f90ab66232067ffc48a9e36f953dc7bd77580ef62
    - fs_125c_3.30v.log  sha256:f82cfc876aeb65bf9c3ac6433b13b1615937c02d8db75640912519e5fdcbb4c1
wall_time: 12.4s
---

## Result

- `q_d_shut_c`: 1.000000e-18
- `q_d_open_c`: 8.569150e-15
- `e_d_shut_j`: 3.300000e-18
- `e_d_open_j`: 2.827820e-14
- `q_clkcyc_xsv_c`: 7.833120e-15
- `e_clkcyc_xsv_j`: 2.584930e-14
- `q_clkcyc_xsb_resid_c`: 1.233550e-15
- `q_cyc_xsb_total_c`: 9.550420e-14
- `q_d_shut_xsv_c`: 1.571667e-18
- `q_d_open_xsv_c`: 2.326667e-18
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 3.060241e-08
- `qv_post_v`: 3.29999
- `qb_pre_v`: -1.659970e-06
- `qb_post_v`: 3.29999
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
