---
record: 2026-08-02-sampler-core-idle-leakage-40
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-40/
  files:
    - sf_27c_2.97v.spice  sha256:63433b944211da82112dfabd9b8a62cc2dc454e1c9e3c1e860b731493ee397ba
    - sf_27c_2.97v.log  sha256:1229c751d288503278e64dfaf8a8a5d10bcc6b6f9ccbffdf43c8d1f8e3cf59a4
wall_time: 1.2m
---

## Result

- `i_idle_clklo_a`: 3.469000e-10
- `i_idle_clkhi_a`: 1.820000e-10
- `p_idle_clklo_w`: 1.030293e-09
- `p_idle_clkhi_w`: 5.405400e-10
- `i_idle_clklo_prev_a`: 3.536500e-10
- `i_idle_clkhi_prev_a`: 1.819500e-10
- `i_idle_worst_a`: 3.469000e-10
- `p_idle_worst_w`: 1.030293e-09
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 9.516399e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 1.324885e-07
- `v_rawbit_clklo_v`: -6.075153e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.853925e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
