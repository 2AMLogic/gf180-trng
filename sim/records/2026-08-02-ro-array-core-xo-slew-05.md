---
record: 2026-08-02-ro-array-core-xo-slew-05
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-05/
  files:
    - ss_-40c_2.97v.spice  sha256:d476db5d944beef9f4324a57fc7a57afca7281490a13dafd425f0fa565eee569
    - ss_-40c_2.97v.log  sha256:3374daf97658e26728c1453a1af55c80e96c144301d05b334b6a320e703f7553
wall_time: 11.2m
---

## Result

- `xo_slew_rise_v_per_s`: 2.641457e+10
- `xo_slew_fall_v_per_s`: -3.789286e+10
- `ro1_slew_rise_v_per_s`: 2.344602e+09
- `ro1_slew_fall_v_per_s`: -4.108123e+09
- `ro1_band_slew_a_v_per_s`: 1.128098e+09
- `ro1_band_slew_b_v_per_s`: 1.190214e+09
- `xo_swing_v`: 3.09618
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ss --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
