---
record: 2026-08-02-sampler-dff-reset-current-xsb-41
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-41/
  files:
    - sf_27c_3.30v.spice  sha256:dfd685b37b091e4dd3bd9a18ba5262d42ebbc4ace640dc2ce56c51e5679ed859
    - sf_27c_3.30v.log  sha256:a1fb6c60e457229860b8e3d61c2087f21ce096bf43454d25eea9f791889aa16d
wall_time: 13.6s
---

## Result

- `i_reset_xsb_a`: 2.108600e-08
- `p_reset_xsb_w`: 6.958380e-08
- `i_reset_xsb_first_a`: 3.214150e-08
- `i_reset_xsb_last_a`: 1.003050e-08
- `q_v`: -4.885786e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
