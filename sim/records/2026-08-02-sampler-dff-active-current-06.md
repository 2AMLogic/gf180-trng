---
record: 2026-08-02-sampler-dff-active-current-06
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-06/
  files:
    - tt_27c_3.63v.spice  sha256:81a6e536a601a871fd1797d8be1ce1809db509bc46ee5fa8be40b94027f4a62f
    - tt_27c_3.63v.log  sha256:458d94ef3ec1f75c896331d64ddfc04a46913eafd25437854c49491a262c2b0b
wall_time: 14.1s
---
...
- `q_d_open_c`: 9.106400e-15
- `e_d_shut_j`: 2.420000e-19
- `e_d_open_j`: 3.305623e-14
- `q_clkcyc_xsv_c`: 8.457460e-15
- `e_clkcyc_xsv_j`: 3.070058e-14
- `q_clkcyc_xsb_resid_c`: 1.115633e-15
- `q_cyc_xsb_total_c`: 1.012867e-13
- `q_d_shut_xsv_c`: 5.833333e-20
- `q_d_open_xsv_c`: 5.666667e-20
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 1.953162e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -2.821785e-07
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
