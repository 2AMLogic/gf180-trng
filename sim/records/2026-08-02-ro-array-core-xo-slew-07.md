---
record: 2026-08-02-ro-array-core-xo-slew-07
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-07/
  files:
    - ss_-40c_3.63v.spice  sha256:e559d3ca0d3b31e68c0d068ac6397f27267df97b26bd979aeee3801e60cc52f1
    - ss_-40c_3.63v.log  sha256:81a48b87c677b18180d263c2988130c55fc2f8fcecab95dd178ec7cca6947a68
wall_time: 11.2m
---

## Result

- `xo_slew_rise_v_per_s`: 4.037426e+10
- `xo_slew_fall_v_per_s`: -5.307387e+10
- `ro1_slew_rise_v_per_s`: 3.651198e+09
- `ro1_slew_fall_v_per_s`: -6.186062e+09
- `ro1_band_slew_a_v_per_s`: 1.851002e+09
- `ro1_band_slew_b_v_per_s`: 1.927877e+09
- `xo_swing_v`: 3.75666
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ss --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
