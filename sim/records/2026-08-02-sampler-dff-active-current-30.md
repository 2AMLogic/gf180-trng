---
record: 2026-08-02-sampler-dff-active-current-30
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-30/
  files:
    - fs_-40c_3.63v.spice  sha256:cf9eb6e2a7af785afc4e2296843f77ed7112c37c18b8b085b7613d208956a31d
    - fs_-40c_3.63v.log  sha256:3eabb95f2c3503b26e6e252e0e72b3833a3916fbfad5850d746c19799b338938
wall_time: 12.8s
---
...
- `q_d_open_c`: 8.721267e-15
- `e_d_shut_j`: 1.815000e-19
- `e_d_open_j`: 3.165820e-14
- `q_clkcyc_xsv_c`: 8.307210e-15
- `e_clkcyc_xsv_j`: 3.015517e-14
- `q_clkcyc_xsb_resid_c`: 8.553667e-16
- `q_cyc_xsb_total_c`: 9.678980e-14
- `q_d_shut_xsv_c`: 5.500000e-20
- `q_d_open_xsv_c`: 5.500000e-20
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 1.546420e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -1.412234e-07
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
