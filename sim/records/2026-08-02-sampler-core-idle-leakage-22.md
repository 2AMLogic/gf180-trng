---
record: 2026-08-02-sampler-core-idle-leakage-22
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-22/
  files:
    - ss_27c_2.97v.spice  sha256:8182ac6583f36cab764407cbb3d592b50b862250c95d420ddfd912ebc470a6e2
    - ss_27c_2.97v.log  sha256:c027916ba89def4f4b0e8c23cfaf1a7ec6407b514d8745b14f8d91c512e890f8
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 2.971500e-10
- `i_idle_clkhi_a`: 1.787000e-10
- `p_idle_clklo_w`: 8.825355e-10
- `p_idle_clkhi_w`: 5.307390e-10
- `i_idle_clklo_prev_a`: 3.025500e-10
- `i_idle_clkhi_prev_a`: 1.786500e-10
- `i_idle_worst_a`: 2.971500e-10
- `p_idle_worst_w`: 8.825355e-10
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 6.511672e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 1.406394e-07
- `v_rawbit_clklo_v`: 4.600171e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 2.064555e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
