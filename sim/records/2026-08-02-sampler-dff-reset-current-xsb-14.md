---
record: 2026-08-02-sampler-dff-reset-current-xsb-14
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-14/
  files:
    - ff_27c_3.30v.spice  sha256:a898096342b31d7db4d213a4d943fa1e60a3c777f1e26f0a229c41ddc92e0583
    - ff_27c_3.30v.log  sha256:0cf92e5f906d581b371728128ea02c27520825f3cdc9f9fdb362b5d113d77c1f
wall_time: 12.5s
---

## Result

- `i_reset_xsb_a`: 1.841875e-08
- `p_reset_xsb_w`: 6.078188e-08
- `i_reset_xsb_first_a`: 2.801100e-08
- `i_reset_xsb_last_a`: 8.826500e-09
- `q_v`: -2.139743e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
