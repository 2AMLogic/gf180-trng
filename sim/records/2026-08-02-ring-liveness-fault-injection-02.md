---
record: 2026-08-02-ring-liveness-fault-injection-02
...
raw:
  path: sim/records/raw/2026-08-02-ring-liveness-fault-injection-02/
  files:
    - summary.json  sha256:36e62f5c5707a7b759ec332f5661056b58de1b1851a4a6a7aed6a0cc3f16a635
    - raw_rows.bin  sha256:b5b8651e25b8c94531af65785461aee13da5823c8507425542a6822d231dc780
wall_time: 0.1s
---

## Result

Scenario `ring1-stuck` -- ring 1 (index 0) stops mid-stream while ring 2 keeps running -- the exact 'half the N=2 array silently dies' scenario DR-0010 raises the stakes on and design/README.md's 'Per-ring liveness' section names as invisible at the combined xo node.
...
| stuck ring index | 0 |
| C_LIVE | 81 |
| first ring_stuck event after onset (stuck ring) | 2079 |
| detection latency (samples after onset) | 79 |
| DR-0016 latency bound (C_LIVE - 1) | 80 |
| detected within bound | True |
| other (healthy) ring ever flagged stuck | False |
...
```sh
python3 sim/tb/ring-liveness-fault-injection/run_demo.py --scenario ring1-stuck --no-write
```
