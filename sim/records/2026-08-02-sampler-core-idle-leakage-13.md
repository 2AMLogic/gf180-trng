---
record: 2026-08-02-sampler-core-idle-leakage-13
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-13/
  files:
    - ff_27c_2.97v.spice  sha256:4aa236251c30167c01f1eb8aa7c5c6e7608252ab4e55fa55e6d1aeccc96734fc
    - ff_27c_2.97v.log  sha256:1277ff4c74df40c9069d531ef31bc517ce27527ada5581cbd3800174097e142d
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 5.422000e-10
- `i_idle_clkhi_a`: 3.449500e-10
- `p_idle_clklo_w`: 1.610334e-09
- `p_idle_clkhi_w`: 1.024501e-09
- `i_idle_clklo_prev_a`: 5.493500e-10
- `i_idle_clkhi_prev_a`: 3.450000e-10
- `i_idle_worst_a`: 5.422000e-10
- `p_idle_worst_w`: 1.610334e-09
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 7.461065e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 1.107205e-07
- `v_rawbit_clklo_v`: -6.372829e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.699811e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
