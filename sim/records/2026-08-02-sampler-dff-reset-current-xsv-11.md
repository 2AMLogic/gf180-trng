---
record: 2026-08-02-sampler-dff-reset-current-xsv-11
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-11/
  files:
    - ff_-40c_3.30v.spice  sha256:017bfe2c0fd8d5480aa7c338a126130335c735f961216b4fe008e2f356869cdb
    - ff_-40c_3.30v.log  sha256:64b3f40288d0606cd194641b73b2cbb25cb273e8215161f10e6fd644dfc222fc
wall_time: 3.4s
---

## Result

- `i_reset_xsv_a`: 4.875308e-11
- `p_reset_xsv_w`: 1.608852e-10
- `v_q`: 1.396633e-08
- `v_m`: 3.3
- `v_mb`: 3.3
- `v_qb`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
