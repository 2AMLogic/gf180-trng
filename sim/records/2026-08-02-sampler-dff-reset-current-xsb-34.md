---
record: 2026-08-02-sampler-dff-reset-current-xsb-34
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-34/
  files:
    - fs_125c_2.97v.spice  sha256:cc13658dda366f19ea20de24d05f31e5748e5dec6c604c330852c3cc19d6da04
    - fs_125c_2.97v.log  sha256:d4df103ea82561ecc3ea0982a7261a17e7274d2157d562716ce6816c6b2f283f
wall_time: 13.3s
---

## Result

- `i_reset_xsb_a`: 2.623875e-08
- `p_reset_xsb_w`: 7.792909e-08
- `i_reset_xsb_first_a`: 3.972750e-08
- `i_reset_xsb_last_a`: 1.275000e-08
- `q_v`: -2.107642e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
