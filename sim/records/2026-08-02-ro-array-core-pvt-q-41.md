---
record: 2026-08-02-ro-array-core-pvt-q-41
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-41/
  files:
    - ff_27c_3.30v.spice  sha256:766e49896aa57bcd46ae3ff0612fe7b6c26eb42ea6dd31d3dc3bd99033668a7d
    - ff_27c_3.30v.log  sha256:43ddac81f4c7409a6bd3c938294a5770c00ee04dbc76f1235280100a06c4b189
wall_time: 3.4m
---

## Result

- `period_r1`: 5.572367e-09
- `period_r2`: 5.219527e-09
- `f_r1`: 1.794569e+08
- `f_r2`: 1.915882e+08
- `i_r1_a`: -2.454367e-05
- `i_r2_a`: -2.613005e-05
- `i_tree_a`: -2.288604e-05
- `e_cycle_r1_j`: -4.513290e-13
- `c_eff_node_r1_f`: -3.767668e-15
- `ring_swing_v`: 3.45193
- `xo_swing_v`: 3.42591
- `i_total_a`: -7.355976e-05
- `p_rings_w`: -1.672233e-04
- `p_total_w`: -2.427472e-04
- `xo_trans_per_s`: 7.420903e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ff --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
