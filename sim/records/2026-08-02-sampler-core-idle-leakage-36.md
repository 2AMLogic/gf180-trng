---
record: 2026-08-02-sampler-core-idle-leakage-36
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-36/
  files:
    - fs_125c_3.63v.spice  sha256:03d8b2f7cb38b12cab44ce32b1a9498572beda1180d6910973fbb24d2c7ebbfc
    - fs_125c_3.63v.log  sha256:ec7653a428e49b9cf25f3c3494544f7eac2c2882bba3527948550cc8267c6eed
wall_time: 51.1s
---

## Result

- `i_idle_clklo_a`: 1.712980e-08
- `i_idle_clkhi_a`: 1.492960e-08
- `p_idle_clklo_w`: 6.218117e-08
- `p_idle_clkhi_w`: 5.419445e-08
- `i_idle_clklo_prev_a`: 1.714015e-08
- `i_idle_clkhi_prev_a`: 1.492965e-08
- `i_idle_worst_a`: 1.712980e-08
- `p_idle_worst_w`: 6.218117e-08
- `v_ro1_v`: 3.62986
- `v_ro2_v`: 3.62987
- `v_xo_v`: 7.782589e-07
- `v_n1_v`: 3.62991
- `v_n2_v`: 2.313751e-07
- `v_rawbit_clklo_v`: -7.489762e-06
- `v_rawvalid_clklo_v`: 3.62999
- `v_rawbit_clkhi_v`: 3.273238e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
