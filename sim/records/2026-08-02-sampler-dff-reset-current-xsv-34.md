---
record: 2026-08-02-sampler-dff-reset-current-xsv-34
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-34/
  files:
    - fs_125c_2.97v.spice  sha256:100ab1c64641502a760879dffb82179518d7e5c83427c8bc916831766adb262d
    - fs_125c_2.97v.log  sha256:859198970eb841cc0ad1d892f5f7de18bef1347d5a2d3b7eddee5ff736d94f49
wall_time: 2.9s
---

## Result

- `i_reset_xsv_a`: 1.670039e-09
- `p_reset_xsv_w`: 4.960016e-09
- `v_q`: 2.956769e-08
- `v_m`: 2.96999
- `v_mb`: 2.96999
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners fs --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
