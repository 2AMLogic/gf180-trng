---
record: 2026-08-01-sampler-dff-reset-current-xsb-28
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-28/
  files:
    - fs_-40c_2.97v.spice  sha256:6647f87495f42a15db5a885f7ea23c8f022fd8a2cfcda4a1f942c2477478698b
    - fs_-40c_2.97v.log  sha256:45ce17ba8aa621f072796d28db0c97bc3ac023b1a469c125afee187fdf02cba0
wall_time: 4.2s
---

## Result

- `i_reset_xsb_a`: 9.260242e-05
- `p_reset_xsb_w`: 2.750292e-04
- `i_reset_xsb_first_a`: 9.260238e-05
- `i_reset_xsb_last_a`: 9.260245e-05
- `q_v`: -1.470212e-08
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
