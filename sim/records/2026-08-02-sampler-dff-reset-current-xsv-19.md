---
record: 2026-08-02-sampler-dff-reset-current-xsv-19
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-19/
  files:
    - ss_-40c_2.97v.spice  sha256:7c946956e45b8e693c2834fd543d24adc1c6bcf0a97d96364d86a0aef767318d
    - ss_-40c_2.97v.log  sha256:b164c223d16f32d51a88362c4cddfa3a8977089e4589990d4da1409b68033d04
wall_time: 3.1s
---

## Result

- `i_reset_xsv_a`: 4.309455e-11
- `p_reset_xsv_w`: 1.279908e-10
- `v_q`: 1.617246e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
