---
record: 2026-08-01-sampler-dff-reset-clocked-06
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-06/
  files:
    - tt_27c_3.63v.spice  sha256:92ba941c3dca2d50809f2d31d15c258090a338cb965e415fc2507fb68309cf90
    - tt_27c_3.63v.log  sha256:4ddea0511ec55d2ec789fb1a83b0209660b38f3a2da437ba9cdf6a942ba127ac
wall_time: 2.3m
---
...
- `q_rst_max_v`: 0.14702
- `q_rst_max_frac`: 0.0405015
- `s_rst_min_v`: 3.07986
- `s_rst_dev_frac`: 0.151553
- `mb_rst_min_v`: 3.46419
- `q_rel_v`: 2.173574e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
