---
record: 2026-08-02-sampler-dff-reset-current-xsb-15
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-15/
  files:
    - ff_27c_3.63v.spice  sha256:b85c2825ca49a27bf6725ea0c3bfb7e73ef99e45382e6894524a8759a078814d
    - ff_27c_3.63v.log  sha256:9421d4b17027c516540043dcbd969fa4b12c3d105074b809216da10f3295c2cd
wall_time: 12.7s
---

## Result

- `i_reset_xsb_a`: 1.950100e-08
- `p_reset_xsb_w`: 7.078863e-08
- `i_reset_xsb_first_a`: 2.891200e-08
- `i_reset_xsb_last_a`: 1.009000e-08
- `q_v`: -1.554877e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
