---
record: 2026-08-01-sampler-dff-reset-clocked-11
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-11/
  files:
    - ff_-40c_3.30v.spice  sha256:762575ca0f29d4846e32082a225c3620a96cd28370d70d80cda8639eee8034e3
    - ff_-40c_3.30v.log  sha256:1bd0661ea40b8f4a98d48dbd8501e63c519c5664057fdd0d5eca55f7cac4e88e
wall_time: 1.9m
---

## Result

- `q_rst_max_v`: 0.136007
- `q_rst_max_frac`: 0.0412143
- `s_rst_min_v`: 2.79505
- `s_rst_dev_frac`: 0.153015
- `mb_rst_min_v`: 3.1499
- `q_rel_v`: 1.493944e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
