---
record: 2026-08-01-sampler-dff-reset-clocked-10
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-10/
  files:
    - ff_-40c_2.97v.spice  sha256:56fbd8b742220e196f5dc07d77a06ab06f84a8c8c80604dca7146724519af2af
    - ff_-40c_2.97v.log  sha256:46a13723a55b0b4953b18c50b14918997b18af3f7c0ecf9e43ff01c4bc325a72
wall_time: 1.9m
---

## Result

- `q_rst_max_v`: 0.122714
- `q_rst_max_frac`: 0.0413177
- `s_rst_min_v`: 2.52022
- `s_rst_dev_frac`: 0.151442
- `mb_rst_min_v`: 2.8353
- `q_rel_v`: 1.656084e-06
- `q_cap_v`: 2.96999
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
