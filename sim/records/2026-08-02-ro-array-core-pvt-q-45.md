---
record: 2026-08-02-ro-array-core-pvt-q-45
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-45/
  files:
    - ff_125c_3.63v.spice  sha256:612e029cad5dccf21147b64613c45b899cc0345dbad593702ea85cd7b134849f
    - ff_125c_3.63v.log  sha256:bb23a6cf47545c688109f166011fafe4bd4ba90acb72dee90c91ec0bba79d1f6
wall_time: 3.4m
---

## Result

- `period_r1`: 6.872660e-09
- `period_r2`: 6.436578e-09
- `f_r1`: 1.455041e+08
- `f_r2`: 1.553621e+08
- `i_r1_a`: -2.468672e-05
- `i_r2_a`: -2.629225e-05
- `i_tree_a`: -2.526478e-05
- `e_cycle_r1_j`: -6.158781e-13
- `c_eff_node_r1_f`: -4.249021e-15
- `ring_swing_v`: 3.78242
- `xo_swing_v`: 3.71592
- `i_total_a`: -7.624375e-05
- `p_rings_w`: -1.850536e-04
- `p_total_w`: -2.767648e-04
- `xo_trans_per_s`: 6.017323e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ff --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
