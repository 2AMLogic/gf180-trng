---
record: 2026-08-02-sampler-dff-reset-current-xsv-12
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-12/
  files:
    - ff_-40c_3.63v.spice  sha256:c870a5fa90b33cf68baf7e2f1754deeef93f4bfe251004fa137f147c895496ce
    - ff_-40c_3.63v.log  sha256:84eae8e408b80b1170a0a15b90c86a023c3ad93c8b8aea8c6fd0fc9b517f1398
wall_time: 3.6s
---

## Result

- `i_reset_xsv_a`: 5.403676e-11
- `p_reset_xsv_w`: 1.961534e-10
- `v_q`: 1.517128e-08
- `v_m`: 3.63
- `v_mb`: 3.63
- `v_qb`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
