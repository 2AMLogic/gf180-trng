---
record: 2026-08-02-sampler-core-idle-leakage-34
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-34/
  files:
    - fs_125c_2.97v.spice  sha256:3d30cd50eec6376a67698cab13eff130560e3b8d2ae0913369bd47840f0e1c6a
    - fs_125c_2.97v.log  sha256:c1be1809351d9e83c804634551ec63870dcb3c68dbddc84424d26d1e2944223a
wall_time: 46.3s
---

## Result

- `i_idle_clklo_a`: 1.048365e-08
- `i_idle_clkhi_a`: 9.134350e-09
- `p_idle_clklo_w`: 3.113644e-08
- `p_idle_clkhi_w`: 2.712902e-08
- `i_idle_clklo_prev_a`: 1.049140e-08
- `i_idle_clkhi_prev_a`: 9.134350e-09
- `i_idle_worst_a`: 1.048365e-08
- `p_idle_worst_w`: 3.113644e-08
- `v_ro1_v`: 2.96989
- `v_ro2_v`: 2.9699
- `v_xo_v`: 6.528104e-07
- `v_n1_v`: 2.96993
- `v_n2_v`: 2.192643e-07
- `v_rawbit_clklo_v`: 5.976099e-06
- `v_rawvalid_clklo_v`: 2.96999
- `v_rawbit_clkhi_v`: 3.038883e-08
- `v_rawvalid_clkhi_v`: 2.96999
- `v_sup_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
