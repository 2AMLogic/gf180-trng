---
record: 2026-08-01-sampler-dff-reset-clocked-23
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-23/
  files:
    - ss_27c_3.30v.spice  sha256:d5b6f1468f54ce4d325e94a648fcf465edb503fddc02327fa82ee02720864136
    - ss_27c_3.30v.log  sha256:3b8a893b191114c009f339713810ac6b1489af3e01c15f1429ab6f9ca27746a0
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.134495
- `q_rst_max_frac`: 0.040756
- `s_rst_min_v`: 2.81176
- `s_rst_dev_frac`: 0.147951
- `mb_rst_min_v`: 3.14601
- `q_rel_v`: 1.520327e-06
- `q_cap_v`: 3.30001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
