---
record: 2026-08-02-sampler-dff-reset-current-xsv-22
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-22/
  files:
    - ss_27c_2.97v.spice  sha256:cc916c8ba5614e34d77700e2bb4de784b5c4f8aa17e6c59f48f6b458cda53f85
    - ss_27c_2.97v.log  sha256:d4b5dde624053843a5ed417d5f620c27f8c6448eaef0759240df063b4c547b59
wall_time: 2.9s
---

## Result

- `i_reset_xsv_a`: 4.342872e-11
- `p_reset_xsv_w`: 1.289833e-10
- `v_q`: 1.992140e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
