---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-35
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-35/
  files:
    - fs_125c_3.30v.spice  sha256:1ba72adcfdb03c04002784e85e0cadc4af49575206ea28cc6a922b520ce301d2
    - fs_125c_3.30v.log  sha256:eb4217c154cd7ae03c22a498501ee7e854661dcefeaa92892a8233fd5caaa758
wall_time: 0.6s
---

## Result

- `i_leak_a`: 4.325881e-09
- `p_idle_w`: 1.427541e-08
- `v_n1`: 3.29999
- `v_n2`: 1.226890e-08
- `v_n3`: 3.3
- `v_n4`: 1.226847e-08
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners fs --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
