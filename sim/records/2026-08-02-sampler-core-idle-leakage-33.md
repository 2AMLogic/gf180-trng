---
record: 2026-08-02-sampler-core-idle-leakage-33
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-33/
  files:
    - fs_27c_3.63v.spice  sha256:46c73fd7a5a2c1818cc150b5815399d3807cfb7c26cb1dea0a92de6d30d89f45
    - fs_27c_3.63v.log  sha256:e2bbf2839de67f690b9e41f23be468b009869e1390968c5c6e6c315b40f2c9d4
wall_time: 45.8s
---

## Result

- `i_idle_clklo_a`: 5.856000e-10
- `i_idle_clkhi_a`: 3.645500e-10
- `p_idle_clklo_w`: 2.125728e-09
- `p_idle_clkhi_w`: 1.323317e-09
- `i_idle_clklo_prev_a`: 5.940000e-10
- `i_idle_clkhi_prev_a`: 3.646000e-10
- `i_idle_worst_a`: 5.856000e-10
- `p_idle_worst_w`: 2.125728e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 7.984013e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 1.202423e-07
- `v_rawbit_clklo_v`: -6.753483e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.895444e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
