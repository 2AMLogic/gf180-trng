---
record: 2026-08-01-sampler-dff-reset-clocked-02
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-02/
  files:
    - tt_-40c_3.30v.spice  sha256:32c7d0a03bcbf9caad0f263a81329c647af15abfd15a256f9d5b5bf7bcda6018
    - tt_-40c_3.30v.log  sha256:f6ceffedeb3b41ea5d98dd9fbf34d9fd2aa5406755fb93ad8ddf18327c321ccb
wall_time: 2.6m
---

## Result

- `q_rst_max_v`: 0.137438
- `q_rst_max_frac`: 0.041648
- `s_rst_min_v`: 2.80059
- `s_rst_dev_frac`: 0.151335
- `mb_rst_min_v`: 3.14543
- `q_rel_v`: 2.086231e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
