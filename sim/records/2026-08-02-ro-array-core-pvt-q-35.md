---
record: 2026-08-02-ro-array-core-pvt-q-35
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-35/
  files:
    - tt_125c_3.30v.spice  sha256:daffbb3d0777b1f41417459e65939a0f9c20e7e8908ed9eee8a05befa77b928a
    - tt_125c_3.30v.log  sha256:18628502db9e2d25b3b86a9aaf57f8b2221af200b9fb2142e697b67382eb6b53
wall_time: 2.9m
---

## Result

- `period_r1`: 8.903305e-09
- `period_r2`: 8.305255e-09
- `f_r1`: 1.123178e+08
- `f_r2`: 1.204057e+08
- `i_r1_a`: -1.544568e-05
- `i_r2_a`: -1.650623e-05
- `i_tree_a`: -1.453527e-05
- `e_cycle_r1_j`: -4.538082e-13
- `c_eff_node_r1_f`: -3.788364e-15
- `ring_swing_v`: 3.45437
- `xo_swing_v`: 3.42436
- `i_total_a`: -4.648719e-05
- `p_rings_w`: -1.054413e-04
- `p_total_w`: -1.534077e-04
- `xo_trans_per_s`: 4.654471e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners tt --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
