---
record: 2026-08-02-sampler-dff-active-current-14
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-14/
  files:
    - ff_27c_3.30v.spice  sha256:246707415e0e5e5fa1cc27daf257d6b7f4ab88cdc9af6831d50d331218c10bab
    - ff_27c_3.30v.log  sha256:f37f3c4522128a076e4b80b6e6d77c0eed72e037f2c30b2b7bb49a8c6da9cdf8
wall_time: 14.1s
---
...
- `q_d_open_c`: 8.416367e-15
- `e_d_shut_j`: 2.200000e-19
- `e_d_open_j`: 2.777401e-14
- `q_clkcyc_xsv_c`: 7.669400e-15
- `e_clkcyc_xsv_j`: 2.530902e-14
- `q_clkcyc_xsb_resid_c`: 1.253500e-15
- `q_cyc_xsb_total_c`: 9.383420e-14
- `q_d_shut_xsv_c`: 8.166667e-20
- `q_d_open_xsv_c`: 9.666667e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.751475e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -1.517681e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ff --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
