---
record: 2026-08-01-sampler-dff-reset-clocked-27
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-27/
  files:
    - ss_125c_3.63v.spice  sha256:07272e907764cd28133304b13b421929d9043b7b5a088be15219be81bdd32209
    - ss_125c_3.63v.log  sha256:24938d3cba973b1a196bebb1f1a1b49914aecc62c320d0d0620102b238f64d90
wall_time: 2.2m
---

## Result

- `q_rst_max_v`: 0.142283
- `q_rst_max_frac`: 0.0391963
- `s_rst_min_v`: 3.0919
- `s_rst_dev_frac`: 0.148237
- `mb_rst_min_v`: 3.46651
- `q_rel_v`: 1.314698e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
