---
record: 2026-08-01-sampler-dff-reset-clocked-13
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-13/
  files:
    - ff_27c_2.97v.spice  sha256:d3326cdb70c42782b34acea08d6a38d2430c8fd6fec418424a2c9740566b56a4
    - ff_27c_2.97v.log  sha256:96345e836dccbd3265bf24ffd8ecf44d035538a01d3cac4c5ee969dfb1717b88
wall_time: 2.0m
---

## Result

- `q_rst_max_v`: 0.119557
- `q_rst_max_frac`: 0.0402549
- `s_rst_min_v`: 2.52497
- `s_rst_dev_frac`: 0.149843
- `mb_rst_min_v`: 2.83909
- `q_rel_v`: 2.356426e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
