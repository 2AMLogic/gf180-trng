---
record: 2026-08-02-sampler-core-idle-leakage-15
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-15/
  files:
    - ff_27c_3.63v.spice  sha256:5ab2369d07ecc6827e738edbf7a5936818b6af932786985710326cc62760ae4a
    - ff_27c_3.63v.log  sha256:07e11ba3240bcbc5a04fc192c7ccc6b7a62b4f084faac9aef698f7196e6d504e
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 8.223000e-10
- `i_idle_clkhi_a`: 5.348000e-10
- `p_idle_clklo_w`: 2.984949e-09
- `p_idle_clkhi_w`: 1.941324e-09
- `i_idle_clklo_prev_a`: 8.327500e-10
- `i_idle_clkhi_prev_a`: 5.348000e-10
- `i_idle_worst_a`: 8.223000e-10
- `p_idle_worst_w`: 2.984949e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 3.744123e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 1.239051e-07
- `v_rawbit_clklo_v`: -8.385296e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.947579e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
