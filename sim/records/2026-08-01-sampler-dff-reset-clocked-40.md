---
record: 2026-08-01-sampler-dff-reset-clocked-40
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-40/
  files:
    - sf_27c_2.97v.spice  sha256:e09d9bd4912783a69453604f62ce1128c8b6085cc3b98443639be1856d8cc62e
    - sf_27c_2.97v.log  sha256:38afadb9773219991bf9c1f89133f4b02eebdaebf8c97013fd67b8cda51e5db9
wall_time: 1.7m
---

## Result

- `q_rst_max_v`: 0.122002
- `q_rst_max_frac`: 0.0410782
- `s_rst_min_v`: 2.5219
- `s_rst_dev_frac`: 0.150876
- `mb_rst_min_v`: 2.83361
- `q_rel_v`: 9.639546e-07
- `q_cap_v`: 2.97001
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
