---
record: 2026-08-02-sampler-dff-active-current-23
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-23/
  files:
    - ss_27c_3.30v.spice  sha256:e0c3eada2718e88b550903b2bc5f0e04905f969df7a6a86723fe808742b447aa
    - ss_27c_3.30v.log  sha256:981ac9b727aa0faefb4887450d22bdc8b8293f105d33297d69109a189d40833b
wall_time: 16.2s
---
...
- `q_d_open_c`: 8.022417e-15
- `e_d_shut_j`: 1.760000e-19
- `e_d_open_j`: 2.647398e-14
- `q_clkcyc_xsv_c`: 7.699950e-15
- `e_clkcyc_xsv_j`: 2.540984e-14
- `q_clkcyc_xsb_resid_c`: 6.751833e-16
- `q_cyc_xsb_total_c`: 8.892230e-14
- `q_d_shut_xsv_c`: 4.833333e-20
- `q_d_open_xsv_c`: 5.000000e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 2.068328e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -1.158780e-06
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
