---
record: 2026-08-02-sampler-dff-active-current-17
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-17/
  files:
    - ff_125c_3.30v.spice  sha256:0e248952dd72cd286e24bad0a2e11bbd17339baf314c038a0f9e720a92f0a99b
    - ff_125c_3.30v.log  sha256:d13f0122a34744731c402477e7f9eebabbe133809f6ad85d5b496c622f87c183
wall_time: 16.1s
---

## Result

- `q_d_shut_c`: 1.983333e-18
- `q_d_open_c`: 8.852100e-15
- `e_d_shut_j`: 6.545000e-18
- `e_d_open_j`: 2.921193e-14
- `q_clkcyc_xsv_c`: 7.886720e-15
- `e_clkcyc_xsv_j`: 2.602618e-14
- `q_clkcyc_xsb_resid_c`: 1.724967e-15
- `q_cyc_xsb_total_c`: 9.911790e-14
- `q_d_shut_xsv_c`: 3.261667e-18
- `q_d_open_xsv_c`: 4.521667e-18
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 6.373587e-07
- `qv_post_v`: 3.29999
- `qb_pre_v`: 2.328897e-07
- `qb_post_v`: 3.29999
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ff --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
