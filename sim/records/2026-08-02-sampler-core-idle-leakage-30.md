---
record: 2026-08-02-sampler-core-idle-leakage-30
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-30/
  files:
    - fs_-40c_3.63v.spice  sha256:af23c6721fa688e274b4f98e8a8c09a10247a502b9f0106d62347962235ac252
    - fs_-40c_3.63v.log  sha256:ef5983cd24182e538d79823ff907c081f61ed72e0ab6b5e9949a66e15f0a9c4e
wall_time: 49.2s
---

## Result

- `i_idle_clklo_a`: 3.927500e-10
- `i_idle_clkhi_a`: 2.205500e-10
- `p_idle_clklo_w`: 1.425682e-09
- `p_idle_clkhi_w`: 8.005965e-10
- `i_idle_clklo_prev_a`: 3.995500e-10
- `i_idle_clkhi_prev_a`: 2.206000e-10
- `i_idle_worst_a`: 3.927500e-10
- `p_idle_worst_w`: 1.425682e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 8.560544e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 9.160519e-08
- `v_rawbit_clklo_v`: -5.845563e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.619988e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
