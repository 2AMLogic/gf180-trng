---
record: 2026-08-02-sampler-core-idle-leakage-12
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-12/
  files:
    - ff_-40c_3.63v.spice  sha256:a17dc316ffca7b0bd5b5ef5b571efa69c906a577c1f2acb5a7a63f86e1d1a11e
    - ff_-40c_3.63v.log  sha256:c5fc8470197ac1419954cdbf2630bf8a0c999c46f9c504b81b898b9f17303a74
wall_time: 1.0m
---

## Result

- `i_idle_clklo_a`: 4.511000e-10
- `i_idle_clkhi_a`: 2.245000e-10
- `p_idle_clklo_w`: 1.637493e-09
- `p_idle_clkhi_w`: 8.149350e-10
- `i_idle_clklo_prev_a`: 4.605000e-10
- `i_idle_clkhi_prev_a`: 2.245000e-10
- `i_idle_worst_a`: 4.511000e-10
- `p_idle_worst_w`: 1.637493e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: -3.635045e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 8.830380e-08
- `v_rawbit_clklo_v`: -7.925049e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.571325e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ff --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
