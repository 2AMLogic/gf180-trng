---
record: 2026-08-01-sampler-dff-reset-clocked-08
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-08/
  files:
    - tt_125c_3.30v.spice  sha256:180bfd35b21133011e42ce7e04f03cb40ea9a4a21083b0b0e7c86b21f36b9758
    - tt_125c_3.30v.log  sha256:3bbe78a352c15f79e90067f3c15419b1304dd29f88ef5753642b47d73605ca6e
wall_time: 2.0m
---

## Result

- `q_rst_max_v`: 0.128526
- `q_rst_max_frac`: 0.0389472
- `s_rst_min_v`: 2.81175
- `s_rst_dev_frac`: 0.147954
- `mb_rst_min_v`: 3.15559
- `q_rel_v`: 1.878819e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
