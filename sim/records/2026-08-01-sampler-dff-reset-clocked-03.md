---
record: 2026-08-01-sampler-dff-reset-clocked-03
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-03/
  files:
    - tt_-40c_3.63v.spice  sha256:4dfb83fb6fcce6ae35a2133b046f19baeccccc878d5e7e0258487bfd1f1ba1cb
    - tt_-40c_3.63v.log  sha256:8bbc38da4b37e8632752cfcfce606b65db3acd09fec70b72d4efe624f6111f63
wall_time: 2.6m
---

## Result

- `q_rst_max_v`: 0.150969
- `q_rst_max_frac`: 0.0415893
- `s_rst_min_v`: 3.0742
- `s_rst_dev_frac`: 0.153113
- `mb_rst_min_v`: 3.45964
- `q_rel_v`: 1.185143e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
