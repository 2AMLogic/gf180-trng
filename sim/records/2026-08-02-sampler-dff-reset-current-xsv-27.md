---
record: 2026-08-02-sampler-dff-reset-current-xsv-27
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-27/
  files:
    - ss_125c_3.63v.spice  sha256:bae637229b00f9d95a71267b00ba9101c40b5cdfd7da981eb8feb5d8c97cb490
    - ss_125c_3.63v.log  sha256:ef242d9478a952c14650bf17c83362f7aea537f6d50f6a091a18d4a058d32cad
wall_time: 3.3s
---

## Result

- `i_reset_xsv_a`: 1.037043e-10
- `p_reset_xsv_w`: 3.764467e-10
- `v_q`: 3.429434e-08
- `v_m`: 3.63
- `v_mb`: 3.63
- `v_qb`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
