---
record: 2026-08-01-sampler-dff-reset-clocked-34
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-34/
  files:
    - fs_125c_2.97v.spice  sha256:6965f39fad1d41a2e3d4821decd89825dd9b05be0606e0d434747ac4f3baffd8
    - fs_125c_2.97v.log  sha256:42ebffd0c834f635e32034aae1842ee867d0f56ad99d5b04d00845a15f2239cc
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.113906
- `q_rst_max_frac`: 0.0383522
- `s_rst_min_v`: 2.5437
- `s_rst_dev_frac`: 0.143536
- `mb_rst_min_v`: 2.82893
- `q_rel_v`: 1.116013e-06
- `q_cap_v`: 2.96999
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
