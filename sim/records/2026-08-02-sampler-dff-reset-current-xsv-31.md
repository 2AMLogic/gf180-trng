---
record: 2026-08-02-sampler-dff-reset-current-xsv-31
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-31/
  files:
    - fs_27c_2.97v.spice  sha256:e52552d1649c111bd73a0a3cea357e1e32721bf86d5554111b3a5a952a08b8a3
    - fs_27c_2.97v.log  sha256:c9167801afb62c2f95373e42f4a4b92989fa6cb67b36571ae50878fe16329fa8
wall_time: 3.0s
---

## Result

- `i_reset_xsv_a`: 5.717503e-11
- `p_reset_xsv_w`: 1.698098e-10
- `v_q`: 1.632627e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners fs --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
