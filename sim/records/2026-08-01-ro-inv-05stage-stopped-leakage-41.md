---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-41
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-41/
  files:
    - sf_27c_3.30v.spice  sha256:50b1a87635286f2d9dc00967aaac9066f6eee9db8c85a29c8d5cf232b6fef84a
    - sf_27c_3.30v.log  sha256:e4dfb7d3d71de17ebcb0d6a92aaadb0706d524eaef94aae7da13cbc438794c62
wall_time: 1.0s
---

## Result

- `i_leak_a`: 1.756345e-11
- `p_idle_w`: 5.795937e-11
- `v_n1`: 3.3
- `v_n2`: 6.135126e-09
- `v_n3`: 3.3
- `v_n4`: 6.135126e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners sf --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
