---
record: 2026-08-01-sampler-dff-reset-clocked-42
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-42/
  files:
    - sf_27c_3.63v.spice  sha256:751d8fc8b1bbeeb37f69c0329a7dfffb4912ec092c35bb17946fef9ccb5a64b8
    - sf_27c_3.63v.log  sha256:5bd079375cda6a6d5f7adf467537d978d1c82fa0785df001bea65a1513292263
wall_time: 1.7m
---

## Result

- `q_rst_max_v`: 0.148106
- `q_rst_max_frac`: 0.0408004
- `s_rst_min_v`: 3.07373
- `s_rst_dev_frac`: 0.153244
- `mb_rst_min_v`: 3.46214
- `q_rel_v`: 3.167602e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
