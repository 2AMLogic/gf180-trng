---
record: 2026-08-02-sampler-dff-active-current-05
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-05/
  files:
    - tt_27c_3.30v.spice  sha256:428d4f3f8a3df6bbeb4bd82c46638b35efbeddf235b1b5e9a8383068e16c5388
    - tt_27c_3.30v.log  sha256:809aa3e9488451bc15c9bdaad5f37fc52c4d3b165a1f08741056cfbb0df6e334
wall_time: 14.0s
---
...
- `q_d_open_c`: 8.178833e-15
- `e_d_shut_j`: 1.760000e-19
- `e_d_open_j`: 2.699015e-14
- `q_clkcyc_xsv_c`: 7.691960e-15
- `e_clkcyc_xsv_j`: 2.538347e-14
- `q_clkcyc_xsb_resid_c`: 8.565000e-16
- `q_cyc_xsb_total_c`: 9.082420e-14
- `q_d_shut_xsv_c`: 5.166667e-20
- `q_d_open_xsv_c`: 5.166667e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.845160e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -3.851754e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
