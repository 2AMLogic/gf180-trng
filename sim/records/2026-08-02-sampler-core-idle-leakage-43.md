---
record: 2026-08-02-sampler-core-idle-leakage-43
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-43/
  files:
    - sf_125c_2.97v.spice  sha256:b4477961ef14112095ee5ce5588935bda9ad0c83bd3b2138f19fe7f04bea3177
    - sf_125c_2.97v.log  sha256:0489b79f8c9b90988363dd1cbf6f500eccdf61d19c873ea1dd5a38ca4588e5bf
wall_time: 1.2m
---

## Result

- `i_idle_clklo_a`: 1.662000e-09
- `i_idle_clkhi_a`: 1.520600e-09
- `p_idle_clklo_w`: 4.936140e-09
- `p_idle_clkhi_w`: 4.516182e-09
- `i_idle_clklo_prev_a`: 1.670550e-09
- `i_idle_clkhi_prev_a`: 1.520600e-09
- `i_idle_worst_a`: 1.662000e-09
- `p_idle_worst_w`: 4.936140e-09
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 1.923336e-06
- `v_n1_v`: 2.97
- `v_n2_v`: 3.047238e-06
- `v_rawbit_clklo_v`: -5.869802e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 4.168346e-07
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
