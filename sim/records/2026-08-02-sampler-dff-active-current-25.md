---
record: 2026-08-02-sampler-dff-active-current-25
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-25/
  files:
    - ss_125c_2.97v.spice  sha256:50ece5cb15f68485212c528d01be913ae36226e9c7f7d52474b5a949cb1ae3de
    - ss_125c_2.97v.log  sha256:dc37ec9d25bf0a7405ecf611f32818af792825af3912bfff38ccdc7ced3da31f
wall_time: 15.2s
---

## Result

- `q_d_shut_c`: 6.333333e-20
- `q_d_open_c`: 7.513000e-15
- `e_d_shut_j`: 1.881000e-19
- `e_d_open_j`: 2.231361e-14
- `q_clkcyc_xsv_c`: 7.050520e-15
- `e_clkcyc_xsv_j`: 2.094004e-14
- `q_clkcyc_xsb_resid_c`: 6.603667e-16
- `q_cyc_xsb_total_c`: 8.330400e-14
- `q_d_shut_xsv_c`: 7.166667e-20
- `q_d_open_xsv_c`: 8.166667e-20
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 3.255199e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -6.333768e-06
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
