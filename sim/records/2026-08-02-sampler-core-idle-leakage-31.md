---
record: 2026-08-02-sampler-core-idle-leakage-31
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-31/
  files:
    - fs_27c_2.97v.spice  sha256:3c6c094cb16485139ad24a97df6ca2be9992033733e304494734c0815256f1fa
    - fs_27c_2.97v.log  sha256:d60a8f30ae9ddb5db1ba141f64084c00209ac002a7b260dda1ebc7b673299c89
wall_time: 47.2s
---

## Result

- `i_idle_clklo_a`: 3.986500e-10
- `i_idle_clkhi_a`: 2.560000e-10
- `p_idle_clklo_w`: 1.183990e-09
- `p_idle_clkhi_w`: 7.603200e-10
- `i_idle_clklo_prev_a`: 4.041000e-10
- `i_idle_clkhi_prev_a`: 2.560000e-10
- `i_idle_worst_a`: 3.986500e-10
- `p_idle_worst_w`: 1.183990e-09
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 5.782605e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 1.089685e-07
- `v_rawbit_clklo_v`: -4.593839e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.703826e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
