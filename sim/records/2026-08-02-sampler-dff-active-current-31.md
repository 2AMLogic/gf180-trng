---
record: 2026-08-02-sampler-dff-active-current-31
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-31/
  files:
    - fs_27c_2.97v.spice  sha256:a0ef11a62e3309d185cdb5ec26cf8c643745a3cccd7197016146fd8a4c6c6a49
    - fs_27c_2.97v.log  sha256:f16e6c1b28b92fd3ba5a80a00ad57cf482e2d0cac41cc754dc334d0b824fedd8
wall_time: 12.4s
---
...
- `q_d_open_c`: 7.261117e-15
- `e_d_shut_j`: 1.534500e-19
- `e_d_open_j`: 2.156552e-14
- `q_clkcyc_xsv_c`: 6.885640e-15
- `e_clkcyc_xsv_j`: 2.045035e-14
- `q_clkcyc_xsb_resid_c`: 7.060000e-16
- `q_cyc_xsb_total_c`: 8.057880e-14
- `q_d_shut_xsv_c`: 5.500000e-20
- `q_d_open_xsv_c`: 6.000000e-20
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 1.632614e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -7.362491e-07
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
