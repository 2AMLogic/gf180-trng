---
record: 2026-08-01-sampler-dff-reset-current-xsb-25
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-25/
  files:
    - ss_125c_2.97v.spice  sha256:706bce231bd1a0558e27acb5787a50b1a91e807c49b647fc33fc556dbf9f2a6c
    - ss_125c_2.97v.log  sha256:378c7b3106d169d6f54785494724eb6bf5d9774e61889511a2742dacb2c045ed
wall_time: 4.5s
---

## Result

- `i_reset_xsb_a`: 5.518482e-05
- `p_reset_xsb_w`: 1.638989e-04
- `i_reset_xsb_first_a`: 5.518480e-05
- `i_reset_xsb_last_a`: 5.518485e-05
- `q_v`: -3.908230e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
