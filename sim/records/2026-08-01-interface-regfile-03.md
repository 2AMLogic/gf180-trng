---
record: 2026-08-01-interface-regfile-03
date: 2026-08-01T21:21:23Z
status: valid
...
raw:
  path: sim/records/raw/2026-08-01-interface-regfile-03/
  files:
    - data_words.hex  sha256:92911321fcce6db6676feba5e30c8a46d0e56df5171d42ee861c944a72f2c1cd
    - raw_words.hex  sha256:efebf43a17c0e62545ebb8bbcc42542e9044d1c6767f4067dd34f00b73087a00
    - summary.json  sha256:c0dfe3f05d414e7eb793d0fbd3424d40a3be3608ec123abba0ffd0f245d17d9c
wall_time: 1.0s
---

## Result

Scenario `mode-switch` — DR-0001 §2's flush rule: switching OUT_MODE in either direction flushes the conditioner and both output FIFOs, so no bit produced before the switch is readable after it.
...
| conditioned words offered by the conditioner | 26 |
| DATA words read | 26 |
| RAW_DATA words read | 254 |
| raw words packed | 254 |
| flush events | 2 |
| FIFO words discarded by flush | 0 |
| partial raw bits discarded by flush | 39 |
...
| DATA stream sha256 | `92911321fcce6db6676feba5e30c8a46d0e56df5171d42ee861c944a72f2c1cd` |
| RAW_DATA stream sha256 | `efebf43a17c0e62545ebb8bbcc42542e9044d1c6767f4067dd34f00b73087a00` |
| FIFO words held at the last OUT_MODE switch | 0 |
| FIFO words surviving it (DR-0001 §2 requires 0) | 0 |
...
```sh
python3 sim/tb/interface-regfile/run_demo.py --scenario mode-switch --no-write
```
