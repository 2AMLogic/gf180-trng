---
record: 2026-08-01-sampler-dff-reset-clocked-07
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-07/
  files:
    - tt_125c_2.97v.spice  sha256:d2047114a7e5ddb40d43db78197b14a4b705f84846fed32755ec29a69bdc9548
    - tt_125c_2.97v.log  sha256:e29003200db6614fa16d007ec4750ca5975b4979709c302f7571142a4d74f3dd
wall_time: 2.0m
---

## Result

- `q_rst_max_v`: 0.115795
- `q_rst_max_frac`: 0.0389882
- `s_rst_min_v`: 2.53519
- `s_rst_dev_frac`: 0.146402
- `mb_rst_min_v`: 2.84001
- `q_rel_v`: 1.006014e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
