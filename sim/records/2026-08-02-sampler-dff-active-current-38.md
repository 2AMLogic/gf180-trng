---
record: 2026-08-02-sampler-dff-active-current-38
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-38/
  files:
    - sf_-40c_3.30v.spice  sha256:ab5fc572abc6c26fdd5e0a41b9f849bd7b2211f1416eaaacc80a3e97a42eed32
    - sf_-40c_3.30v.log  sha256:8c95d270203937474b68450dacc0539f0d9fce15b5afd896cd49ee088daaba7e
wall_time: 11.7s
---

## Result

- `q_d_shut_c`: 5.333333e-20
- `q_d_open_c`: 7.955117e-15
- `e_d_shut_j`: 1.760000e-19
- `e_d_open_j`: 2.625188e-14
- `q_clkcyc_xsv_c`: 7.602390e-15
- `e_clkcyc_xsv_j`: 2.508789e-14
- `q_clkcyc_xsb_resid_c`: 8.760833e-16
- `q_cyc_xsb_total_c`: 8.838290e-14
- `q_d_shut_xsv_c`: 5.000000e-20
- `q_d_open_xsv_c`: 5.000000e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.635372e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -1.065080e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners sf --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
