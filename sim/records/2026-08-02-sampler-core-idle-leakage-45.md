---
record: 2026-08-02-sampler-core-idle-leakage-45
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-45/
  files:
    - sf_125c_3.63v.spice  sha256:bc0d1eeb335ba84293f24b9c2f2e081e540afc743059ca683d35a642e561f2f8
    - sf_125c_3.63v.log  sha256:dd3c1a789903c8731f8164744e6d2924916371efa75592f9372d7b17dccee4b9
wall_time: 1.2m
---

## Result

- `i_idle_clklo_a`: 2.200700e-09
- `i_idle_clkhi_a`: 1.996000e-09
- `p_idle_clklo_w`: 7.988541e-09
- `p_idle_clkhi_w`: 7.245480e-09
- `i_idle_clklo_prev_a`: 2.212250e-09
- `i_idle_clkhi_prev_a`: 1.995950e-09
- `i_idle_worst_a`: 2.200700e-09
- `p_idle_worst_w`: 7.988541e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 2.221007e-06
- `v_n1_v`: 3.63
- `v_n2_v`: 3.302731e-06
- `v_rawbit_clklo_v`: -7.637139e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 4.513734e-07
- `v_rawvalid_clkhi_v`: 3.63
- `v_sup_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
