---
record: 2026-08-02-sampler-dff-active-current-08
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-08/
  files:
    - tt_125c_3.30v.spice  sha256:42d383c9c77079824382fc268caa5ff48a6df51831a0c15d0581dad2d32bcac2
    - tt_125c_3.30v.log  sha256:f58057e99f6dd188b22449b2387bddcde9d3b1e213fe1b18b37b88c44d6e6c13
wall_time: 14.1s
---
...
- `q_d_open_c`: 8.610350e-15
- `e_d_shut_j`: 7.700000e-19
- `e_d_open_j`: 2.841415e-14
- `q_clkcyc_xsv_c`: 7.833100e-15
- `e_clkcyc_xsv_j`: 2.584923e-14
- `q_clkcyc_xsb_resid_c`: 1.098317e-15
- `q_cyc_xsb_total_c`: 9.581450e-14
- `q_d_shut_xsv_c`: 3.566667e-19
- `q_d_open_xsv_c`: 4.800000e-19
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 8.091633e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -1.298665e-06
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
