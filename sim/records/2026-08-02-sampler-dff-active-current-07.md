---
record: 2026-08-02-sampler-dff-active-current-07
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-07/
  files:
    - tt_125c_2.97v.spice  sha256:3d856ccbd7e01349b13cfe0a87882f992a7ef974a33d8f2dcc07dba36256d004
    - tt_125c_2.97v.log  sha256:22c86a9f9fe1303a5e2801d36ba694225a1ec5ef30212e40ab897beb3d95c674
wall_time: 14.4s
---

## Result

- `q_d_shut_c`: 2.033333e-19
- `q_d_open_c`: 7.691883e-15
- `e_d_shut_j`: 6.039000e-19
- `e_d_open_j`: 2.284489e-14
- `q_clkcyc_xsv_c`: 7.060770e-15
- `e_clkcyc_xsv_j`: 2.097049e-14
- `q_clkcyc_xsb_resid_c`: 8.374500e-16
- `q_cyc_xsb_total_c`: 8.545020e-14
- `q_d_shut_xsv_c`: 2.933333e-19
- `q_d_open_xsv_c`: 3.916667e-19
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 7.834308e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -2.030277e-06
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
