---
record: 2026-08-02-sampler-core-idle-leakage-32
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-32/
  files:
    - fs_27c_3.30v.spice  sha256:8bd19013574d0baf4b4167e49c83d243d1504c54d5c41583b3cab1d0a193df8f
    - fs_27c_3.30v.log  sha256:a33589c7530d30daf7543163120f129b7617f7afa41488688cab7c9cca1f5130
wall_time: 46.8s
---

## Result

- `i_idle_clklo_a`: 4.844000e-10
- `i_idle_clkhi_a`: 3.039000e-10
- `p_idle_clklo_w`: 1.598520e-09
- `p_idle_clkhi_w`: 1.002870e-09
- `i_idle_clklo_prev_a`: 4.913500e-10
- `i_idle_clkhi_prev_a`: 3.039000e-10
- `i_idle_worst_a`: 4.844000e-10
- `p_idle_worst_w`: 1.598520e-09
- `v_ro1_v`: 3.3
- `v_ro2_v`: 3.3
- `v_xo_v`: 7.363359e-07
- `v_n1_v`: 3.3
- `v_n2_v`: 1.135952e-07
- `v_rawbit_clklo_v`: -5.664630e-06
- `v_rawvalid_clklo_v`: 3.3
- `v_rawbit_clkhi_v`: 1.794724e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
