---
record: 2026-08-02-sampler-dff-active-current-02
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-02/
  files:
    - tt_-40c_3.30v.spice  sha256:cdd6a3fb157a4b8ae9b5bd3779e1edc881781341e5e5bb17bb3e08cc37a71632
    - tt_-40c_3.30v.log  sha256:252c5508e96423a5029a92d7684a7ce4758b6baa92ffeb1669beeaf95a7afff7
wall_time: 12.0s
---
...
- `q_d_open_c`: 7.914850e-15
- `e_d_shut_j`: 1.705000e-19
- `e_d_open_j`: 2.611900e-14
- `q_clkcyc_xsv_c`: 7.578870e-15
- `e_clkcyc_xsv_j`: 2.501027e-14
- `q_clkcyc_xsb_resid_c`: 8.477333e-16
- `q_cyc_xsb_total_c`: 8.791160e-14
- `q_d_shut_xsv_c`: 5.000000e-20
- `q_d_open_xsv_c`: 5.000000e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.534244e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -1.324388e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners tt --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
