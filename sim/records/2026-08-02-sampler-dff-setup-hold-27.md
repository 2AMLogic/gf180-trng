---
record: 2026-08-02-sampler-dff-setup-hold-27
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-setup-hold-27/
  files:
    - ss_125c_3.63v.spice  sha256:21cf64a9c6cfd43f42c4e710f9d891c7c33462890e1c3ab699c4a0d824cacc37
    - ss_125c_3.63v.log  sha256:2ed0a02d035b4d7c821fe2a50feca5b3403f6cb4e7a272b16fe9542cf6a3527a
wall_time: 2.2m
---

## Result

- `tpd_clk_q_rise_s`: 1.398000e-10
- `tpd_clk_q_fall_s`: 1.630000e-10
- `q_rst_v`: 3.429425e-08
- `q_e1_v`: 3.63
- `q_e2_v`: -3.109077e-06
- `q_e4_v`: 8.531125e-07
- `q_e3_1ns_v`: 1.089303e-04
- `q_e3_10ns_v`: -4.912764e-06
- `q_e3_100ns_v`: -4.673084e-06
- `q_e3_drift_v`: -1.136034e-04
- `q_e3_rail_dev_v`: -4.673084e-06
- `q_e5_1ns_v`: 1.295412e-04
- `q_e5_10ns_v`: 2.668973e-06
- `q_e5_100ns_v`: 2.515925e-06
- `q_e5_drift_v`: -1.270253e-04
- `q_e5_rail_dev_v`: 2.515925e-06
- `q_e6_v`: 8.530720e-07
- `q_e7_1ns_v`: 3.62961
- `q_e7_10ns_v`: 3.63
- `q_e7_100ns_v`: 3.63
- `q_e7_drift_v`: 3.910000e-04
...
```sh
python3 sim/run_corners.py sampler-dff-setup-hold --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
