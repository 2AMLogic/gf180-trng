---
record: 2026-08-02-sampler-dff-active-current-12
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-12/
  files:
    - ff_-40c_3.63v.spice  sha256:50ccfb4f05f388c1d7fea92830cec4ed7b4e968f34104a5cb16656fb10292b6d
    - ff_-40c_3.63v.log  sha256:f424c33c46b707617a5ab73c85b5699a7a2c19b56f231f80727f057cb502f0a3
wall_time: 13.8s
---

## Result

- `q_d_shut_c`: 5.000000e-20
- `q_d_open_c`: 9.016000e-15
- `e_d_shut_j`: 1.815000e-19
- `e_d_open_j`: 3.272808e-14
- `q_clkcyc_xsv_c`: 8.300650e-15
- `e_clkcyc_xsv_j`: 3.013136e-14
- `q_clkcyc_xsb_resid_c`: 1.270200e-15
- `q_cyc_xsb_total_c`: 1.004467e-13
- `q_d_shut_xsv_c`: 5.666667e-20
- `q_d_open_xsv_c`: 5.500000e-20
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 1.517148e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -8.033670e-08
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ff --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
