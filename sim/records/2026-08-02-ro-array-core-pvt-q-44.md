---
record: 2026-08-02-ro-array-core-pvt-q-44
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-44/
  files:
    - ff_125c_3.30v.spice  sha256:6b8d6e897d96e4fc8449ed0ec20b0c0f5018fc10c612ca6b990d2f10b4489bc7
    - ff_125c_3.30v.log  sha256:f700aad1c46c0aebf47bf16b5cc37c2ef37e70ec52b86a1068d9b791c72e77df
wall_time: 3.4m
---

## Result

- `period_r1`: 7.510290e-09
- `period_r2`: 7.023732e-09
- `f_r1`: 1.331507e+08
- `f_r2`: 1.423744e+08
- `i_r1_a`: -2.002342e-05
- `i_r2_a`: -2.134992e-05
- `i_tree_a`: -2.019330e-05
- `e_cycle_r1_j`: -4.962595e-13
- `c_eff_node_r1_f`: -4.142746e-15
- `ring_swing_v`: 3.45249
- `xo_swing_v`: 3.39218
- `i_total_a`: -6.156664e-05
- `p_rings_w`: -1.365320e-04
- `p_total_w`: -2.031699e-04
- `xo_trans_per_s`: 5.510502e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ff --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
