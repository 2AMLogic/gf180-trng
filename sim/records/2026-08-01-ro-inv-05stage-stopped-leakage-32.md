---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-32
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-32/
  files:
    - fs_27c_3.30v.spice  sha256:9c9cc8bff138e5a2f2132dda6d109bb9ae575f413e3d4447eeb6f2d1cc1dd9c8
    - fs_27c_3.30v.log  sha256:10ee952ad7be0c302739fed78699c4345dacac440c7e94f5e4cd89103653a12c
wall_time: 0.7s
---

## Result

- `i_leak_a`: 4.247177e-11
- `p_idle_w`: 1.401568e-10
- `v_n1`: 3.3
- `v_n2`: 5.060483e-09
- `v_n3`: 3.3
- `v_n4`: 5.060483e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners fs --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
