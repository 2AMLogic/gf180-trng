---
record: 2026-08-02-sampler-dff-reset-current-xsv-43
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-43/
  files:
    - sf_125c_2.97v.spice  sha256:920d8ff071be7d1b17825f7e1bfa918df1e4378d8f7a438ec1302be6f9f83015
    - sf_125c_2.97v.log  sha256:8f37b208dc6bf6c4ca6a0e5968d4d9c9347d4d151fd3b8b7b8cf198c2d7250fe
wall_time: 3.3s
---

## Result

- `i_reset_xsv_a`: 2.383193e-10
- `p_reset_xsv_w`: 7.078084e-10
- `v_q`: 4.159563e-07
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners sf --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
