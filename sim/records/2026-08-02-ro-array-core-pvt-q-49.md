---
record: 2026-08-02-ro-array-core-pvt-q-49
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-49/
  files:
    - ss_27c_2.97v.spice  sha256:5c2a042c55b8d80225e051beb89065bdb14a02bcdb1df7bd03360af38af9f122
    - ss_27c_2.97v.log  sha256:95dbc705c31209f85ddf4df42716ea93e55067070c440c19642bc23c02ee28bf
wall_time: 2.9m
---

## Result

- `period_r1`: 9.390085e-09
- `period_r2`: 8.743842e-09
- `f_r1`: 1.064953e+08
- `f_r2`: 1.143662e+08
- `i_r1_a`: -1.090706e-05
- `i_r2_a`: -1.167764e-05
- `i_tree_a`: -8.783746e-06
- `e_cycle_r1_j`: -3.041821e-13
- `c_eff_node_r1_f`: -3.134931e-15
- `ring_swing_v`: 3.13649
- `xo_swing_v`: 3.14532
- `i_total_a`: -3.136844e-05
- `p_rings_w`: -6.707655e-05
- `p_total_w`: -9.316427e-05
- `xo_trans_per_s`: 4.417230e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ss --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
