---
record: 2026-08-02-sampler-core-idle-leakage-06
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-06/
  files:
    - tt_27c_3.63v.spice  sha256:07a01e5bfffd31c06946626b5890b88cd746245bd167891f4003783cfab2aa7a
    - tt_27c_3.63v.log  sha256:7303cd6a5e427fa3de033c4e56969778657d710cac83e3ca0dd3169cdc9f7132
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 4.578000e-10
- `i_idle_clkhi_a`: 2.361500e-10
- `p_idle_clklo_w`: 1.661814e-09
- `p_idle_clkhi_w`: 8.572245e-10
- `i_idle_clklo_prev_a`: 4.669000e-10
- `i_idle_clkhi_prev_a`: 2.361500e-10
- `i_idle_worst_a`: 4.578000e-10
- `p_idle_worst_w`: 1.661814e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 8.897211e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 1.295562e-07
- `v_rawbit_clklo_v`: -7.510312e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 2.025085e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners tt --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
