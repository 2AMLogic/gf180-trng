---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-31
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-31/
  files:
    - fs_27c_2.97v.spice  sha256:80f52f7d734fee65f860a6a16d7ee682bf8c7a74115a0ab30a216c2e53ed647d
    - fs_27c_2.97v.log  sha256:5464f60a641c5007632f8139289e90c92aed66d897b93c82e980c44c4644b8a2
wall_time: 0.7s
---

## Result

- `i_leak_a`: 3.388435e-11
- `p_idle_w`: 1.006365e-10
- `v_n1`: 2.97
- `v_n2`: 4.703392e-09
- `v_n3`: 2.97
- `v_n4`: 4.703392e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners fs --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
