---
record: 2026-08-01-sampler-dff-reset-clocked-35
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-35/
  files:
    - fs_125c_3.30v.spice  sha256:65aaadf915d84ebddd0339ca8ecdc75a79b2266ff6be6fa63c682989938c1c75
    - fs_125c_3.30v.log  sha256:9fdafa6ad7522f1aa38761f66df24098564af535050c52a3a875072f92e6888f
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.126851
- `q_rst_max_frac`: 0.0384395
- `s_rst_min_v`: 2.81944
- `s_rst_dev_frac`: 0.145624
- `mb_rst_min_v`: 3.14919
- `q_rel_v`: 2.579396e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
