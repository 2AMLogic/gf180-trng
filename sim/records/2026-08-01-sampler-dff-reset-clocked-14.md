---
record: 2026-08-01-sampler-dff-reset-clocked-14
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-14/
  files:
    - ff_27c_3.30v.spice  sha256:498b85718fa0cd94469dcc8086d59c0a31e66fdfcdd89afc828e15354125df88
    - ff_27c_3.30v.log  sha256:f9ebd52fe0c549bd9476a06399093d2c90dec8cb7ae362b10bb8d8b8ac6bd082
wall_time: 2.0m
---

## Result

- `q_rst_max_v`: 0.132357
- `q_rst_max_frac`: 0.0401081
- `s_rst_min_v`: 2.80142
- `s_rst_dev_frac`: 0.151085
- `mb_rst_min_v`: 3.15379
- `q_rel_v`: 1.932136e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners ff --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
