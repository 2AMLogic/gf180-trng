---
record: 2026-08-01-sampler-dff-reset-current-xsv-20
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-20/
  files:
    - ss_-40c_3.30v.spice  sha256:57864b3fa00001f681435d7eb408b6046ce641cc78fd8cfd524ea25d2ea5fed5
    - ss_-40c_3.30v.log  sha256:087bb90959ab5dc50c2536468396a959cc0a8e6b144cedb0e61cdcc84bb547b7
wall_time: 1.2s
---

## Result

- `i_reset_xsv_a`: 1.760612e-04
- `p_reset_xsv_w`: 5.810021e-04
- `v_q`: 1.700387e-08
- `v_m`: 0.846316
- `v_rst`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ss --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
