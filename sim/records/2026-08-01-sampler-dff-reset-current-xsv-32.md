---
record: 2026-08-01-sampler-dff-reset-current-xsv-32
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsv-32/
  files:
    - fs_27c_3.30v.spice  sha256:12b2abd9d7e325531657102154964bf2dc2c07ae302a61a1af8376d3b528441e
    - fs_27c_3.30v.log  sha256:2d77bd039f30f7dfb5f2739eef0ad25d4f48a1753aa8a1366d4c7a5a5ca7a41b
wall_time: 1.1s
---

## Result

- `i_reset_xsv_a`: 2.023198e-04
- `p_reset_xsv_w`: 6.676555e-04
- `v_q`: 1.718045e-08
- `v_m`: 0.868394
- `v_rst`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners fs --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
