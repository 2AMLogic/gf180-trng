---
record: 2026-08-01-sampler-dff-reset-clocked-37
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-37/
  files:
    - sf_-40c_2.97v.spice  sha256:fe1133b8cd2695a3099d0bbbe22d7e03f92f3e9656b6e6a6fe697e3015682a99
    - sf_-40c_2.97v.log  sha256:a78990cee3fba9deb45f83f5b6ed1467ae086542209566a75aafdf3d5189f0f9
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.125225
- `q_rst_max_frac`: 0.0421632
- `s_rst_min_v`: 2.51786
- `s_rst_dev_frac`: 0.152234
- `mb_rst_min_v`: 2.8303
- `q_rel_v`: 1.555237e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
