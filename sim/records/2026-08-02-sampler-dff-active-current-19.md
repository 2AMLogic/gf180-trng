---
record: 2026-08-02-sampler-dff-active-current-19
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-19/
  files:
    - ss_-40c_2.97v.spice  sha256:fb0cd2f793fd24deb23fdb8da3ee94c45302d01212fd199388bb6411bb182a5b
    - ss_-40c_2.97v.log  sha256:5ce681279f6cb375a7701e315dfc5c2fae11ed8ce9bc78ffc99dc644fa02866d
wall_time: 15.1s
---

## Result

- `q_d_shut_c`: 4.666667e-20
- `q_d_open_c`: 6.895833e-15
- `e_d_shut_j`: 1.386000e-19
- `e_d_open_j`: 2.048062e-14
- `q_clkcyc_xsv_c`: 6.808640e-15
- `e_clkcyc_xsv_j`: 2.022166e-14
- `q_clkcyc_xsb_resid_c`: 5.569667e-16
- `q_cyc_xsb_total_c`: 7.641160e-14
- `q_d_shut_xsv_c`: 4.333333e-20
- `q_d_open_xsv_c`: 4.500000e-20
- `vdd_mean_v`: 2.97
- `qv_pre_v`: 1.617267e-08
- `qv_post_v`: 2.97
- `qb_pre_v`: -5.678384e-07
- `qb_post_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
