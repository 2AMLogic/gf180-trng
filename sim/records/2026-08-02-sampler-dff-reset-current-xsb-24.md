---
record: 2026-08-02-sampler-dff-reset-current-xsb-24
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-24/
  files:
    - ss_27c_3.63v.spice  sha256:d69a74732a6dcf76794aa7f94940fef6befd1538034a342d3b9a269ae58852d0
    - ss_27c_3.63v.log  sha256:873a057c4d3668fc68b475dd39546e18f496a0cb3e9c64ed4be104fcd131e118
wall_time: 13.1s
---

## Result

- `i_reset_xsb_a`: 2.420075e-08
- `p_reset_xsb_w`: 8.784872e-08
- `i_reset_xsb_first_a`: 3.543200e-08
- `i_reset_xsb_last_a`: 1.296950e-08
- `q_v`: -1.115045e-05
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
