---
record: 2026-08-02-sampler-core-idle-leakage-39
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-39/
  files:
    - sf_-40c_3.63v.spice  sha256:609f10abf85d9b1e032e14b0f36163e9af18c6779cfc56a7b5f28672d978b018
    - sf_-40c_3.63v.log  sha256:6462168df1e531f9d6581414df755eca58cbffd012aeeea582d3e80e1139af88
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 4.271000e-10
- `i_idle_clkhi_a`: 2.211500e-10
- `p_idle_clklo_w`: 1.550373e-09
- `p_idle_clkhi_w`: 8.027745e-10
- `i_idle_clklo_prev_a`: 4.354000e-10
- `i_idle_clkhi_prev_a`: 2.212000e-10
- `i_idle_worst_a`: 4.271000e-10
- `p_idle_worst_w`: 1.550373e-09
- `v_ro1_v`: 3.63
- `v_ro2_v`: 3.63
- `v_xo_v`: 4.633368e-07
- `v_n1_v`: 3.63
- `v_n2_v`: 1.058757e-07
- `v_rawbit_clklo_v`: -7.587501e-06
- `v_rawvalid_clklo_v`: 3.63
- `v_rawbit_clkhi_v`: 1.809516e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
