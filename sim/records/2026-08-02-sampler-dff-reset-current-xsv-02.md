---
record: 2026-08-02-sampler-dff-reset-current-xsv-02
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-02/
  files:
    - tt_-40c_3.30v.spice  sha256:376b43c3f34e50ab2b2ced5f07f0b2162909de379f23a423c01686738f2038cd
    - tt_-40c_3.30v.log  sha256:aedc65ba45fa647489c3526c8425bfb939cc6c7967204d0996784299f79575b9
wall_time: 3.2s
---

## Result

- `i_reset_xsv_a`: 4.827860e-11
- `p_reset_xsv_w`: 1.593194e-10
- `v_q`: 1.534262e-08
- `v_m`: 3.3
- `v_mb`: 3.3
- `v_qb`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners tt --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
