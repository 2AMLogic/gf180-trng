---
record: 2026-08-01-sampler-dff-reset-current-xsb-17
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-current-xsb-17/
  files:
    - ff_125c_3.30v.spice  sha256:70bee8b81873b9bba9257e521285f5d8e0e2dfc99a836ee73c6e659b8ec8629b
    - ff_125c_3.30v.log  sha256:249c3372b93334cdf24f86b148e6ba01d7b1aeab0a6a2430d4cbe8874d539546
wall_time: 4.7s
---

## Result

- `i_reset_xsb_a`: 1.042628e-04
- `p_reset_xsb_w`: 3.440672e-04
- `i_reset_xsb_first_a`: 1.042628e-04
- `i_reset_xsb_last_a`: 1.042628e-04
- `q_v`: 5.925495e-07
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ff --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
