---
record: 2026-08-02-sampler-dff-reset-current-xsb-19
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-19/
  files:
    - ss_-40c_2.97v.spice  sha256:1a80787595ca26725403e48918cdfac2cd755b7704ee8313cb5587b10f875e26
    - ss_-40c_2.97v.log  sha256:6ddf7b8031179c308fe39ae50b5c06dbfefbbbabbb73f7c485d5574a27100377
wall_time: 12.6s
---

## Result

- `i_reset_xsb_a`: 1.751425e-08
- `p_reset_xsb_w`: 5.201732e-08
- `i_reset_xsb_first_a`: 2.671050e-08
- `i_reset_xsb_last_a`: 8.318000e-09
- `q_v`: -7.822973e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners ss --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
