---
record: 2026-08-02-ro-array-core-xo-slew-04
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-04/
  files:
    - ff_-40c_3.63v.spice  sha256:f54846cd7b469d03af9fe973ac01227889437d582204e8a54caefa10ddf43d76
    - ff_-40c_3.63v.log  sha256:61071d5c31f593366fe2390fb8a0a45608ac02069b65c4aa0a70df077ceb48a6
wall_time: 10.8m
---

## Result

- `xo_slew_rise_v_per_s`: 5.478913e+10
- `xo_slew_fall_v_per_s`: -7.126546e+10
- `ro1_slew_rise_v_per_s`: 5.437670e+09
- `ro1_slew_fall_v_per_s`: -8.688325e+09
- `ro1_band_slew_a_v_per_s`: 2.727375e+09
- `ro1_band_slew_b_v_per_s`: 2.727375e+09
- `xo_swing_v`: 3.72147
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ff --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
