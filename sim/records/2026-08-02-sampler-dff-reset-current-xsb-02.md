---
record: 2026-08-02-sampler-dff-reset-current-xsb-02
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-02/
  files:
    - tt_-40c_3.30v.spice  sha256:2da92f3351c655752a03c7ba2df404b625c99541de1360ced38390a77a267672
    - tt_-40c_3.30v.log  sha256:61069c2cf2b2804496c380c68cf9e82f42ccfa5418d0edb68df76fe566636c60
wall_time: 12.0s
---

## Result

- `i_reset_xsb_a`: 1.666825e-08
- `p_reset_xsb_w`: 5.500522e-08
- `i_reset_xsb_first_a`: 2.495200e-08
- `i_reset_xsb_last_a`: 8.384500e-09
- `q_v`: -1.969311e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners tt --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
