---
record: 2026-08-02-sampler-core-idle-leakage-25
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-25/
  files:
    - ss_125c_2.97v.spice  sha256:064a86c390b2dcda91f263bdc482121057ca49ca02f819f73c290f81012789bf
    - ss_125c_2.97v.log  sha256:9d3ca46e7fb8aa81fc3a94869431afa9ceb61c750c579479f218999f31b01635
wall_time: 46.7s
---

## Result

- `i_idle_clklo_a`: 5.370000e-10
- `i_idle_clkhi_a`: 3.681000e-10
- `p_idle_clklo_w`: 1.594890e-09
- `p_idle_clkhi_w`: 1.093257e-09
- `i_idle_clklo_prev_a`: 5.442500e-10
- `i_idle_clkhi_prev_a`: 3.681000e-10
- `i_idle_worst_a`: 5.370000e-10
- `p_idle_worst_w`: 1.594890e-09
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 9.201572e-07
- `v_n1_v`: 2.97
- `v_n2_v`: 2.411732e-07
- `v_rawbit_clklo_v`: 5.502842e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 3.343818e-08
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners ss --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
