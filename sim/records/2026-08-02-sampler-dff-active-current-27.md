---
record: 2026-08-02-sampler-dff-active-current-27
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-27/
  files:
    - ss_125c_3.63v.spice  sha256:470feffeb1b87f4e3df8b96a90f1d7a03adfc261b8f4590069e4d55d06d835dd
    - ss_125c_3.63v.log  sha256:b8053e637d858a087ba850100a3ac4b64e06cb5fcf81f9dbb656a477e81f4f47
wall_time: 15.8s
---

## Result

- `q_d_shut_c`: 8.333333e-20
- `q_d_open_c`: 9.316550e-15
- `e_d_shut_j`: 3.025000e-19
- `e_d_open_j`: 3.381908e-14
- `q_clkcyc_xsv_c`: 8.577750e-15
- `e_clkcyc_xsv_j`: 3.113723e-14
- `q_clkcyc_xsb_resid_c`: 9.330167e-16
- `q_cyc_xsb_total_c`: 1.034159e-13
- `q_d_shut_xsv_c`: 9.500000e-20
- `q_d_open_xsv_c`: 1.100000e-19
- `vdd_mean_v`: 3.63
- `qv_pre_v`: 3.429445e-08
- `qv_post_v`: 3.63
- `qb_pre_v`: -2.826665e-06
- `qb_post_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps 125 --supply 3.63 --supply-tol 0 --no-write
```
