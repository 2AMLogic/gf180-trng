---
record: 2026-08-02-sampler-dff-active-current-26
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-26/
  files:
    - ss_125c_3.30v.spice  sha256:97b98bfafdd6a86e6ad1ded3d522e63755c87926d85d229e22ab1594e41d7e80
    - ss_125c_3.30v.log  sha256:eb0f69c4e5043c44d601e198df4d81d04b719ecc8883543f26ea7594233469e9
wall_time: 15.2s
---

## Result

- `q_d_shut_c`: 7.333333e-20
- `q_d_open_c`: 8.406983e-15
- `e_d_shut_j`: 2.420000e-19
- `e_d_open_j`: 2.774305e-14
- `q_clkcyc_xsv_c`: 7.832260e-15
- `e_clkcyc_xsv_j`: 2.584646e-14
- `q_clkcyc_xsb_resid_c`: 8.115500e-16
- `q_cyc_xsb_total_c`: 9.328910e-14
- `q_d_shut_xsv_c`: 8.166667e-20
- `q_d_open_xsv_c`: 9.500000e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 3.326084e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -4.184746e-06
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners ss --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
