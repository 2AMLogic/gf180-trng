---
record: 2026-08-01-sampler-dff-reset-clocked-33
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-33/
  files:
    - fs_27c_3.63v.spice  sha256:142e9d94975d46dbe62174aeeb6c82b3eec687c6adadcd6abbba2453e12a102a
    - fs_27c_3.63v.log  sha256:1af3d59a0556991acd559caf687c1770f25626e6535abfbb70e63d104540bb05
wall_time: 2.0m
---

## Result

- `q_rst_max_v`: 0.145432
- `q_rst_max_frac`: 0.040064
- `s_rst_min_v`: 3.0888
- `s_rst_dev_frac`: 0.14909
- `mb_rst_min_v`: 3.46295
- `q_rel_v`: 1.763587e-06
- `q_cap_v`: 3.63
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
