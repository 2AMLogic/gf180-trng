---
record: 2026-08-01-sampler-dff-reset-clocked-04
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-04/
  files:
    - tt_27c_2.97v.spice  sha256:f2f76d1d1f93c8af68e68493f8b6965fad33765a9665c39a8a06b9a48d54144f
    - tt_27c_2.97v.log  sha256:68d2159d76f7dd7e72b6e2d04cb6e7fdb614f86f88cba08f7d36fb6daaee6707
wall_time: 2.2m
---

## Result

- `q_rst_max_v`: 0.120427
- `q_rst_max_frac`: 0.0405477
- `s_rst_min_v`: 2.53031
- `s_rst_dev_frac`: 0.148043
- `mb_rst_min_v`: 2.83525
- `q_rel_v`: 1.694266e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners tt --temps 27 --supply 2.97 --supply-tol 0 --no-write
```
