---
record: 2026-08-02-sampler-dff-reset-current-xsb-38
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-38/
  files:
    - sf_-40c_3.30v.spice  sha256:26aa0d17c1b7743fecba5e2fb3b196deb1366cda5031b16919a8dac7b20b4f78
    - sf_-40c_3.30v.log  sha256:66e6a76cd19cfd64e14bf5a906b667a1eccc132647b5a44d1277a9e5ca243656
wall_time: 14.3s
---

## Result

- `i_reset_xsb_a`: 1.763950e-08
- `p_reset_xsb_w`: 5.821035e-08
- `i_reset_xsb_first_a`: 2.636750e-08
- `i_reset_xsb_last_a`: 8.911500e-09
- `q_v`: -1.408697e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
