---
record: 2026-08-02-sampler-dff-reset-current-xsv-10
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsv-10/
  files:
    - ff_-40c_2.97v.spice  sha256:5821c4ed3586f17a89b9747002c3d74c2e5c0b3e9f10ced337b4cd9a5bb20d81
    - ff_-40c_2.97v.log  sha256:3fbef76af428d00a5df76615ae97774da65029e8cfdd255a48bcbf02b3804649
wall_time: 3.4s
---

## Result

- `i_reset_xsv_a`: 4.367781e-11
- `p_reset_xsv_w`: 1.297231e-10
- `v_q`: 1.300911e-08
- `v_m`: 2.97
- `v_mb`: 2.97
- `v_qb`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsv --corners ff --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
