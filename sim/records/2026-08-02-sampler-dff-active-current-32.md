---
record: 2026-08-02-sampler-dff-active-current-32
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-active-current-32/
  files:
    - fs_27c_3.30v.spice  sha256:847f3cd361af585563dac9fbc008ca9b81dc5925693bbcd01f0a910872ed4ef3
    - fs_27c_3.30v.log  sha256:af7a544effd4640ab53eb162d6ac3976b6285e340ea90de683c8518eff97f8e8
wall_time: 12.8s
---
...
- `q_d_open_c`: 8.136000e-15
- `e_d_shut_j`: 1.815000e-19
- `e_d_open_j`: 2.684880e-14
- `q_clkcyc_xsv_c`: 7.658610e-15
- `e_clkcyc_xsv_j`: 2.527341e-14
- `q_clkcyc_xsb_resid_c`: 9.065500e-16
- `q_cyc_xsb_total_c`: 9.040310e-14
- `q_d_shut_xsv_c`: 6.333333e-20
- `q_d_open_xsv_c`: 7.166667e-20
- `vdd_mean_v`: 3.3
- `qv_pre_v`: 1.718033e-08
- `qv_post_v`: 3.3
- `qb_pre_v`: -4.923881e-07
- `qb_post_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-active-current --corners fs --temps 27 --supply 3.3 --supply-tol 0 --no-write
```
