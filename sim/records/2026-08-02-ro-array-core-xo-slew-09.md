---
record: 2026-08-02-ro-array-core-xo-slew-09
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-09/
  files:
    - ss_125c_3.30v.spice  sha256:47d9889f3bbc656113504db6cc2652ae18db1124b59cfa5813dad8fa85e06730
    - ss_125c_3.30v.log  sha256:520b32652e92e4a1fbe4027f58d312499a9408a1912a7d3f78a8fb71e101cecb
wall_time: 11.2m
---

## Result

- `xo_slew_rise_v_per_s`: 2.190081e+10
- `xo_slew_fall_v_per_s`: -2.809513e+10
- `ro1_slew_rise_v_per_s`: 1.655710e+09
- `ro1_slew_fall_v_per_s`: -2.970791e+09
- `ro1_band_slew_a_v_per_s`: 7.198246e+08
- `ro1_band_slew_b_v_per_s`: 9.202454e+08
- `xo_swing_v`: 3.37286
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ss --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
