---
record: 2026-08-02-sampler-core-idle-leakage-37
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-37/
  files:
    - sf_-40c_2.97v.spice  sha256:c4aa0690e955f2d5d37a211dd2545f85f2f390b89e909f6519c9936b1119f53a
    - sf_-40c_2.97v.log  sha256:4b1af2e71c1f30f4c63ef9293e656e6588c956ef6158d79fc10ab7ad87e65426
wall_time: 1.1m
---

## Result

- `i_idle_clklo_a`: 3.160500e-10
- `i_idle_clkhi_a`: 1.783500e-10
- `p_idle_clklo_w`: 9.386685e-10
- `p_idle_clkhi_w`: 5.296995e-10
- `i_idle_clklo_prev_a`: 3.213500e-10
- `i_idle_clkhi_prev_a`: 1.783000e-10
- `i_idle_worst_a`: 3.160500e-10
- `p_idle_worst_w`: 9.386685e-10
- `v_ro1_v`: 2.97
- `v_ro2_v`: 2.97
- `v_xo_v`: 1.133356e-06
- `v_n1_v`: 2.97
- `v_n2_v`: 9.714182e-08
- `v_rawbit_clklo_v`: -5.333920e-06
- `v_rawvalid_clklo_v`: 2.97
- `v_rawbit_clkhi_v`: 1.463890e-08
- `v_rawvalid_clkhi_v`: 2.97
- `v_sup_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners sf --temps -40 --supply 2.97 --supply-tol 0 --no-write
```
