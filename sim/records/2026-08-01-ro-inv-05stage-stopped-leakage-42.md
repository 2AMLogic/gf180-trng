---
record: 2026-08-01-ro-inv-05stage-stopped-leakage-42
...
raw:
  path: sim/records/raw/2026-08-01-ro-inv-05stage-stopped-leakage-42/
  files:
    - sf_27c_3.63v.spice  sha256:eefba2b6707b428f3a1fe1ee666634b200a01feb869095830c226796d10874cc
    - sf_27c_3.63v.log  sha256:54c882bb22435b15890b88b8a32ba30717c6d51d4edd5e17f9d1238cacf9e76f
wall_time: 1.2s
---

## Result

- `i_leak_a`: 1.999964e-11
- `p_idle_w`: 7.259871e-11
- `v_n1`: 3.63
- `v_n2`: 6.917497e-09
- `v_n3`: 3.63
- `v_n4`: 6.917497e-09
...
```sh
python3 sim/run_corners.py ro-inv-05stage-stopped-leakage --corners sf --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
