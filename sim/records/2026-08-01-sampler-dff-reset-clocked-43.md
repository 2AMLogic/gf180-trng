---
record: 2026-08-01-sampler-dff-reset-clocked-43
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-43/
  files:
    - sf_125c_2.97v.spice  sha256:9d39eb6598dc1e9569d28be8241cfea850be3d2258c53ebd18d789e39d0fdab6
    - sf_125c_2.97v.log  sha256:2267d4117e0652e549adc63058a8dfceadbcdb3c2cd5572356d9d5f06cb1813c
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.117258
- `q_rst_max_frac`: 0.0394807
- `s_rst_min_v`: 2.52881
- `s_rst_dev_frac`: 0.14855
- `mb_rst_min_v`: 2.83896
- `q_rel_v`: 1.051733e-06
- `q_cap_v`: 2.97
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps 125 --supply 2.97 --supply-tol 0 --no-write
```
