---
record: 2026-09-12-digital-sta-power-14
date: 2026-09-12T07:30:29Z
status: valid
...
parasitics:
  spef_sha256: 1a29551398044cedefe8afa84106832441f3aa4083acdc22519b44f01b19c1cf
  spef_bytes: 3412739
  note: >-
...
raw:
  path: sim/records/raw/2026-09-12-digital-sta-power-14/
  files:
    - constraint.tcl  sha256:d18485192a39a50ce93c5bd12dd6ebbf34b022b98a18786fdf53269ba3f53b57
    - constraint.log  sha256:61fa8b571bff598a7659afc779bef6bcb56db3e75bbe9c61de1bff74d9cb468a
    - ratified-rate.tcl  sha256:cc4424611c945053d0b39b76a01ad65c350ae5ff1269cf4c64c39f0d95b44403
    - ratified-rate.log  sha256:f064c3309454a4535fe54ae346a659566347cab4a63e5f451fb24e0ebceca19e
wall_time: 10.3s
---
...
- `worst_setup_slack_ns`: 4.208398e+01
- `worst_hold_slack_ns`: 7.138646e-01
- `worst_setup_slack_ideal_clock_ns`: 4.211552e+01
- `worst_hold_slack_ideal_clock_ns`: 6.916273e-01
- `clock_tree_cost_ns`: 3.154454e-02
- `tns_setup_ns`: 0.000000e+00
- `tns_hold_ns`: 0.000000e+00
- `clock_skew_setup_ns`: 6.049439e-02
- `min_period_ns`: 7.916672e+00
- `fmax_bisect_mhz`: 1.263157e+02
- `fmax_linear_mhz`: 1.263261e+02
...
- `p_total_20mhz_w`: 1.270021e-02
- `p_internal_20mhz_w`: 8.882409e-03
- `p_switching_20mhz_w`: 3.817331e-03
- `p_clock_20mhz_w`: 2.904488e-03
- `p_sequential_20mhz_w`: 6.728685e-03
- `p_combinational_20mhz_w`: 3.067042e-03
- `p_total_1mhz_w`: 6.354598e-04
- `p_internal_1mhz_w`: 4.441200e-04
- `p_switching_1mhz_w`: 1.908664e-04
- `p_clock_1mhz_w`: 1.453836e-04
- `p_clock_internal_1mhz_w`: 5.370629e-05
- `p_clock_switching_1mhz_w`: 9.150973e-05
- `p_sequential_1mhz_w`: 3.365967e-04
- `p_sequential_internal_1mhz_w`: 3.086674e-04
- `p_sequential_switching_1mhz_w`: 2.775817e-05
- `p_combinational_1mhz_w`: 1.534801e-04
- `p_combinational_internal_1mhz_w`: 8.174656e-05
- `p_combinational_switching_1mhz_w`: 7.159881e-05
- `p_leakage_w`: 4.734241e-07
- `i_leakage_a`: 1.315067e-07
- `i_total_1mhz_a`: 1.765166e-04
...
- `max_slew_slack_ns`: 2.320442e-01
...
```sh
python3 sim/tb/digital-sta-power/run_sta.py --liberty ff_n40C_3v60 --rc nom --no-write
```
...
- **One corner** (ff_n40C_3v60, interconnect `nom`). Says nothing about any
