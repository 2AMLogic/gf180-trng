---
record: 2026-08-02-sampler-dff-reset-current-xsb-39
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-39/
  files:
    - sf_-40c_3.63v.spice  sha256:08c2de29e59824a4f2ca601d3ccf90d04b0fcbafc25649c50386240763623015
    - sf_-40c_3.63v.log  sha256:ad741d0640af9ca9093f46056e0af05f1918bf95560f848e27e83b0ad11601f8
wall_time: 14.6s
---

## Result

- `i_reset_xsb_a`: 2.072900e-08
- `p_reset_xsb_w`: 7.524627e-08
- `i_reset_xsb_first_a`: 2.928950e-08
- `i_reset_xsb_last_a`: 1.216850e-08
- `q_v`: -9.769555e-07
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners sf --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
