---
record: 2026-08-02-ro-array-core-pvt-q-51
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-pvt-q-51/
  files:
    - ss_27c_3.63v.spice  sha256:2437dea6f772706a9e75b090a9ed751a0bf07f24390188fdbf0005c2638547af
    - ss_27c_3.63v.log  sha256:54d5d446746ba004e51441d917577a68cef9a179ce703dcd4df9da2f260b0ed8
wall_time: 2.8m
---

## Result

- `period_r1`: 7.255548e-09
- `period_r2`: 6.774745e-09
- `f_r1`: 1.378256e+08
- `f_r2`: 1.476070e+08
- `i_r1_a`: -1.856112e-05
- `i_r2_a`: -1.982146e-05
- `i_tree_a`: -1.584228e-05
- `e_cycle_r1_j`: -4.888561e-13
- `c_eff_node_r1_f`: -3.372680e-15
- `ring_swing_v`: 3.79857
- `xo_swing_v`: 3.81048
- `i_total_a`: -5.422486e-05
- `p_rings_w`: -1.393288e-04
- `p_total_w`: -1.968362e-04
- `xo_trans_per_s`: 5.708652e+08
...
```sh
python3 sim/run_corners.py ro-array-core-pvt-q --corners ss --temps 27 --supply 3.63 --supply-tol 0 --no-write
```
