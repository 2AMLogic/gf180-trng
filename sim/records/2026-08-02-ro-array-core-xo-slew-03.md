---
record: 2026-08-02-ro-array-core-xo-slew-03
...
raw:
  path: sim/records/raw/2026-08-02-ro-array-core-xo-slew-03/
  files:
    - ff_-40c_3.30v.spice  sha256:a46d4a06ab8ef5f1ac0afe8b279d888a359b3128765b85a3358f3dcc266ccb73
    - ff_-40c_3.30v.log  sha256:b421608e193e606a5486dbc05ef8d0586c4682f55dead6d43062e29761a12d8d
wall_time: 10.9m
---

## Result

- `xo_slew_rise_v_per_s`: 4.691328e+10
- `xo_slew_fall_v_per_s`: -6.024462e+10
- `ro1_slew_rise_v_per_s`: 4.303278e+09
- `ro1_slew_fall_v_per_s`: -7.324492e+09
- `ro1_band_slew_a_v_per_s`: 2.238958e+09
- `ro1_band_slew_b_v_per_s`: 2.239034e+09
- `xo_swing_v`: 3.39268
...
```sh
python3 sim/run_corners.py ro-array-core-xo-slew --corners ff --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
