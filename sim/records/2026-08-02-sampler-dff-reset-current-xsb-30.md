---
record: 2026-08-02-sampler-dff-reset-current-xsb-30
...
raw:
  path: sim/records/raw/2026-08-02-sampler-dff-reset-current-xsb-30/
  files:
    - fs_-40c_3.63v.spice  sha256:5886fbe9f25670abcc6e195124860610c18d1549671a0ccc3abddb0195103d88
    - fs_-40c_3.63v.log  sha256:6289b67e99d63acb8301467a0a6f364d7b5298fda5b1a62f4f6ce5fb64579ec4
wall_time: 13.4s
---

## Result

- `i_reset_xsb_a`: 1.837400e-08
- `p_reset_xsb_w`: 6.669762e-08
- `i_reset_xsb_first_a`: 2.610150e-08
- `i_reset_xsb_last_a`: 1.064650e-08
- `q_v`: -1.977359e-06
...
```sh
python3 sim/run_corners.py sampler-dff-reset-current-xsb --corners fs --temps -40 --supply 3.63 --supply-tol 0 --no-write
```
