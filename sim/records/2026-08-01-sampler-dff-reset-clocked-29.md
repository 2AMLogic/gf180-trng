---
record: 2026-08-01-sampler-dff-reset-clocked-29
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-29/
  files:
    - fs_-40c_3.30v.spice  sha256:b8d18cfe27201e319c865e2d8ae9f9b310b223a5be32ec48ec9708df62c5d2b7
    - fs_-40c_3.30v.log  sha256:f9d1494cf7076ceebd74fad601ccf85ec24d0a17832c357f82d1b2abb2234416
wall_time: 2.2m
---

## Result

- `q_rst_max_v`: 0.135237
- `q_rst_max_frac`: 0.0409808
- `s_rst_min_v`: 2.8121
- `s_rst_dev_frac`: 0.147848
- `mb_rst_min_v`: 3.14355
- `q_rel_v`: 1.987806e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners fs --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
