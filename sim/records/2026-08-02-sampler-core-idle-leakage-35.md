---
record: 2026-08-02-sampler-core-idle-leakage-35
...
raw:
  path: sim/records/raw/2026-08-02-sampler-core-idle-leakage-35/
  files:
    - fs_125c_3.30v.spice  sha256:51addbb2127be6b4d7a2c55d8684e8169879c4dbfc3ce83e1361cc2178acef4d
    - fs_125c_3.30v.log  sha256:109fb8acbb57e606815e214d7327e7decbd686db9874aa35f0689fb80953b2cf
wall_time: 50.8s
---

## Result

- `i_idle_clklo_a`: 1.329845e-08
- `i_idle_clkhi_a`: 1.158440e-08
- `p_idle_clklo_w`: 4.388488e-08
- `p_idle_clkhi_w`: 3.822852e-08
- `i_idle_clklo_prev_a`: 1.330715e-08
- `i_idle_clkhi_prev_a`: 1.158435e-08
- `i_idle_worst_a`: 1.329845e-08
- `p_idle_worst_w`: 4.388488e-08
- `v_ro1_v`: 3.29988
- `v_ro2_v`: 3.29989
- `v_xo_v`: 6.762803e-07
- `v_n1_v`: 3.29992
- `v_n2_v`: 2.215761e-07
- `v_rawbit_clklo_v`: -6.468913e-06
- `v_rawvalid_clklo_v`: 3.29999
- `v_rawbit_clkhi_v`: 3.134456e-08
- `v_rawvalid_clkhi_v`: 3.29999
- `v_sup_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-core-idle-leakage --corners fs --temps 125 --supply 3.3 --supply-tol 0 --no-write
```
