---
record: 2026-08-01-sampler-dff-reset-clocked-38
...
raw:
  path: sim/records/raw/2026-08-01-sampler-dff-reset-clocked-38/
  files:
    - sf_-40c_3.30v.spice  sha256:d82639cd626aadfe8ec53d725b2c8b1a6cd25eb3f3f9d2411c5928efb8374fed
    - sf_-40c_3.30v.log  sha256:420b81ebb1eeb481a4e8fc54cecc67e726ee56b644933c206d987250bc5dc7b0
wall_time: 1.8m
---

## Result

- `q_rst_max_v`: 0.138957
- `q_rst_max_frac`: 0.0421081
- `s_rst_min_v`: 2.79167
- `s_rst_dev_frac`: 0.154041
- `mb_rst_min_v`: 3.14379
- `q_rel_v`: 2.641289e-06
- `q_cap_v`: 3.3
...
```sh
python3 sim/run_corners.py sampler-dff-reset-clocked --corners sf --temps -40 --supply 3.3 --supply-tol 0 --no-write
```
